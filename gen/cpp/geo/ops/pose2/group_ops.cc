 ...
 */
template <typename Scalar>
geo::Pose2<Scalar> GroupOps<Scalar>::InverseWithJacobian(const geo::Pose2<Scalar>& a, Eigen::Matrix<Scalar, 3, 3>* const res_D_a) {
    // Input arrays
    const Eigen::Matrix<Scalar, 4, 1>& _a = a.Data();
 ...
 */
template <typename Scalar>
geo::Pose2<Scalar> GroupOps<Scalar>::ComposeWithJacobians(const geo::Pose2<Scalar>& a, const geo::Pose2<Scalar>& b, Eigen::Matrix<Scalar, 3, 3>* const res_D_a, Eigen::Matrix<Scalar, 3, 3>* const res_D_b) {
    // Input arrays
    const Eigen::Matrix<Scalar, 4, 1>& _a = a.Data();
    const Eigen::Matrix<Scalar, 4, 1>& _b = b.Data();
 ...
 */
template <typename Scalar>
geo::Pose2<Scalar> GroupOps<Scalar>::BetweenWithJacobians(const geo::Pose2<Scalar>& a, const geo::Pose2<Scalar>& b, Eigen::Matrix<Scalar, 3, 3>* const res_D_a, Eigen::Matrix<Scalar, 3, 3>* const res_D_b) {
    // Input arrays
    const Eigen::Matrix<Scalar, 4, 1>& _a = a.Data();
    const Eigen::Matrix<Scalar, 4, 1>& _b = b.Data();
