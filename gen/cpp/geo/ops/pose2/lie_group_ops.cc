...
geo::Pose2<Scalar> LieGroupOps<Scalar>::FromTangent(const Eigen::Matrix<Scalar, 3, 1>& vec, const Scalar epsilon) {
    ...
    const Scalar _tmp4 = _tmp2*(-_tmp0 + 1);
...
Eigen::Matrix<Scalar, 3, 1> LieGroupOps<Scalar>::ToTangent(const geo::Pose2<Scalar>& a, const Scalar epsilon) {
    ...
    const Scalar _tmp3 = _a[1]/std::max<Scalar>(epsilon, -_a[0] + 1);
    const Scalar _tmp4 = _a[3]*_tmp1;

    // Output terms (1)
    Eigen::Matrix<Scalar, 3, 1> _res;
    _res(0, 0) = _tmp2*_tmp3 + _tmp4;
    _res(1, 0) = -_tmp2 + _tmp3*_tmp4;
    _res(2, 0) = _tmp0;
...
geo::Pose2<Scalar> LieGroupOps<Scalar>::Retract(const geo::Pose2<Scalar>& a, const Eigen::Matrix<Scalar, 3, 1>& vec, const Scalar epsilon) {
    ...
    const Scalar _tmp3 = _tmp1*_tmp2;
    const Scalar _tmp4 = _tmp2*(-_tmp0 + 1);
    const Scalar _tmp5 = _tmp3*vec[0] - _tmp4*vec[1];
    const Scalar _tmp6 = _tmp3*vec[1] + _tmp4*vec[0];
...
Eigen::Matrix<Scalar, 3, 1> LieGroupOps<Scalar>::LocalCoordinates(const geo::Pose2<Scalar>& a, const geo::Pose2<Scalar>& b, const Scalar epsilon) {
    ...
    const Scalar _tmp7 = _tmp6*(-_a[2]*_tmp1 - _a[3]*_tmp2 + _b[2]*_tmp1 + _b[3]*_tmp2);
    const Scalar _tmp8 = _tmp3/std::max<Scalar>(epsilon, -_tmp4 + 1);
    const Scalar _tmp9 = _tmp6*(_a[2]*_tmp2 - _a[3]*_tmp1 - _b[2]*_tmp2 + _b[3]*_tmp1);

    // Output terms (1)
    Eigen::Matrix<Scalar, 3, 1> _res;
    _res(0, 0) = _tmp7*_tmp8 + _tmp9;
    _res(1, 0) = -_tmp7 + _tmp8*_tmp9;
    _res(2, 0) = _tmp5;
