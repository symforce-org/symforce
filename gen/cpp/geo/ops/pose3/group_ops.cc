...
geo::Pose3<Scalar> GroupOps<Scalar>::Inverse(const geo::Pose3<Scalar>& a) {
    ...
    const Scalar _tmp6 = 2*_a[0]*_a[2];
    const Scalar _tmp7 = _a[3]*_tmp2;
    const Scalar _tmp8 = -2*(_a[0] * _a[0]) + 1;
    const Scalar _tmp9 = _a[2]*_tmp2;
...
geo::Pose3<Scalar> GroupOps<Scalar>::Compose(const geo::Pose3<Scalar>& a, const geo::Pose3<Scalar>& b) {
    ...
    // Intermediate terms (11)
    const Scalar _tmp0 = -2*(_a[2] * _a[2]);
    const Scalar _tmp1 = -2*(_a[1] * _a[1]) + 1;
    const Scalar _tmp2 = 2*_a[0];
    const Scalar _tmp3 = _a[1]*_tmp2;
    const Scalar _tmp4 = 2*_a[2];
    const Scalar _tmp5 = _a[3]*_tmp4;
    const Scalar _tmp6 = _a[0]*_tmp4;
    const Scalar _tmp7 = 2*_a[1]*_a[3];
    const Scalar _tmp8 = -2*(_a[0] * _a[0]);
    const Scalar _tmp9 = _a[1]*_tmp4;
...
geo::Pose3<Scalar> GroupOps<Scalar>::Between(const geo::Pose3<Scalar>& a, const geo::Pose3<Scalar>& b) {
    ...
    const Scalar _tmp0 = -2*(_a[1] * _a[1]);
    const Scalar _tmp1 = -2*(_a[2] * _a[2]) + 1;
    const Scalar _tmp2 = _tmp0 + _tmp1;
    const Scalar _tmp3 = 2*_a[0]*_a[1];
    const Scalar _tmp4 = 2*_a[2];
    const Scalar _tmp5 = _a[3]*_tmp4;
    const Scalar _tmp6 = _tmp3 + _tmp5;
    const Scalar _tmp7 = _a[0]*_tmp4;
    ...
    const Scalar _tmp14 = _a[1]*_tmp4;
    const Scalar _tmp15 = _a[0]*_tmp8;
    const Scalar _tmp16 = _tmp14 + _tmp15;
    const Scalar _tmp17 = _tmp0 + _tmp12 + 1;
