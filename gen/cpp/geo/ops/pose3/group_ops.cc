 ...
 */
template <typename Scalar>
geo::Pose3<Scalar> GroupOps<Scalar>::InverseWithJacobian(const geo::Pose3<Scalar>& a, Eigen::Matrix<Scalar, 6, 6>* const res_D_a) {
    // Input arrays
    const Eigen::Matrix<Scalar, 7, 1>& _a = a.Data();
    ...
    const Scalar _tmp79 = -1.0/2.0*_tmp17*_tmp57 - 1.0/2.0*_tmp23*_tmp59 - 1.0/2.0*_tmp5*_tmp60;
    const Scalar _tmp80 = -_tmp17*_tmp39 - _tmp23*_tmp35 - _tmp43*_tmp5;
    const Scalar _tmp81 = -1.0/2.0*_tmp17*_tmp47 - 1.0/2.0*_tmp23*_tmp50 - 1.0/2.0*_tmp5*_tmp53;
 ...
 */
template <typename Scalar>
geo::Pose3<Scalar> GroupOps<Scalar>::ComposeWithJacobians(const geo::Pose3<Scalar>& a, const geo::Pose3<Scalar>& b, Eigen::Matrix<Scalar, 6, 6>* const res_D_a, Eigen::Matrix<Scalar, 6, 6>* const res_D_b) {
    // Input arrays
    const Eigen::Matrix<Scalar, 7, 1>& _a = a.Data();
    const Eigen::Matrix<Scalar, 7, 1>& _b = b.Data();
 ...
 */
template <typename Scalar>
geo::Pose3<Scalar> GroupOps<Scalar>::BetweenWithJacobians(const geo::Pose3<Scalar>& a, const geo::Pose3<Scalar>& b, Eigen::Matrix<Scalar, 6, 6>* const res_D_a, Eigen::Matrix<Scalar, 6, 6>* const res_D_b) {
    // Input arrays
    const Eigen::Matrix<Scalar, 7, 1>& _a = a.Data();
    const Eigen::Matrix<Scalar, 7, 1>& _b = b.Data();
    ...
    const Scalar _tmp125 = (1.0/2.0)*_tmp122*_tmp85 + (1.0/2.0)*_tmp123*_tmp92 + (1.0/2.0)*_tmp124*_tmp99;
    ...
    const Scalar _tmp176 = -1.0/2.0*_tmp172 + (1.0/2.0)*_tmp173 + (1.0/2.0)*_tmp174 + (1.0/2.0)*_tmp175;
    ...
    const Scalar _tmp194 = (1.0/2.0)*_tmp172 - 1.0/2.0*_tmp173 - 1.0/2.0*_tmp174 - 1.0/2.0*_tmp175;
    ...
    _res[2] = _tmp2;
    _res[3] = _tmp3;
    _res[4] = -_a[4]*_tmp18 - _a[5]*_tmp13 - _a[6]*_tmp9 + _b[4]*_tmp18 + _b[5]*_tmp13 + _b[6]*_tmp9;
    _res[5] = -_a[4]*_tmp26 - _a[5]*_tmp24 - _a[6]*_tmp21 + _b[4]*_tmp26 + _b[5]*_tmp24 + _b[6]*_tmp21;
    _res[6] = -_a[4]*_tmp30 - _a[5]*_tmp29 - _a[6]*_tmp27 + _b[4]*_tmp30 + _b[5]*_tmp29 + _b[6]*_tmp27;
