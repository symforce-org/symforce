...
Eigen::Matrix<Scalar, 2, 1> DoubleSphereCameraCal<Scalar>::PixelFromCameraPointWithJacobians(
  ...
  const Scalar _tmp12 = _tmp11 * point(0, 0);
  const Scalar _tmp13 = _tmp11 * point(1, 0);
  ...
  const Scalar _tmp24 = _tmp23 * (_tmp1 * _tmp22 + _tmp1 * _tmp8);
  const Scalar _tmp25 = _self[1] * point(1, 0);
  const Scalar _tmp26 = -_tmp2 + _tmp3;
  const Scalar _tmp27 = _tmp20 * _tmp23;
  const Scalar _tmp28 = _tmp23 * _tmp25;
  ...
  const Scalar _tmp37 = _tmp23 * (_tmp31 * point(1, 0) + _tmp34 * (_tmp33 * _tmp36 + _tmp36));
  const Scalar _tmp38 = _tmp14 * _tmp29 + 1;
  const Scalar _tmp39 = _tmp22 * _tmp38 + _tmp38 * _tmp8;
