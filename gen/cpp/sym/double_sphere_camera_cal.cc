...
Eigen::Matrix<Scalar, 2, 1> DoubleSphereCameraCal<Scalar>::PixelFromCameraPoint(
  ...
  const Scalar _tmp7 = std::pow(_self[4], Scalar(2));
  const Scalar _tmp8 = (Scalar(1) / Scalar(2)) * _tmp3 + _tmp4 + Scalar(-1) / Scalar(2);
  const Scalar _tmp9 = (Scalar(1) / Scalar(2)) * _tmp3 + _tmp5 + Scalar(1) / Scalar(2);
  const Scalar _tmp10 = std::pow(_tmp9, Scalar(2)) / std::pow(_tmp8, Scalar(2));
  const Scalar _tmp11 = _tmp10 * _tmp7 - _tmp7 + 1;
...
Eigen::Matrix<Scalar, 2, 1> DoubleSphereCameraCal<Scalar>::PixelFromCameraPointWithJacobians(
  ...
  const Scalar _tmp13 = _self[4] * point(2, 0);
  const Scalar _tmp14 = std::pow(_self[4], Scalar(2));
  const Scalar _tmp15 = (Scalar(1) / Scalar(2)) * _tmp3 + _tmp4 + Scalar(-1) / Scalar(2);
  const Scalar _tmp16 = (Scalar(1) / Scalar(2)) * _tmp3 + _tmp5 + Scalar(1) / Scalar(2);
  const Scalar _tmp17 = std::pow(_tmp16, Scalar(2)) / std::pow(_tmp15, Scalar(2));
  const Scalar _tmp18 = _tmp14 * _tmp17 - _tmp14 + 1;
  const Scalar _tmp19 = _tmp4 / _tmp7;
  const Scalar _tmp20 = _tmp19 * _tmp2;
  const Scalar _tmp21 = _tmp1 * _tmp20 + _tmp1 * _tmp6;
  const Scalar _tmp22 = (Scalar(1) / Scalar(2)) *
  ...
  const Scalar _tmp27 = -_tmp2 + _tmp7;
  ...
  const Scalar _tmp34 = _tmp22 * (_tmp30 * point(0, 0) + _tmp33 * (_tmp31 * _tmp32 + _tmp31));
  const Scalar _tmp35 = 2 * point(1, 0);
  const Scalar _tmp36 = _tmp30 * point(1, 0) + _tmp33 * (_tmp32 * _tmp35 + _tmp35);
  const Scalar _tmp37 = _tmp13 * _tmp28 + 1;
  const Scalar _tmp38 = _tmp20 * _tmp37 + _tmp37 * _tmp6;
    ...
    _is_valid = std::max<Scalar>(
        0, std::min<Scalar>(
               std::max<Scalar>(
                   ...
                   1 - std::max<Scalar>(0, -(((_tmp1 + _tmp13) > 0) - ((_tmp1 + _tmp13) < 0)))),
               std::max<Scalar>(
                   -(((_tmp18) > 0) - ((_tmp18) < 0)),
                   1 - std::max<Scalar>(
                           0, -(((-_tmp1 *
                                      (_self[4] * _tmp17 - _self[4] -
                                       _tmp16 *
                                           std::sqrt(Scalar(
                                               std::max<Scalar>(_tmp18, std::sqrt(epsilon)))) /
                                           _tmp15) +
                                  point(2, 0)) > 0) -
                                ((-_tmp1 *
                                      (_self[4] * _tmp17 - _self[4] -
...
Eigen::Matrix<Scalar, 3, 1> DoubleSphereCameraCal<Scalar>::CameraRayFromPixelWithJacobians(
  ...
  const Scalar _tmp38 = _self[5] * _tmp12;
  const Scalar _tmp39 = _tmp10 / [&]() {
    const Scalar base = _tmp16;
    return base * base * base;
  }();
  const Scalar _tmp40 = -epsilon;
  const Scalar _tmp41 = ((((_tmp13 + _tmp40) > 0) - ((_tmp13 + _tmp40) < 0)) + 1) / _tmp14;
  const Scalar _tmp42 = _tmp39 * _tmp41;
  const Scalar _tmp43 = _tmp38 * _tmp42;
  const Scalar _tmp44 = _tmp33 * _tmp37 - _tmp33 * _tmp43;
  const Scalar _tmp45 = _tmp27 / std::pow(_tmp20, Scalar(2));
  const Scalar _tmp46 = _tmp45 * (-_tmp34 + _tmp44);
  const Scalar _tmp47 = _tmp0 * _tmp3;
  const Scalar _tmp48 = _tmp28 * _tmp47;
  const Scalar _tmp49 = (Scalar(1) / Scalar(2)) * _tmp41;
  const Scalar _tmp50 = _tmp35 * _tmp49;
  const Scalar _tmp51 = _self[4] * _tmp50;
  const Scalar _tmp52 = _tmp38 * _tmp51;
  const Scalar _tmp53 = _tmp22 * _tmp8;
  const Scalar _tmp54 = _self[4] * _tmp53;
  const Scalar _tmp55 = ((((_tmp25 + _tmp40) > 0) - ((_tmp25 + _tmp40) < 0)) + 1) / _tmp26;
  const Scalar _tmp56 = (Scalar(1) / Scalar(4)) * _tmp55;
  const Scalar _tmp57 = -_tmp33 * _tmp52 + _tmp34 * _tmp54 + _tmp56 * (-_tmp24 * _tmp34 + _tmp44);
  const Scalar _tmp58 = _tmp21 * _tmp32;
  const Scalar _tmp59 = _tmp30 * _tmp4;
  const Scalar _tmp60 = _tmp21 * _tmp59;
  const Scalar _tmp61 = _tmp28 * _tmp53;
  const Scalar _tmp62 = _tmp21 * _tmp23;
  const Scalar _tmp63 = _tmp38 * _tmp50;
  ...
  const Scalar _tmp67 = _tmp37 * _tmp64 - _tmp42 * _tmp66;
  const Scalar _tmp68 = _tmp45 * (-_tmp65 + _tmp67);
  const Scalar _tmp69 = -_tmp51 * _tmp66 + _tmp54 * _tmp65 + _tmp56 * (-_tmp24 * _tmp65 + _tmp67);
  const Scalar _tmp70 = _tmp4 * _tmp6;
  const Scalar _tmp71 = _tmp28 * _tmp70;
  const Scalar _tmp72 = _tmp47 * _tmp52;
  const Scalar _tmp73 = 2 * _tmp47;
  const Scalar _tmp74 = _tmp54 * _tmp73;
  const Scalar _tmp75 = _tmp24 * _tmp73;
  const Scalar _tmp76 = _tmp37 * _tmp47;
  const Scalar _tmp77 = _tmp43 * _tmp47;
  const Scalar _tmp78 = _tmp76 - _tmp77;
  const Scalar _tmp79 = _tmp56 * (-_tmp75 + _tmp78) - _tmp72 + _tmp74;
  const Scalar _tmp80 = -_tmp73 + _tmp78;
  const Scalar _tmp81 = _tmp32 * _tmp45;
  const Scalar _tmp82 = _tmp45 * _tmp59;
  const Scalar _tmp83 = _tmp61 * _tmp73;
  const Scalar _tmp84 = _tmp48 * _tmp63;
  const Scalar _tmp85 = _tmp23 * _tmp45;
  const Scalar _tmp86 = 2 * _tmp70;
  const Scalar _tmp87 = _tmp37 * _tmp70;
  const Scalar _tmp88 = _tmp43 * _tmp70;
  const Scalar _tmp89 = _tmp87 - _tmp88;
  const Scalar _tmp90 = _tmp45 * (-_tmp86 + _tmp89);
  const Scalar _tmp91 = _tmp52 * _tmp70;
  const Scalar _tmp92 = _tmp54 * _tmp86;
  const Scalar _tmp93 = _tmp24 * _tmp86;
  const Scalar _tmp94 = _tmp56 * (_tmp89 - _tmp93) - _tmp91 + _tmp92;
  const Scalar _tmp95 = _tmp61 * _tmp86;
  const Scalar _tmp96 = _tmp63 * _tmp71;
  const Scalar _tmp97 = _self[4] * _tmp7;
  const Scalar _tmp98 = _tmp23 - Scalar(1) / Scalar(2) * _tmp55 * _tmp97;
  const Scalar _tmp99 = _tmp21 * _tmp98;
  const Scalar _tmp100 = _self[5] * _tmp7;
  const Scalar _tmp101 = -_tmp100 * _tmp49 + _tmp14 - 1;
  const Scalar _tmp102 = -_tmp100 * _tmp36 - 2 * _tmp101 * _tmp39;
  const Scalar _tmp103 = _tmp11 * _tmp22;
  const Scalar _tmp104 = _tmp101 * _tmp35;
  const Scalar _tmp105 = -_self[4] * _tmp104 + _tmp102 * _tmp56 - _tmp103 * _tmp97;
  const Scalar _tmp106 = _tmp102 * _tmp45;
  const Scalar _tmp107 = -_tmp76 + _tmp77;
  const Scalar _tmp108 = _tmp107 + _tmp73;
  const Scalar _tmp109 = _tmp56 * (_tmp107 + _tmp75) + _tmp72 - _tmp74;
  const Scalar _tmp110 = -_tmp87 + _tmp88;
  const Scalar _tmp111 = _tmp56 * (_tmp110 + _tmp93) + _tmp91 - _tmp92;
  const Scalar _tmp112 = _tmp111 * _tmp21;
  const Scalar _tmp113 = _tmp45 * (_tmp110 + _tmp86);
