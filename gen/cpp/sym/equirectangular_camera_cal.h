...
class EquirectangularCameraCal {
 public:
   ...
   */
  explicit EquirectangularCameraCal(const DataVec& data, bool normalize = true) : data_(data) {
    (void)normalize;
  }
  ...
  static EquirectangularCameraCal FromStorage(const Scalar* const vec) {
  ...
  EquirectangularCameraCal<ToScalar> Cast() const {
    return EquirectangularCameraCal<ToScalar>(Data().template cast<ToScalar>());
  }
...
// Print definitions
std::ostream& operator<<(std::ostream& os, const EquirectangularCameraCal<double>& a);
std::ostream& operator<<(std::ostream& os, const EquirectangularCameraCal<float>& a);
