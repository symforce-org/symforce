...
void BetweenFactorAtanCameraCal(const sym::ATANCameraCal<Scalar>& a,
  ...
  const Scalar _tmp4 = -_a[4] - _a_T_b[4] + _b[4];
  const Scalar _tmp5 = _tmp0 * sqrt_info(0, 2) + _tmp1 * sqrt_info(0, 3) + _tmp2 * sqrt_info(0, 1) +
                       _tmp3 * sqrt_info(0, 0) + _tmp4 * sqrt_info(0, 4);
  const Scalar _tmp6 = _tmp0 * sqrt_info(1, 2) + _tmp1 * sqrt_info(1, 3) + _tmp2 * sqrt_info(1, 1) +
                       _tmp3 * sqrt_info(1, 0) + _tmp4 * sqrt_info(1, 4);
  const Scalar _tmp7 = _tmp0 * sqrt_info(2, 2) + _tmp1 * sqrt_info(2, 3) + _tmp2 * sqrt_info(2, 1) +
                       _tmp3 * sqrt_info(2, 0) + _tmp4 * sqrt_info(2, 4);
  const Scalar _tmp8 = _tmp0 * sqrt_info(3, 2) + _tmp1 * sqrt_info(3, 3) + _tmp2 * sqrt_info(3, 1) +
                       _tmp3 * sqrt_info(3, 0) + _tmp4 * sqrt_info(3, 4);
  const Scalar _tmp9 = _tmp0 * sqrt_info(4, 2) + _tmp1 * sqrt_info(4, 3) + _tmp2 * sqrt_info(4, 1) +
                       _tmp3 * sqrt_info(4, 0) + _tmp4 * sqrt_info(4, 4);
  const Scalar _tmp10 = std::pow(sqrt_info(0, 0), Scalar(2));
  const Scalar _tmp11 = std::pow(sqrt_info(2, 0), Scalar(2));
  const Scalar _tmp12 = std::pow(sqrt_info(4, 0), Scalar(2));
  const Scalar _tmp13 = std::pow(sqrt_info(1, 0), Scalar(2));
  const Scalar _tmp14 = std::pow(sqrt_info(3, 0), Scalar(2));
  const Scalar _tmp15 = _tmp10 + _tmp11 + _tmp12 + _tmp13 + _tmp14;
  const Scalar _tmp16 = sqrt_info(4, 0) * sqrt_info(4, 1);
  const Scalar _tmp17 = sqrt_info(0, 0) * sqrt_info(0, 1);
  const Scalar _tmp18 = sqrt_info(2, 0) * sqrt_info(2, 1);
  const Scalar _tmp19 = sqrt_info(1, 0) * sqrt_info(1, 1);
  const Scalar _tmp20 = sqrt_info(3, 0) * sqrt_info(3, 1);
  const Scalar _tmp21 = _tmp16 + _tmp17 + _tmp18 + _tmp19 + _tmp20;
  const Scalar _tmp22 = sqrt_info(4, 0) * sqrt_info(4, 2);
  const Scalar _tmp23 = sqrt_info(0, 0) * sqrt_info(0, 2);
  const Scalar _tmp24 = sqrt_info(2, 0) * sqrt_info(2, 2);
  const Scalar _tmp25 = sqrt_info(1, 0) * sqrt_info(1, 2);
  const Scalar _tmp26 = sqrt_info(3, 0) * sqrt_info(3, 2);
  const Scalar _tmp27 = _tmp22 + _tmp23 + _tmp24 + _tmp25 + _tmp26;
  const Scalar _tmp28 = sqrt_info(4, 0) * sqrt_info(4, 3);
  const Scalar _tmp29 = sqrt_info(0, 0) * sqrt_info(0, 3);
  const Scalar _tmp30 = sqrt_info(2, 0) * sqrt_info(2, 3);
  const Scalar _tmp31 = sqrt_info(1, 0) * sqrt_info(1, 3);
  const Scalar _tmp32 = sqrt_info(3, 0) * sqrt_info(3, 3);
  const Scalar _tmp33 = _tmp28 + _tmp29 + _tmp30 + _tmp31 + _tmp32;
  const Scalar _tmp34 = sqrt_info(4, 0) * sqrt_info(4, 4);
  const Scalar _tmp35 = sqrt_info(0, 0) * sqrt_info(0, 4);
  const Scalar _tmp36 = sqrt_info(2, 0) * sqrt_info(2, 4);
  const Scalar _tmp37 = sqrt_info(1, 0) * sqrt_info(1, 4);
  const Scalar _tmp38 = sqrt_info(3, 0) * sqrt_info(3, 4);
  ...
  const Scalar _tmp46 = std::pow(sqrt_info(4, 1), Scalar(2));
  const Scalar _tmp47 = std::pow(sqrt_info(1, 1), Scalar(2));
  const Scalar _tmp48 = std::pow(sqrt_info(3, 1), Scalar(2));
  const Scalar _tmp49 = _tmp44 + _tmp45 + _tmp46 + _tmp47 + _tmp48;
  const Scalar _tmp50 = sqrt_info(4, 1) * sqrt_info(4, 2);
  const Scalar _tmp51 = sqrt_info(0, 1) * sqrt_info(0, 2);
  const Scalar _tmp52 = sqrt_info(2, 1) * sqrt_info(2, 2);
  const Scalar _tmp53 = sqrt_info(1, 1) * sqrt_info(1, 2);
  const Scalar _tmp54 = sqrt_info(3, 1) * sqrt_info(3, 2);
  const Scalar _tmp55 = _tmp50 + _tmp51 + _tmp52 + _tmp53 + _tmp54;
  const Scalar _tmp56 = sqrt_info(4, 1) * sqrt_info(4, 3);
  const Scalar _tmp57 = sqrt_info(0, 1) * sqrt_info(0, 3);
  const Scalar _tmp58 = sqrt_info(2, 1) * sqrt_info(2, 3);
  const Scalar _tmp59 = sqrt_info(1, 1) * sqrt_info(1, 3);
  const Scalar _tmp60 = sqrt_info(3, 1) * sqrt_info(3, 3);
  const Scalar _tmp61 = _tmp56 + _tmp57 + _tmp58 + _tmp59 + _tmp60;
  const Scalar _tmp62 = sqrt_info(4, 1) * sqrt_info(4, 4);
  const Scalar _tmp63 = sqrt_info(0, 1) * sqrt_info(0, 4);
  const Scalar _tmp64 = sqrt_info(2, 1) * sqrt_info(2, 4);
  const Scalar _tmp65 = sqrt_info(1, 1) * sqrt_info(1, 4);
  const Scalar _tmp66 = sqrt_info(3, 1) * sqrt_info(3, 4);
  ...
  const Scalar _tmp73 = std::pow(sqrt_info(4, 2), Scalar(2));
  const Scalar _tmp74 = std::pow(sqrt_info(1, 2), Scalar(2));
  const Scalar _tmp75 = std::pow(sqrt_info(3, 2), Scalar(2));
  const Scalar _tmp76 = _tmp71 + _tmp72 + _tmp73 + _tmp74 + _tmp75;
  const Scalar _tmp77 = sqrt_info(4, 2) * sqrt_info(4, 3);
  const Scalar _tmp78 = sqrt_info(0, 2) * sqrt_info(0, 3);
  const Scalar _tmp79 = sqrt_info(2, 2) * sqrt_info(2, 3);
  const Scalar _tmp80 = sqrt_info(1, 2) * sqrt_info(1, 3);
  const Scalar _tmp81 = sqrt_info(3, 2) * sqrt_info(3, 3);
  const Scalar _tmp82 = _tmp77 + _tmp78 + _tmp79 + _tmp80 + _tmp81;
  const Scalar _tmp83 = sqrt_info(4, 2) * sqrt_info(4, 4);
  const Scalar _tmp84 = sqrt_info(0, 2) * sqrt_info(0, 4);
  const Scalar _tmp85 = sqrt_info(2, 2) * sqrt_info(2, 4);
  const Scalar _tmp86 = sqrt_info(1, 2) * sqrt_info(1, 4);
  const Scalar _tmp87 = sqrt_info(3, 2) * sqrt_info(3, 4);
  ...
  const Scalar _tmp93 = std::pow(sqrt_info(4, 3), Scalar(2));
  const Scalar _tmp94 = std::pow(sqrt_info(1, 3), Scalar(2));
  const Scalar _tmp95 = std::pow(sqrt_info(3, 3), Scalar(2));
  const Scalar _tmp96 = _tmp91 + _tmp92 + _tmp93 + _tmp94 + _tmp95;
  const Scalar _tmp97 = sqrt_info(4, 3) * sqrt_info(4, 4);
  const Scalar _tmp98 = sqrt_info(0, 3) * sqrt_info(0, 4);
  const Scalar _tmp99 = sqrt_info(2, 3) * sqrt_info(2, 4);
  const Scalar _tmp100 = sqrt_info(1, 3) * sqrt_info(1, 4);
  const Scalar _tmp101 = sqrt_info(3, 3) * sqrt_info(3, 4);
  ...
  const Scalar _tmp106 = std::pow(sqrt_info(4, 4), Scalar(2));
  const Scalar _tmp107 = std::pow(sqrt_info(1, 4), Scalar(2));
  const Scalar _tmp108 = std::pow(sqrt_info(3, 4), Scalar(2));
  const Scalar _tmp109 = _tmp104 + _tmp105 + _tmp106 + _tmp107 + _tmp108;
  const Scalar _tmp110 = _tmp6 * sqrt_info(1, 0);
  const Scalar _tmp111 = _tmp5 * sqrt_info(0, 0);
  const Scalar _tmp112 = _tmp7 * sqrt_info(2, 0);
  const Scalar _tmp113 = _tmp8 * sqrt_info(3, 0);
  const Scalar _tmp114 = _tmp9 * sqrt_info(4, 0);
  const Scalar _tmp115 = _tmp6 * sqrt_info(1, 1);
  const Scalar _tmp116 = _tmp5 * sqrt_info(0, 1);
  const Scalar _tmp117 = _tmp7 * sqrt_info(2, 1);
  const Scalar _tmp118 = _tmp8 * sqrt_info(3, 1);
  const Scalar _tmp119 = _tmp9 * sqrt_info(4, 1);
  const Scalar _tmp120 = _tmp6 * sqrt_info(1, 2);
  const Scalar _tmp121 = _tmp5 * sqrt_info(0, 2);
  const Scalar _tmp122 = _tmp7 * sqrt_info(2, 2);
  const Scalar _tmp123 = _tmp8 * sqrt_info(3, 2);
  const Scalar _tmp124 = _tmp9 * sqrt_info(4, 2);
  const Scalar _tmp125 = _tmp6 * sqrt_info(1, 3);
  const Scalar _tmp126 = _tmp5 * sqrt_info(0, 3);
  const Scalar _tmp127 = _tmp7 * sqrt_info(2, 3);
  const Scalar _tmp128 = _tmp8 * sqrt_info(3, 3);
  const Scalar _tmp129 = _tmp9 * sqrt_info(4, 3);
  const Scalar _tmp130 = _tmp6 * sqrt_info(1, 4);
  const Scalar _tmp131 = _tmp5 * sqrt_info(0, 4);
  const Scalar _tmp132 = _tmp7 * sqrt_info(2, 4);
