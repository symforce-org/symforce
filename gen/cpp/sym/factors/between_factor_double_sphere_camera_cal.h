...
void BetweenFactorDoubleSphereCameraCal(const sym::DoubleSphereCameraCal<Scalar>& a,
  ...
  const Scalar _tmp1 = -_a[2] - _a_T_b[2] + _b[2];
  const Scalar _tmp2 = -_a[3] - _a_T_b[3] + _b[3];
  const Scalar _tmp3 = -_a[1] - _a_T_b[1] + _b[1];
  const Scalar _tmp4 = -_a[0] - _a_T_b[0] + _b[0];
  const Scalar _tmp5 = -_a[5] - _a_T_b[5] + _b[5];
  const Scalar _tmp6 = _tmp0 * sqrt_info(0, 4) + _tmp1 * sqrt_info(0, 2) + _tmp2 * sqrt_info(0, 3) +
                       _tmp3 * sqrt_info(0, 1) + _tmp4 * sqrt_info(0, 0) + _tmp5 * sqrt_info(0, 5);
  const Scalar _tmp7 = _tmp0 * sqrt_info(1, 4) + _tmp1 * sqrt_info(1, 2) + _tmp2 * sqrt_info(1, 3) +
                       _tmp3 * sqrt_info(1, 1) + _tmp4 * sqrt_info(1, 0) + _tmp5 * sqrt_info(1, 5);
  const Scalar _tmp8 = _tmp0 * sqrt_info(2, 4) + _tmp1 * sqrt_info(2, 2) + _tmp2 * sqrt_info(2, 3) +
                       _tmp3 * sqrt_info(2, 1) + _tmp4 * sqrt_info(2, 0) + _tmp5 * sqrt_info(2, 5);
  const Scalar _tmp9 = _tmp0 * sqrt_info(3, 4) + _tmp1 * sqrt_info(3, 2) + _tmp2 * sqrt_info(3, 3) +
                       _tmp3 * sqrt_info(3, 1) + _tmp4 * sqrt_info(3, 0) + _tmp5 * sqrt_info(3, 5);
  const Scalar _tmp10 = _tmp0 * sqrt_info(4, 4) + _tmp1 * sqrt_info(4, 2) +
                        _tmp2 * sqrt_info(4, 3) + _tmp3 * sqrt_info(4, 1) +
                        _tmp4 * sqrt_info(4, 0) + _tmp5 * sqrt_info(4, 5);
  const Scalar _tmp11 = _tmp0 * sqrt_info(5, 4) + _tmp1 * sqrt_info(5, 2) +
                        _tmp2 * sqrt_info(5, 3) + _tmp3 * sqrt_info(5, 1) +
                        _tmp4 * sqrt_info(5, 0) + _tmp5 * sqrt_info(5, 5);
  const Scalar _tmp12 = std::pow(sqrt_info(0, 0), Scalar(2));
  const Scalar _tmp13 = std::pow(sqrt_info(2, 0), Scalar(2));
  const Scalar _tmp14 = std::pow(sqrt_info(5, 0), Scalar(2));
  const Scalar _tmp15 = std::pow(sqrt_info(4, 0), Scalar(2));
  const Scalar _tmp16 = std::pow(sqrt_info(1, 0), Scalar(2));
  const Scalar _tmp17 = std::pow(sqrt_info(3, 0), Scalar(2));
  const Scalar _tmp18 = _tmp12 + _tmp13 + _tmp14 + _tmp15 + _tmp16 + _tmp17;
  const Scalar _tmp19 = sqrt_info(4, 0) * sqrt_info(4, 1);
  const Scalar _tmp20 = sqrt_info(5, 0) * sqrt_info(5, 1);
  const Scalar _tmp21 = sqrt_info(0, 0) * sqrt_info(0, 1);
  const Scalar _tmp22 = sqrt_info(2, 0) * sqrt_info(2, 1);
  const Scalar _tmp23 = sqrt_info(1, 0) * sqrt_info(1, 1);
  const Scalar _tmp24 = sqrt_info(3, 0) * sqrt_info(3, 1);
  const Scalar _tmp25 = _tmp19 + _tmp20 + _tmp21 + _tmp22 + _tmp23 + _tmp24;
  const Scalar _tmp26 = sqrt_info(4, 0) * sqrt_info(4, 2);
  const Scalar _tmp27 = sqrt_info(5, 0) * sqrt_info(5, 2);
  const Scalar _tmp28 = sqrt_info(0, 0) * sqrt_info(0, 2);
  const Scalar _tmp29 = sqrt_info(2, 0) * sqrt_info(2, 2);
  const Scalar _tmp30 = sqrt_info(1, 0) * sqrt_info(1, 2);
  const Scalar _tmp31 = sqrt_info(3, 0) * sqrt_info(3, 2);
  const Scalar _tmp32 = _tmp26 + _tmp27 + _tmp28 + _tmp29 + _tmp30 + _tmp31;
  const Scalar _tmp33 = sqrt_info(4, 0) * sqrt_info(4, 3);
  const Scalar _tmp34 = sqrt_info(5, 0) * sqrt_info(5, 3);
  const Scalar _tmp35 = sqrt_info(0, 0) * sqrt_info(0, 3);
  const Scalar _tmp36 = sqrt_info(2, 0) * sqrt_info(2, 3);
  const Scalar _tmp37 = sqrt_info(1, 0) * sqrt_info(1, 3);
  const Scalar _tmp38 = sqrt_info(3, 0) * sqrt_info(3, 3);
  const Scalar _tmp39 = _tmp33 + _tmp34 + _tmp35 + _tmp36 + _tmp37 + _tmp38;
  const Scalar _tmp40 = sqrt_info(4, 0) * sqrt_info(4, 4);
  const Scalar _tmp41 = sqrt_info(5, 0) * sqrt_info(5, 4);
  const Scalar _tmp42 = sqrt_info(0, 0) * sqrt_info(0, 4);
  const Scalar _tmp43 = sqrt_info(2, 0) * sqrt_info(2, 4);
  const Scalar _tmp44 = sqrt_info(1, 0) * sqrt_info(1, 4);
  const Scalar _tmp45 = sqrt_info(3, 0) * sqrt_info(3, 4);
  const Scalar _tmp46 = _tmp40 + _tmp41 + _tmp42 + _tmp43 + _tmp44 + _tmp45;
  const Scalar _tmp47 = sqrt_info(4, 0) * sqrt_info(4, 5);
  const Scalar _tmp48 = sqrt_info(5, 0) * sqrt_info(5, 5);
  const Scalar _tmp49 = sqrt_info(0, 0) * sqrt_info(0, 5);
  const Scalar _tmp50 = sqrt_info(2, 0) * sqrt_info(2, 5);
  const Scalar _tmp51 = sqrt_info(1, 0) * sqrt_info(1, 5);
  const Scalar _tmp52 = sqrt_info(3, 0) * sqrt_info(3, 5);
  ...
  const Scalar _tmp61 = std::pow(sqrt_info(5, 1), Scalar(2));
  const Scalar _tmp62 = std::pow(sqrt_info(4, 1), Scalar(2));
  const Scalar _tmp63 = std::pow(sqrt_info(1, 1), Scalar(2));
  const Scalar _tmp64 = std::pow(sqrt_info(3, 1), Scalar(2));
  const Scalar _tmp65 = _tmp59 + _tmp60 + _tmp61 + _tmp62 + _tmp63 + _tmp64;
  const Scalar _tmp66 = sqrt_info(4, 1) * sqrt_info(4, 2);
  const Scalar _tmp67 = sqrt_info(5, 1) * sqrt_info(5, 2);
  const Scalar _tmp68 = sqrt_info(0, 1) * sqrt_info(0, 2);
  const Scalar _tmp69 = sqrt_info(2, 1) * sqrt_info(2, 2);
  const Scalar _tmp70 = sqrt_info(1, 1) * sqrt_info(1, 2);
  const Scalar _tmp71 = sqrt_info(3, 1) * sqrt_info(3, 2);
  const Scalar _tmp72 = _tmp66 + _tmp67 + _tmp68 + _tmp69 + _tmp70 + _tmp71;
  const Scalar _tmp73 = sqrt_info(4, 1) * sqrt_info(4, 3);
  const Scalar _tmp74 = sqrt_info(5, 1) * sqrt_info(5, 3);
  const Scalar _tmp75 = sqrt_info(0, 1) * sqrt_info(0, 3);
  const Scalar _tmp76 = sqrt_info(2, 1) * sqrt_info(2, 3);
  const Scalar _tmp77 = sqrt_info(1, 1) * sqrt_info(1, 3);
  const Scalar _tmp78 = sqrt_info(3, 1) * sqrt_info(3, 3);
  const Scalar _tmp79 = _tmp73 + _tmp74 + _tmp75 + _tmp76 + _tmp77 + _tmp78;
  const Scalar _tmp80 = sqrt_info(4, 1) * sqrt_info(4, 4);
  const Scalar _tmp81 = sqrt_info(5, 1) * sqrt_info(5, 4);
  const Scalar _tmp82 = sqrt_info(0, 1) * sqrt_info(0, 4);
  const Scalar _tmp83 = sqrt_info(2, 1) * sqrt_info(2, 4);
  const Scalar _tmp84 = sqrt_info(1, 1) * sqrt_info(1, 4);
  const Scalar _tmp85 = sqrt_info(3, 1) * sqrt_info(3, 4);
  const Scalar _tmp86 = _tmp80 + _tmp81 + _tmp82 + _tmp83 + _tmp84 + _tmp85;
  const Scalar _tmp87 = sqrt_info(4, 1) * sqrt_info(4, 5);
  const Scalar _tmp88 = sqrt_info(5, 1) * sqrt_info(5, 5);
  const Scalar _tmp89 = sqrt_info(0, 1) * sqrt_info(0, 5);
  const Scalar _tmp90 = sqrt_info(2, 1) * sqrt_info(2, 5);
  const Scalar _tmp91 = sqrt_info(1, 1) * sqrt_info(1, 5);
  const Scalar _tmp92 = sqrt_info(3, 1) * sqrt_info(3, 5);
  ...
  const Scalar _tmp100 = std::pow(sqrt_info(5, 2), Scalar(2));
  const Scalar _tmp101 = std::pow(sqrt_info(4, 2), Scalar(2));
  const Scalar _tmp102 = std::pow(sqrt_info(1, 2), Scalar(2));
  const Scalar _tmp103 = std::pow(sqrt_info(3, 2), Scalar(2));
  const Scalar _tmp104 = _tmp100 + _tmp101 + _tmp102 + _tmp103 + _tmp98 + _tmp99;
  const Scalar _tmp105 = sqrt_info(5, 2) * sqrt_info(5, 3);
  const Scalar _tmp106 = sqrt_info(4, 2) * sqrt_info(4, 3);
  const Scalar _tmp107 = sqrt_info(0, 2) * sqrt_info(0, 3);
  const Scalar _tmp108 = sqrt_info(2, 2) * sqrt_info(2, 3);
  const Scalar _tmp109 = sqrt_info(1, 2) * sqrt_info(1, 3);
  const Scalar _tmp110 = sqrt_info(3, 2) * sqrt_info(3, 3);
  const Scalar _tmp111 = _tmp105 + _tmp106 + _tmp107 + _tmp108 + _tmp109 + _tmp110;
  const Scalar _tmp112 = sqrt_info(5, 2) * sqrt_info(5, 4);
  const Scalar _tmp113 = sqrt_info(4, 2) * sqrt_info(4, 4);
  const Scalar _tmp114 = sqrt_info(0, 2) * sqrt_info(0, 4);
  const Scalar _tmp115 = sqrt_info(2, 2) * sqrt_info(2, 4);
  const Scalar _tmp116 = sqrt_info(1, 2) * sqrt_info(1, 4);
  const Scalar _tmp117 = sqrt_info(3, 2) * sqrt_info(3, 4);
  const Scalar _tmp118 = _tmp112 + _tmp113 + _tmp114 + _tmp115 + _tmp116 + _tmp117;
  const Scalar _tmp119 = sqrt_info(5, 2) * sqrt_info(5, 5);
  const Scalar _tmp120 = sqrt_info(4, 2) * sqrt_info(4, 5);
  const Scalar _tmp121 = sqrt_info(0, 2) * sqrt_info(0, 5);
  const Scalar _tmp122 = sqrt_info(2, 2) * sqrt_info(2, 5);
  const Scalar _tmp123 = sqrt_info(1, 2) * sqrt_info(1, 5);
  const Scalar _tmp124 = sqrt_info(3, 2) * sqrt_info(3, 5);
  ...
  const Scalar _tmp131 = std::pow(sqrt_info(5, 3), Scalar(2));
  const Scalar _tmp132 = std::pow(sqrt_info(4, 3), Scalar(2));
  const Scalar _tmp133 = std::pow(sqrt_info(1, 3), Scalar(2));
  const Scalar _tmp134 = std::pow(sqrt_info(3, 3), Scalar(2));
  const Scalar _tmp135 = _tmp129 + _tmp130 + _tmp131 + _tmp132 + _tmp133 + _tmp134;
  const Scalar _tmp136 = sqrt_info(5, 3) * sqrt_info(5, 4);
  const Scalar _tmp137 = sqrt_info(4, 3) * sqrt_info(4, 4);
  const Scalar _tmp138 = sqrt_info(0, 3) * sqrt_info(0, 4);
  const Scalar _tmp139 = sqrt_info(2, 3) * sqrt_info(2, 4);
  const Scalar _tmp140 = sqrt_info(1, 3) * sqrt_info(1, 4);
  const Scalar _tmp141 = sqrt_info(3, 3) * sqrt_info(3, 4);
  const Scalar _tmp142 = _tmp136 + _tmp137 + _tmp138 + _tmp139 + _tmp140 + _tmp141;
  const Scalar _tmp143 = sqrt_info(5, 3) * sqrt_info(5, 5);
  const Scalar _tmp144 = sqrt_info(4, 3) * sqrt_info(4, 5);
  const Scalar _tmp145 = sqrt_info(0, 3) * sqrt_info(0, 5);
  const Scalar _tmp146 = sqrt_info(2, 3) * sqrt_info(2, 5);
  const Scalar _tmp147 = sqrt_info(1, 3) * sqrt_info(1, 5);
  const Scalar _tmp148 = sqrt_info(3, 3) * sqrt_info(3, 5);
  ...
  const Scalar _tmp154 = std::pow(sqrt_info(5, 4), Scalar(2));
  const Scalar _tmp155 = std::pow(sqrt_info(4, 4), Scalar(2));
  const Scalar _tmp156 = std::pow(sqrt_info(1, 4), Scalar(2));
  const Scalar _tmp157 = std::pow(sqrt_info(3, 4), Scalar(2));
  const Scalar _tmp158 = _tmp152 + _tmp153 + _tmp154 + _tmp155 + _tmp156 + _tmp157;
  const Scalar _tmp159 = sqrt_info(5, 4) * sqrt_info(5, 5);
  const Scalar _tmp160 = sqrt_info(4, 4) * sqrt_info(4, 5);
  const Scalar _tmp161 = sqrt_info(0, 4) * sqrt_info(0, 5);
  const Scalar _tmp162 = sqrt_info(2, 4) * sqrt_info(2, 5);
  const Scalar _tmp163 = sqrt_info(1, 4) * sqrt_info(1, 5);
  const Scalar _tmp164 = sqrt_info(3, 4) * sqrt_info(3, 5);
  ...
  const Scalar _tmp169 = std::pow(sqrt_info(5, 5), Scalar(2));
  const Scalar _tmp170 = std::pow(sqrt_info(4, 5), Scalar(2));
  const Scalar _tmp171 = std::pow(sqrt_info(1, 5), Scalar(2));
  const Scalar _tmp172 = std::pow(sqrt_info(3, 5), Scalar(2));
  const Scalar _tmp173 = _tmp167 + _tmp168 + _tmp169 + _tmp170 + _tmp171 + _tmp172;
  const Scalar _tmp174 = _tmp10 * sqrt_info(4, 0);
  const Scalar _tmp175 = _tmp9 * sqrt_info(3, 0);
  const Scalar _tmp176 = _tmp8 * sqrt_info(2, 0);
  const Scalar _tmp177 = _tmp7 * sqrt_info(1, 0);
  const Scalar _tmp178 = _tmp11 * sqrt_info(5, 0);
  const Scalar _tmp179 = _tmp6 * sqrt_info(0, 0);
  const Scalar _tmp180 = _tmp10 * sqrt_info(4, 1);
  const Scalar _tmp181 = _tmp9 * sqrt_info(3, 1);
  const Scalar _tmp182 = _tmp8 * sqrt_info(2, 1);
  const Scalar _tmp183 = _tmp7 * sqrt_info(1, 1);
  const Scalar _tmp184 = _tmp11 * sqrt_info(5, 1);
  const Scalar _tmp185 = _tmp6 * sqrt_info(0, 1);
  const Scalar _tmp186 = _tmp10 * sqrt_info(4, 2);
  const Scalar _tmp187 = _tmp9 * sqrt_info(3, 2);
  const Scalar _tmp188 = _tmp8 * sqrt_info(2, 2);
  const Scalar _tmp189 = _tmp7 * sqrt_info(1, 2);
  const Scalar _tmp190 = _tmp11 * sqrt_info(5, 2);
  const Scalar _tmp191 = _tmp6 * sqrt_info(0, 2);
  const Scalar _tmp192 = _tmp10 * sqrt_info(4, 3);
  const Scalar _tmp193 = _tmp9 * sqrt_info(3, 3);
  const Scalar _tmp194 = _tmp8 * sqrt_info(2, 3);
  const Scalar _tmp195 = _tmp7 * sqrt_info(1, 3);
  const Scalar _tmp196 = _tmp11 * sqrt_info(5, 3);
  const Scalar _tmp197 = _tmp6 * sqrt_info(0, 3);
  const Scalar _tmp198 = _tmp10 * sqrt_info(4, 4);
  const Scalar _tmp199 = _tmp9 * sqrt_info(3, 4);
  const Scalar _tmp200 = _tmp8 * sqrt_info(2, 4);
  const Scalar _tmp201 = _tmp7 * sqrt_info(1, 4);
  const Scalar _tmp202 = _tmp11 * sqrt_info(5, 4);
  const Scalar _tmp203 = _tmp6 * sqrt_info(0, 4);
  const Scalar _tmp204 = _tmp10 * sqrt_info(4, 5);
  const Scalar _tmp205 = _tmp9 * sqrt_info(3, 5);
  const Scalar _tmp206 = _tmp8 * sqrt_info(2, 5);
  const Scalar _tmp207 = _tmp7 * sqrt_info(1, 5);
  const Scalar _tmp208 = _tmp11 * sqrt_info(5, 5);
  const Scalar _tmp209 = _tmp6 * sqrt_info(0, 5);
