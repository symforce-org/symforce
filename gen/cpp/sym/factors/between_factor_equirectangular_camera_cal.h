...
void BetweenFactorEquirectangularCameraCal(const sym::EquirectangularCameraCal<Scalar>& a,
                                           const sym::EquirectangularCameraCal<Scalar>& b,
                                           const sym::EquirectangularCameraCal<Scalar>& a_T_b,
  ...
  const Scalar _tmp0 = -_a[3] - _a_T_b[3] + _b[3];
  const Scalar _tmp1 = -_a[2] - _a_T_b[2] + _b[2];
  const Scalar _tmp2 = -_a[0] - _a_T_b[0] + _b[0];
  ...
  const Scalar _tmp10 = std::pow(sqrt_info(3, 0), Scalar(2));
  const Scalar _tmp11 = std::pow(sqrt_info(1, 0), Scalar(2));
  const Scalar _tmp12 = _tmp10 + _tmp11 + _tmp8 + _tmp9;
  const Scalar _tmp13 = sqrt_info(3, 0) * sqrt_info(3, 1);
  const Scalar _tmp14 = sqrt_info(1, 0) * sqrt_info(1, 1);
  const Scalar _tmp15 = sqrt_info(2, 0) * sqrt_info(2, 1);
  const Scalar _tmp16 = sqrt_info(0, 0) * sqrt_info(0, 1);
  const Scalar _tmp17 = _tmp13 + _tmp14 + _tmp15 + _tmp16;
  const Scalar _tmp18 = sqrt_info(3, 0) * sqrt_info(3, 2);
  const Scalar _tmp19 = sqrt_info(1, 0) * sqrt_info(1, 2);
  const Scalar _tmp20 = sqrt_info(2, 0) * sqrt_info(2, 2);
  const Scalar _tmp21 = sqrt_info(0, 0) * sqrt_info(0, 2);
  const Scalar _tmp22 = _tmp18 + _tmp19 + _tmp20 + _tmp21;
  const Scalar _tmp23 = sqrt_info(3, 0) * sqrt_info(3, 3);
  const Scalar _tmp24 = sqrt_info(1, 0) * sqrt_info(1, 3);
  const Scalar _tmp25 = sqrt_info(2, 0) * sqrt_info(2, 3);
  const Scalar _tmp26 = sqrt_info(0, 0) * sqrt_info(0, 3);
  ...
  const Scalar _tmp33 = std::pow(sqrt_info(3, 1), Scalar(2));
  const Scalar _tmp34 = std::pow(sqrt_info(1, 1), Scalar(2));
  const Scalar _tmp35 = _tmp31 + _tmp32 + _tmp33 + _tmp34;
  const Scalar _tmp36 = sqrt_info(3, 1) * sqrt_info(3, 2);
  const Scalar _tmp37 = sqrt_info(1, 1) * sqrt_info(1, 2);
  const Scalar _tmp38 = sqrt_info(2, 1) * sqrt_info(2, 2);
  const Scalar _tmp39 = sqrt_info(0, 1) * sqrt_info(0, 2);
  const Scalar _tmp40 = _tmp36 + _tmp37 + _tmp38 + _tmp39;
  const Scalar _tmp41 = sqrt_info(3, 1) * sqrt_info(3, 3);
  const Scalar _tmp42 = sqrt_info(1, 1) * sqrt_info(1, 3);
  const Scalar _tmp43 = sqrt_info(2, 1) * sqrt_info(2, 3);
  const Scalar _tmp44 = sqrt_info(0, 1) * sqrt_info(0, 3);
  ...
  const Scalar _tmp50 = std::pow(sqrt_info(3, 2), Scalar(2));
  const Scalar _tmp51 = std::pow(sqrt_info(1, 2), Scalar(2));
  const Scalar _tmp52 = _tmp48 + _tmp49 + _tmp50 + _tmp51;
  const Scalar _tmp53 = sqrt_info(3, 2) * sqrt_info(3, 3);
  const Scalar _tmp54 = sqrt_info(1, 2) * sqrt_info(1, 3);
  const Scalar _tmp55 = sqrt_info(2, 2) * sqrt_info(2, 3);
  const Scalar _tmp56 = sqrt_info(0, 2) * sqrt_info(0, 3);
  ...
  const Scalar _tmp61 = std::pow(sqrt_info(3, 3), Scalar(2));
  const Scalar _tmp62 = std::pow(sqrt_info(1, 3), Scalar(2));
  const Scalar _tmp63 = _tmp59 + _tmp60 + _tmp61 + _tmp62;
  const Scalar _tmp64 = _tmp4 * sqrt_info(0, 0);
  const Scalar _tmp65 = _tmp6 * sqrt_info(2, 0);
  const Scalar _tmp66 = _tmp5 * sqrt_info(1, 0);
  const Scalar _tmp67 = _tmp7 * sqrt_info(3, 0);
  const Scalar _tmp68 = _tmp4 * sqrt_info(0, 1);
  const Scalar _tmp69 = _tmp6 * sqrt_info(2, 1);
  const Scalar _tmp70 = _tmp5 * sqrt_info(1, 1);
  const Scalar _tmp71 = _tmp7 * sqrt_info(3, 1);
  const Scalar _tmp72 = _tmp4 * sqrt_info(0, 2);
  const Scalar _tmp73 = _tmp6 * sqrt_info(2, 2);
  const Scalar _tmp74 = _tmp5 * sqrt_info(1, 2);
  const Scalar _tmp75 = _tmp7 * sqrt_info(3, 2);
  const Scalar _tmp76 = _tmp4 * sqrt_info(0, 3);
  const Scalar _tmp77 = _tmp6 * sqrt_info(2, 3);
  const Scalar _tmp78 = _tmp5 * sqrt_info(1, 3);
