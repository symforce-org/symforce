...
void BetweenFactorMatrix31(const Eigen::Matrix<Scalar, 3, 1>& a,
  ...
  const Scalar _tmp6 = std::pow<Scalar>(sqrt_info(0, 0), 2);
  const Scalar _tmp7 = std::pow<Scalar>(sqrt_info(2, 0), 2);
  const Scalar _tmp8 = std::pow<Scalar>(sqrt_info(1, 0), 2);
  ...
  const Scalar _tmp14 = std::pow<Scalar>(sqrt_info(0, 1), 2);
  const Scalar _tmp15 = std::pow<Scalar>(sqrt_info(2, 1), 2);
  const Scalar _tmp16 = std::pow<Scalar>(sqrt_info(1, 1), 2);
  ...
  const Scalar _tmp26 = std::pow<Scalar>(sqrt_info(0, 2), 2);
  const Scalar _tmp27 = std::pow<Scalar>(sqrt_info(2, 2), 2);
  const Scalar _tmp28 = std::pow<Scalar>(sqrt_info(1, 2), 2);
