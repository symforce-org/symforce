...
void BetweenFactorMatrix31Isotropic(const Eigen::Matrix<Scalar, 3, 1>& a,
  ...
  const Scalar _tmp3 = -sqrt_info;
  const Scalar _tmp4 = std::pow(sqrt_info, Scalar(2));
  const Scalar _tmp5 = -_tmp4;
  const Scalar _tmp6 = _tmp0 * _tmp4;
