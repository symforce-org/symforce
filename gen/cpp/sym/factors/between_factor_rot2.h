...
void BetweenFactorRot2(const geo::Rot2<Scalar>& a, const geo::Rot2<Scalar>& b, const geo::Rot2<Scalar>& a_T_b, const Eigen::Matrix<Scalar, 1, 1>& sqrt_info, const Scalar epsilon, Eigen::Matrix<Scalar, 1, 1>* const res = nullptr, Eigen::Matrix<Scalar, 1, 2>* const jac = nullptr) {
    // Input arrays
