...
void BetweenFactorRot2(const sym::Rot2<Scalar>& a, const sym::Rot2<Scalar>& b,
  ...
  const Scalar _tmp13 = 2 / std::pow<Scalar>(_tmp2, 2);
  const Scalar _tmp14 = _tmp1 * _tmp13;
  const Scalar _tmp15 = _a[0] * _a[1] * _tmp13;
  const Scalar _tmp16 = _b[0] * _tmp15;
  const Scalar _tmp17 = -_b[1] * _tmp14 + _tmp16 + _tmp5;
  const Scalar _tmp18 = -_b[1] * _tmp15;
  const Scalar _tmp19 = -_b[0] * _tmp14 + _tmp18 + _tmp4;
  const Scalar _tmp20 = 1.0 / (_tmp12);
  const Scalar _tmp21 = std::pow<Scalar>(_tmp12, 2);
  const Scalar _tmp22 = _tmp11 / _tmp21;
  const Scalar _tmp23 = _tmp21 * sqrt_info(0, 0) / (std::pow<Scalar>(_tmp11, 2) + _tmp21);
  const Scalar _tmp24 = _tmp0 * _tmp13;
  const Scalar _tmp25 = -_b[1] * _tmp24 - _tmp16 + _tmp5;
  const Scalar _tmp26 = _b[0] * _tmp24 + _tmp18 - _tmp4;
  const Scalar _tmp27 = _a[1] * _tmp3;
  const Scalar _tmp28 = _a[0] * _tmp3;
  const Scalar _tmp29 = _tmp10 * _tmp28 - _tmp27 * _tmp8;
  const Scalar _tmp30 = _tmp10 * _tmp27;
  const Scalar _tmp31 = _tmp28 * _tmp8;
  ...
  if (jacobian != nullptr) {
    ...
    _jacobian(0, 0) = _a[0] * _tmp23 *
                          (_tmp20 * (_tmp10 * _tmp26 - _tmp25 * _tmp8) -
                           _tmp22 * (_tmp10 * _tmp25 + _tmp26 * _tmp8)) -
                      _a[1] * _tmp23 *
                          (_tmp20 * (_tmp10 * _tmp17 - _tmp19 * _tmp8) -
                           _tmp22 * (_tmp10 * _tmp19 + _tmp17 * _tmp8));
    _jacobian(0, 1) = _b[0] * _tmp23 * (_tmp20 * _tmp29 - _tmp22 * (_tmp30 + _tmp31)) -
                      _b[1] * _tmp23 * (_tmp20 * (-_tmp30 - _tmp31) - _tmp22 * _tmp29);
  }
