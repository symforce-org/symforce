...
void BetweenFactorRot2Isotropic(const sym::Rot2<Scalar>& a, const sym::Rot2<Scalar>& b,
                                const sym::Rot2<Scalar>& a_T_b, const Scalar sqrt_info,
