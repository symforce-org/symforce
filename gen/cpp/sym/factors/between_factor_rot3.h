...
void BetweenFactorRot3(const geo::Rot3<Scalar>& a, const geo::Rot3<Scalar>& b, const geo::Rot3<Scalar>& a_T_b, const Eigen::Matrix<Scalar, 3, 3>& sqrt_info, const Scalar epsilon, Eigen::Matrix<Scalar, 3, 1>* const res, Eigen::Matrix<Scalar, 3, 6>* const jac) {
    ...
    const Scalar _tmp14 = _a_T_b[0]*_tmp3 - _a_T_b[1]*_tmp1 - _a_T_b[2]*_tmp2 + _a_T_b[3]*_tmp0;
    const Scalar _tmp15 = _tmp12*sqrt_info(0, 1);
    const Scalar _tmp16 = -_a_T_b[0]*_tmp1 - _a_T_b[1]*_tmp3 + _a_T_b[2]*_tmp0 + _a_T_b[3]*_tmp2;
    ...
    const Scalar _tmp28 = (1.0/2.0)*((((-_tmp5 + _tmp6) > 0) - ((-_tmp5 + _tmp6) < 0)) + 1)*((((_tmp7 - _tmp8) > 0) - ((_tmp7 - _tmp8) < 0)) + 1);
    ...
    const Scalar _tmp67 = _tmp13*_tmp64 + _tmp15*_tmp39 + _tmp17*_tmp49 + _tmp27*_tmp31 + _tmp27*_tmp51 - _tmp27*_tmp54 - _tmp27*_tmp56 - _tmp27*_tmp66 + _tmp41*sqrt_info(0, 1);
    ...
    const Scalar _tmp81 = (1.0/2.0)*_tmp13*_tmp80 + (1.0/2.0)*_tmp15*_tmp76 + (1.0/2.0)*_tmp17*_tmp71 + (1.0/2.0)*_tmp51*_tmp73 - 1.0/2.0*_tmp54*_tmp73 - 1.0/2.0*_tmp56*_tmp73 - 1.0/2.0*_tmp66*_tmp73 + (1.0/2.0)*_tmp74*sqrt_info(0, 0) + (1.0/2.0)*_tmp77*sqrt_info(0, 1);
    ...
    const Scalar _tmp93 = _tmp13*_tmp92 + _tmp15*_tmp87 + _tmp17*_tmp90 - _tmp56*_tmp82 - _tmp66*_tmp82 + _tmp84*sqrt_info(0, 0) + _tmp85*sqrt_info(0, 1) - _tmp86*sqrt_info(0, 2) + _tmp88*sqrt_info(0, 2);
    ...
    const Scalar _tmp102 = _tmp100*sqrt_info(0, 1) + _tmp101*_tmp13 + _tmp15*_tmp98 + _tmp17*_tmp95 + _tmp51*_tmp96 - _tmp54*_tmp96 - _tmp66*_tmp96 - _tmp97*sqrt_info(0, 0) + _tmp99*sqrt_info(0, 0);
    const Scalar _tmp103 = (1.0/2.0)*_tmp102;
    const Scalar _tmp104 = (1.0/2.0)*_tmp93;
    const Scalar _tmp105 = -_a[0]*_a_T_b[0] - _a[1]*_a_T_b[1] - _a[2]*_a_T_b[2] + _a[3]*_a_T_b[3];
    ...
    const Scalar _tmp124 = (1.0/2.0)*_tmp105*_tmp118 + (1.0/2.0)*_tmp105*_tmp51 - 1.0/2.0*_tmp105*_tmp54 - 1.0/2.0*_tmp105*_tmp66 - 1.0/2.0*_tmp106*sqrt_info(0, 0) + (1.0/2.0)*_tmp107*sqrt_info(0, 0) + (1.0/2.0)*_tmp112*_tmp15 + (1.0/2.0)*_tmp117*_tmp17 + (1.0/2.0)*_tmp123*_tmp13;
    ...
    const Scalar _tmp131 = (1.0/2.0)*_tmp112*_tmp17 + (1.0/2.0)*_tmp125*_tmp31 + (1.0/2.0)*_tmp125*_tmp51 - 1.0/2.0*_tmp125*_tmp54 - 1.0/2.0*_tmp126*sqrt_info(0, 0) + (1.0/2.0)*_tmp127*_tmp15 + (1.0/2.0)*_tmp128*sqrt_info(0, 1) - 1.0/2.0*_tmp129*sqrt_info(0, 1) + (1.0/2.0)*_tmp130*sqrt_info(0, 2);
    ...
    const Scalar _tmp136 = _tmp117*_tmp13 + _tmp118*_tmp132 + _tmp125*_tmp17 + _tmp130*sqrt_info(0, 1) - _tmp132*_tmp54 - _tmp132*_tmp66 + _tmp133*sqrt_info(0, 0) - _tmp134*sqrt_info(0, 0) + _tmp135*sqrt_info(0, 2);
    const Scalar _tmp137 = (1.0/2.0)*_b[2];
    const Scalar _tmp138 = _tmp127*_tmp55;
    const Scalar _tmp139 = _tmp127*_tmp53;
    const Scalar _tmp140 = _tmp118*_tmp127 + _tmp123*_tmp15 + _tmp127*_tmp31 + _tmp127*_tmp51 - _tmp127*_tmp66 + _tmp13*_tmp132 + _tmp130*sqrt_info(0, 0) - _tmp138*sqrt_info(0, 0) - _tmp139*sqrt_info(0, 2);
    ...
    const Scalar _tmp150 = (1.0/2.0)*_tmp144*_tmp71 - 1.0/2.0*_tmp145*_tmp73 - 1.0/2.0*_tmp146*sqrt_info(1, 2) + (1.0/2.0)*_tmp147*_tmp73 + (1.0/2.0)*_tmp148*_tmp80 - 1.0/2.0*_tmp149*_tmp73 + (1.0/2.0)*_tmp19*_tmp76 + (1.0/2.0)*_tmp74*sqrt_info(1, 0) + (1.0/2.0)*_tmp77*sqrt_info(1, 1);
    const Scalar _tmp151 = _tmp30*sqrt_info(1, 0);
    const Scalar _tmp152 = _tmp27*_tmp53;
    const Scalar _tmp153 = _tmp144*_tmp49 - _tmp145*_tmp27 + _tmp147*_tmp27 + _tmp148*_tmp64 - _tmp149*_tmp27 + _tmp151*_tmp27 - _tmp152*sqrt_info(1, 2) + _tmp19*_tmp39 + _tmp41*sqrt_info(1, 1);
    const Scalar _tmp154 = (1.0/2.0)*_tmp153;
    const Scalar _tmp155 = _tmp144*_tmp90 - _tmp145*_tmp82 + _tmp148*_tmp92 - _tmp149*_tmp82 + _tmp19*_tmp87 + _tmp84*sqrt_info(1, 0) + _tmp85*sqrt_info(1, 1) - _tmp86*sqrt_info(1, 2) + _tmp88*sqrt_info(1, 2);
    const Scalar _tmp156 = _tmp53*_tmp96;
    const Scalar _tmp157 = _tmp12*_tmp95;
    const Scalar _tmp158 = _tmp100*sqrt_info(1, 1) + _tmp101*_tmp148 + _tmp147*_tmp96 - _tmp149*_tmp96 - _tmp156*sqrt_info(1, 2) + _tmp157*sqrt_info(1, 0) + _tmp19*_tmp98 - _tmp97*sqrt_info(1, 0) + _tmp99*sqrt_info(1, 0);
    ...
    const Scalar _tmp163 = (1.0/2.0)*_tmp112*_tmp144 + (1.0/2.0)*_tmp125*_tmp147 + (1.0/2.0)*_tmp125*_tmp151 - 1.0/2.0*_tmp126*sqrt_info(1, 0) + (1.0/2.0)*_tmp127*_tmp19 + (1.0/2.0)*_tmp128*sqrt_info(1, 1) - 1.0/2.0*_tmp129*sqrt_info(1, 1) + (1.0/2.0)*_tmp130*sqrt_info(1, 2) - 1.0/2.0*_tmp162*sqrt_info(1, 2);
    const Scalar _tmp164 = _tmp117*_tmp12;
    const Scalar _tmp165 = _tmp40*sqrt_info(1, 1);
    const Scalar _tmp166 = _tmp105*_tmp53;
    const Scalar _tmp167 = _tmp105*_tmp147 - _tmp105*_tmp149 + _tmp105*_tmp165 - _tmp106*sqrt_info(1, 0) + _tmp107*sqrt_info(1, 0) + _tmp112*_tmp19 + _tmp123*_tmp148 + _tmp164*sqrt_info(1, 0) - _tmp166*sqrt_info(1, 2);
    const Scalar _tmp168 = (1.0/2.0)*_tmp167;
    const Scalar _tmp169 = _tmp132*_tmp53;
    const Scalar _tmp170 = _tmp117*_tmp148 + _tmp125*_tmp144 + _tmp130*sqrt_info(1, 1) - _tmp132*_tmp149 + _tmp132*_tmp165 + _tmp133*sqrt_info(1, 0) - _tmp134*sqrt_info(1, 0) + _tmp135*sqrt_info(1, 2) - _tmp169*sqrt_info(1, 2);
    const Scalar _tmp171 = _tmp123*_tmp19 + _tmp127*_tmp147 - _tmp127*_tmp149 + _tmp127*_tmp151 + _tmp127*_tmp165 + _tmp130*sqrt_info(1, 0) + _tmp132*_tmp148 - _tmp138*sqrt_info(1, 0) - _tmp139*sqrt_info(1, 2);
    ...
    const Scalar _tmp178 = -_tmp152*sqrt_info(2, 2) + _tmp172*_tmp49 + _tmp173*_tmp27 - _tmp174*_tmp27 + _tmp175*_tmp27 + _tmp176*_tmp64 - _tmp177*_tmp27 + _tmp21*_tmp39 + _tmp41*sqrt_info(2, 1);
    const Scalar _tmp179 = (1.0/2.0)*_tmp178;
    const Scalar _tmp180 = _tmp172*_tmp90 - _tmp174*_tmp82 + _tmp176*_tmp92 - _tmp177*_tmp82 + _tmp21*_tmp87 + _tmp84*sqrt_info(2, 0) + _tmp85*sqrt_info(2, 1) - _tmp86*sqrt_info(2, 2) + _tmp88*sqrt_info(2, 2);
    const Scalar _tmp181 = -1.0/2.0*_tmp146*sqrt_info(2, 2) + (1.0/2.0)*_tmp172*_tmp71 + (1.0/2.0)*_tmp173*_tmp73 - 1.0/2.0*_tmp174*_tmp73 + (1.0/2.0)*_tmp175*_tmp73 + (1.0/2.0)*_tmp176*_tmp80 - 1.0/2.0*_tmp177*_tmp73 + (1.0/2.0)*_tmp21*_tmp76 + (1.0/2.0)*_tmp77*sqrt_info(2, 1);
    const Scalar _tmp182 = _tmp100*sqrt_info(2, 1) + _tmp101*_tmp176 - _tmp156*sqrt_info(2, 2) + _tmp157*sqrt_info(2, 0) + _tmp173*_tmp96 + _tmp175*_tmp96 - _tmp177*_tmp96 + _tmp21*_tmp98 - _tmp97*sqrt_info(2, 0);
    const Scalar _tmp183 = (1.0/2.0)*_tmp182;
    const Scalar _tmp184 = _tmp105*sqrt_info(2, 1);
    const Scalar _tmp185 = _tmp105*_tmp175 - _tmp106*sqrt_info(2, 0) + _tmp107*sqrt_info(2, 0) + _tmp112*_tmp21 + _tmp123*_tmp176 + _tmp164*sqrt_info(2, 0) - _tmp166*sqrt_info(2, 2) + _tmp184*_tmp40 - _tmp184*_tmp65;
    const Scalar _tmp186 = (1.0/2.0)*_tmp185;
    const Scalar _tmp187 = (1.0/2.0)*_tmp112*_tmp172 + (1.0/2.0)*_tmp125*_tmp173 + (1.0/2.0)*_tmp125*_tmp175 - 1.0/2.0*_tmp125*_tmp177 - 1.0/2.0*_tmp126*sqrt_info(2, 0) + (1.0/2.0)*_tmp127*_tmp21 + (1.0/2.0)*_tmp128*sqrt_info(2, 1) + (1.0/2.0)*_tmp130*sqrt_info(2, 2) - 1.0/2.0*_tmp162*sqrt_info(2, 2);
    const Scalar _tmp188 = _tmp40*sqrt_info(2, 1);
    const Scalar _tmp189 = _tmp117*_tmp176 + _tmp12*_tmp184 + _tmp125*_tmp172 + _tmp132*_tmp173 - _tmp132*_tmp177 + _tmp132*_tmp188 - _tmp134*sqrt_info(2, 0) + _tmp135*sqrt_info(2, 2) - _tmp169*sqrt_info(2, 2);
