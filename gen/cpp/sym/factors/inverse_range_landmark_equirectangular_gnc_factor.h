...
void InverseRangeLandmarkEquirectangularGncFactor(
  ...
  const Scalar _tmp22 = _source_pose[2] * _tmp6;
  ...
  const Scalar _tmp40 = _source_pose[2] * _tmp20;
  const Scalar _tmp41 = _tmp39 + _tmp40;
  const Scalar _tmp42 = std::pow(_source_pose[0], Scalar(2));
  const Scalar _tmp43 = -2 * _tmp42;
  const Scalar _tmp44 = _tmp18 * _tmp41 + _tmp25 * (_tmp29 + _tmp43) + _tmp30 * _tmp37 +
  ...
  const Scalar _tmp54 = _tmp18 * (_tmp27 + _tmp43 + 1) + _tmp25 * _tmp53 + _tmp30 * _tmp51 +
  ...
  const Scalar _tmp83 = std::max<Scalar>(
      0, std::min<Scalar>(
             (((Scalar(M_PI) - std::fabs(_tmp9)) > 0) - ((Scalar(M_PI) - std::fabs(_tmp9)) < 0)),
             (((-std::fabs(_tmp11) + Scalar(M_PI_2)) > 0) -
              ((-std::fabs(_tmp11) + Scalar(M_PI_2)) < 0))));
  const Scalar _tmp84 = std::pow(_tmp74, Scalar(2));
  const Scalar _tmp85 = std::max<Scalar>(0, (((_tmp76 + _tmp84) > 0) - ((_tmp76 + _tmp84) < 0)));
  const Scalar _tmp86 = Scalar(1.0) / (epsilon - gnc_mu + 1);
  const Scalar _tmp87 = epsilon + std::fabs(_tmp86);
  const Scalar _tmp88 = 2 - _tmp86;
  const Scalar _tmp89 = _tmp88 + epsilon * std::copysign(Scalar(1.0), _tmp88);
  const Scalar _tmp90 = std::pow(gnc_scale, Scalar(-2));
  const Scalar _tmp91 = _tmp80 * _tmp90 / _tmp87 + 1;
  const Scalar _tmp92 = (Scalar(1) / Scalar(2)) * _tmp89;
  const Scalar _tmp93 =
      std::sqrt(Scalar(2)) * std::sqrt(Scalar(_tmp87 * (std::pow(_tmp91, _tmp92) - 1) / _tmp89));
  const Scalar _tmp94 = _tmp82 * _tmp83 * _tmp85 * _tmp93;
  const Scalar _tmp95 = _tmp81 * _tmp94;
  const Scalar _tmp96 = _tmp68 * _tmp95;
  const Scalar _tmp97 = _tmp79 * _tmp95;
  const Scalar _tmp98 = -_tmp40;
  const Scalar _tmp99 = std::pow(_source_pose[3], Scalar(2));
  const Scalar _tmp100 = -_tmp26;
  const Scalar _tmp101 = _tmp100 + _tmp99;
  const Scalar _tmp102 = -_tmp42;
  const Scalar _tmp103 = _tmp102 + _tmp28;
  const Scalar _tmp104 = _tmp18 * (_tmp39 + _tmp98) + _tmp25 * (_tmp101 + _tmp103);
  const Scalar _tmp105 = -_tmp21;
  const Scalar _tmp106 = _tmp18 * (_tmp105 + _tmp22) + _tmp25 * _tmp8;
  const Scalar _tmp107 = -_tmp99;
  const Scalar _tmp108 = _tmp18 * (_tmp100 + _tmp107 + _tmp28 + _tmp42) + _tmp25 * _tmp41;
  ...
  const Scalar _tmp113 = _tmp104 * _tmp49 + _tmp106 * _tmp4 + _tmp108 * _tmp35;
  ...
  const Scalar _tmp120 = 2 * _tmp66;
  const Scalar _tmp121 = std::pow(_tmp78, Scalar(2));
  const Scalar _tmp122 = _tmp74 / _tmp77;
  const Scalar _tmp123 = _tmp122 / _tmp121;
  const Scalar _tmp124 = (Scalar(1) / Scalar(2)) * _tmp123;
  const Scalar _tmp125 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp126 = -_tmp124 * (_tmp109 * _tmp120 + _tmp113 * _tmp119) +
                         _tmp125 * (_tmp104 * _tmp72 + _tmp106 * _tmp71 + _tmp108 * _tmp69);
  const Scalar _tmp127 = _target_calibration[1] / (_tmp121 + _tmp84);
  const Scalar _tmp128 = _tmp127 * _tmp79;
  const Scalar _tmp129 = 2 * _tmp128;
  const Scalar _tmp130 = _tmp121 * _tmp129;
  const Scalar _tmp131 = _tmp114 * _tmp118 + _tmp126 * _tmp130;
  const Scalar _tmp132 = (Scalar(1) / Scalar(2)) * _tmp68;
  const Scalar _tmp133 = _tmp94 / (_tmp80 * std::sqrt(_tmp80));
  const Scalar _tmp134 = _tmp132 * _tmp133;
  const Scalar _tmp135 = _tmp115 * _tmp95;
  const Scalar _tmp136 = _tmp110 * _tmp135;
  const Scalar _tmp137 =
      _tmp81 * _tmp82 * _tmp83 * _tmp85 * _tmp90 * std::pow(_tmp91, Scalar(_tmp92 - 1)) / _tmp93;
  const Scalar _tmp138 = _tmp132 * _tmp137;
  const Scalar _tmp139 = _tmp114 * _tmp136 - _tmp131 * _tmp134 + _tmp131 * _tmp138;
  const Scalar _tmp140 = (Scalar(1) / Scalar(2)) * _tmp79;
  const Scalar _tmp141 = _tmp137 * _tmp140;
  const Scalar _tmp142 = _tmp127 * _tmp95;
  const Scalar _tmp143 = _tmp121 * _tmp142;
  const Scalar _tmp144 = _tmp133 * _tmp140;
  const Scalar _tmp145 = _tmp126 * _tmp143 + _tmp131 * _tmp141 - _tmp131 * _tmp144;
  const Scalar _tmp146 = -_tmp28;
  const Scalar _tmp147 = _tmp146 + _tmp42;
  const Scalar _tmp148 = _tmp107 + _tmp26;
  const Scalar _tmp149 = _tmp18 * _tmp51 + _tmp30 * (_tmp147 + _tmp148);
  const Scalar _tmp150 = _tmp18 * _tmp37 + _tmp30 * (_tmp38 + _tmp98);
  const Scalar _tmp151 = -_tmp5;
  const Scalar _tmp152 = _tmp18 * (_tmp101 + _tmp147) + _tmp30 * (_tmp151 + _tmp50);
  const Scalar _tmp153 = _tmp149 * _tmp59 + _tmp150 * _tmp64 + _tmp152 * _tmp60;
  const Scalar _tmp154 = _tmp149 * _tmp49 + _tmp150 * _tmp35 + _tmp152 * _tmp4;
  const Scalar _tmp155 = -_tmp124 * (_tmp119 * _tmp154 + _tmp120 * _tmp153) +
                         _tmp125 * (_tmp149 * _tmp72 + _tmp150 * _tmp69 + _tmp152 * _tmp71);
  const Scalar _tmp156 = -_tmp111 * _tmp153 + _tmp112 * _tmp154;
  const Scalar _tmp157 = _tmp118 * _tmp156 + _tmp130 * _tmp155;
  const Scalar _tmp158 = -_tmp134 * _tmp157 + _tmp136 * _tmp156 + _tmp138 * _tmp157;
  const Scalar _tmp159 = _tmp141 * _tmp157 + _tmp143 * _tmp155 - _tmp144 * _tmp157;
  const Scalar _tmp160 =
      _tmp25 * (_tmp105 + _tmp23) + _tmp30 * (_tmp102 + _tmp146 + _tmp26 + _tmp99);
  const Scalar _tmp161 = _tmp25 * (_tmp151 + _tmp7) + _tmp30 * _tmp53;
  const Scalar _tmp162 = _tmp24 * _tmp30 + _tmp25 * (_tmp103 + _tmp148);
  const Scalar _tmp163 = _tmp160 * _tmp35 + _tmp161 * _tmp49 + _tmp162 * _tmp4;
  const Scalar _tmp164 = _tmp160 * _tmp64 + _tmp161 * _tmp59 + _tmp162 * _tmp60;
  const Scalar _tmp165 = -_tmp111 * _tmp164 + _tmp112 * _tmp163;
  const Scalar _tmp166 = -_tmp124 * (_tmp119 * _tmp163 + _tmp120 * _tmp164) +
                         _tmp125 * (_tmp160 * _tmp69 + _tmp161 * _tmp72 + _tmp162 * _tmp71);
  const Scalar _tmp167 = _tmp118 * _tmp165 + _tmp130 * _tmp166;
  const Scalar _tmp168 = -_tmp134 * _tmp167 + _tmp136 * _tmp165 + _tmp138 * _tmp167;
  const Scalar _tmp169 = _tmp141 * _tmp167 + _tmp143 * _tmp166 - _tmp144 * _tmp167;
  ...
  const Scalar _tmp175 = _tmp125 * source_inverse_range;
  const Scalar _tmp176 = _tmp175 * _tmp71;
  const Scalar _tmp177 = _tmp119 * source_inverse_range;
  const Scalar _tmp178 = _tmp177 * _tmp4;
  const Scalar _tmp179 = _tmp120 * source_inverse_range;
  const Scalar _tmp180 = _tmp179 * _tmp60;
  const Scalar _tmp181 = -_tmp124 * (_tmp178 + _tmp180) + _tmp176;
  const Scalar _tmp182 = _tmp118 * _tmp174 + _tmp130 * _tmp181;
  const Scalar _tmp183 = -_tmp134 * _tmp182 + _tmp136 * _tmp174 + _tmp138 * _tmp182;
  const Scalar _tmp184 = _tmp141 * _tmp182 + _tmp143 * _tmp181 - _tmp144 * _tmp182;
  const Scalar _tmp185 = _tmp172 * _tmp35;
  const Scalar _tmp186 = _tmp170 * _tmp64;
  const Scalar _tmp187 = _tmp185 - _tmp186;
  const Scalar _tmp188 = _tmp177 * _tmp35;
  const Scalar _tmp189 = _tmp179 * _tmp64;
  const Scalar _tmp190 = _tmp175 * _tmp69;
  const Scalar _tmp191 = -_tmp124 * (_tmp188 + _tmp189) + _tmp190;
  const Scalar _tmp192 = _tmp118 * _tmp187 + _tmp130 * _tmp191;
  const Scalar _tmp193 = -_tmp134 * _tmp192 + _tmp136 * _tmp187 + _tmp138 * _tmp192;
  const Scalar _tmp194 = _tmp141 * _tmp192 + _tmp143 * _tmp191 - _tmp144 * _tmp192;
  const Scalar _tmp195 = _tmp172 * _tmp49;
  const Scalar _tmp196 = _tmp170 * _tmp59;
  const Scalar _tmp197 = _tmp195 - _tmp196;
  const Scalar _tmp198 = _tmp175 * _tmp72;
  const Scalar _tmp199 = _tmp179 * _tmp59;
  const Scalar _tmp200 = _tmp177 * _tmp49;
  const Scalar _tmp201 = -_tmp124 * (_tmp199 + _tmp200) + _tmp198;
  const Scalar _tmp202 = _tmp118 * _tmp197 + _tmp130 * _tmp201;
  const Scalar _tmp203 = -_tmp134 * _tmp202 + _tmp136 * _tmp197 + _tmp138 * _tmp202;
  const Scalar _tmp204 = _tmp141 * _tmp202 + _tmp143 * _tmp201 - _tmp144 * _tmp202;
  const Scalar _tmp205 = -_tmp34;
  const Scalar _tmp206 = -_tmp0;
  const Scalar _tmp207 = _tmp2 + _tmp206;
  const Scalar _tmp208 = std::pow(_target_pose[3], Scalar(2));
  const Scalar _tmp209 = -_tmp208;
  const Scalar _tmp210 = _tmp209 + _tmp57;
  const Scalar _tmp211 = -_tmp61;
  const Scalar _tmp212 =
      _tmp31 * (_tmp205 + _tmp33) + _tmp44 * (_tmp207 + _tmp210) + _tmp54 * (_tmp211 + _tmp63);
  const Scalar _tmp213 = -_tmp57;
  const Scalar _tmp214 = _tmp208 + _tmp213;
  const Scalar _tmp215 =
      -_tmp123 * _tmp212 * _tmp66 + _tmp125 * (_tmp54 * (_tmp207 + _tmp214) + _tmp65);
  const Scalar _tmp216 = -_tmp116 * _tmp119 * _tmp212 + _tmp130 * _tmp215;
  const Scalar _tmp217 = _tmp132 * _tmp216;
  const Scalar _tmp218 = -_tmp133 * _tmp217 - _tmp135 * _tmp212 * _tmp56 + _tmp137 * _tmp217;
  const Scalar _tmp219 = _tmp141 * _tmp216 + _tmp143 * _tmp215 - _tmp144 * _tmp216;
  const Scalar _tmp220 = -_tmp46;
  const Scalar _tmp221 = -_tmp2;
  const Scalar _tmp222 = _tmp0 + _tmp221;
  const Scalar _tmp223 =
      _tmp31 * (_tmp220 + _tmp48) + _tmp44 * (_tmp211 + _tmp62) + _tmp54 * (_tmp210 + _tmp222);
  const Scalar _tmp224 = _tmp31 * (_tmp206 + _tmp208 + _tmp221 + _tmp57) + _tmp55;
  const Scalar _tmp225 = -_tmp111 * _tmp224 + _tmp112 * _tmp223;
  const Scalar _tmp226 = _tmp122 * (_tmp119 * _tmp223 + _tmp120 * _tmp224);
  const Scalar _tmp227 = _tmp118 * _tmp225 - _tmp128 * _tmp226;
  const Scalar _tmp228 = -_tmp134 * _tmp227 + _tmp136 * _tmp225 + _tmp138 * _tmp227;
  const Scalar _tmp229 =
      _tmp141 * _tmp227 - Scalar(1) / Scalar(2) * _tmp142 * _tmp226 - _tmp144 * _tmp227;
  const Scalar _tmp230 = _tmp44 * (_tmp214 + _tmp222) + _tmp73;
  const Scalar _tmp231 = _tmp230 * _tmp67;
  const Scalar _tmp232 = -_tmp123 * _tmp230 * _tmp56 +
                         _tmp125 * (_tmp31 * (_tmp0 + _tmp2 + _tmp209 + _tmp213) +
                                    _tmp44 * (_tmp205 + _tmp70) + _tmp54 * (_tmp220 + _tmp47));
  const Scalar _tmp233 = _tmp117 * _tmp231 + _tmp130 * _tmp232;
  const Scalar _tmp234 = -_tmp134 * _tmp233 + _tmp135 * _tmp231 + _tmp138 * _tmp233;
  const Scalar _tmp235 = _tmp141 * _tmp233 + _tmp143 * _tmp232 - _tmp144 * _tmp233;
  const Scalar _tmp236 = _tmp171 - _tmp173;
  const Scalar _tmp237 = -_tmp124 * (-_tmp178 - _tmp180) - _tmp176;
  const Scalar _tmp238 = _tmp118 * _tmp236 + _tmp130 * _tmp237;
  const Scalar _tmp239 = -_tmp134 * _tmp238 + _tmp136 * _tmp236 + _tmp138 * _tmp238;
  const Scalar _tmp240 = _tmp141 * _tmp238 + _tmp143 * _tmp237 - _tmp144 * _tmp238;
  const Scalar _tmp241 = _tmp110 * (-_tmp185 + _tmp186);
  const Scalar _tmp242 = -_tmp124 * (-_tmp188 - _tmp189) - _tmp190;
  const Scalar _tmp243 = _tmp117 * _tmp241 + _tmp130 * _tmp242;
  const Scalar _tmp244 = -_tmp134 * _tmp243 + _tmp135 * _tmp241 + _tmp138 * _tmp243;
  const Scalar _tmp245 = _tmp141 * _tmp243 + _tmp143 * _tmp242 - _tmp144 * _tmp243;
  const Scalar _tmp246 = -_tmp195 + _tmp196;
  const Scalar _tmp247 = _tmp121 * (-_tmp124 * (-_tmp199 - _tmp200) - _tmp198);
  const Scalar _tmp248 = _tmp118 * _tmp246 + _tmp129 * _tmp247;
  const Scalar _tmp249 = -_tmp134 * _tmp248 + _tmp136 * _tmp246 + _tmp138 * _tmp248;
  const Scalar _tmp250 = _tmp141 * _tmp248 + _tmp142 * _tmp247 - _tmp144 * _tmp248;
  const Scalar _tmp251 = _tmp19 * _tmp60 + _tmp36 * _tmp64 + _tmp52 * _tmp59;
  const Scalar _tmp252 = _tmp19 * _tmp4 + _tmp35 * _tmp36 + _tmp49 * _tmp52;
  const Scalar _tmp253 = -_tmp111 * _tmp251 + _tmp112 * _tmp252;
  const Scalar _tmp254 = -_tmp124 * (_tmp119 * _tmp252 + _tmp120 * _tmp251) +
                         _tmp125 * (_tmp19 * _tmp71 + _tmp36 * _tmp69 + _tmp52 * _tmp72);
  const Scalar _tmp255 = _tmp118 * _tmp253 + _tmp130 * _tmp254;
  const Scalar _tmp256 = -_tmp134 * _tmp255 + _tmp136 * _tmp253 + _tmp138 * _tmp255;
  const Scalar _tmp257 = _tmp141 * _tmp255 + _tmp143 * _tmp254 - _tmp144 * _tmp255;
  ...
  if (jacobian != nullptr) {
    ...
    _jacobian(0, 3) = _tmp183;
    _jacobian(1, 3) = _tmp184;
    _jacobian(0, 4) = _tmp193;
    _jacobian(1, 4) = _tmp194;
  ...
  if (hessian != nullptr) {
    ...
    _hessian(3, 0) = _tmp139 * _tmp183 + _tmp145 * _tmp184;
    _hessian(4, 0) = _tmp139 * _tmp193 + _tmp145 * _tmp194;
    _hessian(5, 0) = _tmp139 * _tmp203 + _tmp145 * _tmp204;
    ...
    _hessian(3, 1) = _tmp158 * _tmp183 + _tmp159 * _tmp184;
    _hessian(4, 1) = _tmp158 * _tmp193 + _tmp159 * _tmp194;
    _hessian(5, 1) = _tmp158 * _tmp203 + _tmp159 * _tmp204;
    ...
    _hessian(3, 2) = _tmp168 * _tmp183 + _tmp169 * _tmp184;
    _hessian(4, 2) = _tmp168 * _tmp193 + _tmp169 * _tmp194;
    _hessian(5, 2) = _tmp168 * _tmp203 + _tmp169 * _tmp204;
    ...
    _hessian(1, 3) = 0;
    _hessian(2, 3) = 0;
    _hessian(3, 3) = std::pow(_tmp183, Scalar(2)) + std::pow(_tmp184, Scalar(2));
    _hessian(4, 3) = _tmp183 * _tmp193 + _tmp184 * _tmp194;
    _hessian(5, 3) = _tmp183 * _tmp203 + _tmp184 * _tmp204;
    _hessian(6, 3) = _tmp183 * _tmp218 + _tmp184 * _tmp219;
    _hessian(7, 3) = _tmp183 * _tmp228 + _tmp184 * _tmp229;
    _hessian(8, 3) = _tmp183 * _tmp234 + _tmp184 * _tmp235;
    _hessian(9, 3) = _tmp183 * _tmp239 + _tmp184 * _tmp240;
    _hessian(10, 3) = _tmp183 * _tmp244 + _tmp184 * _tmp245;
    _hessian(11, 3) = _tmp183 * _tmp249 + _tmp184 * _tmp250;
    _hessian(12, 3) = _tmp183 * _tmp256 + _tmp184 * _tmp257;
    _hessian(0, 4) = 0;
    _hessian(1, 4) = 0;
    _hessian(2, 4) = 0;
    _hessian(3, 4) = 0;
    _hessian(4, 4) = std::pow(_tmp193, Scalar(2)) + std::pow(_tmp194, Scalar(2));
    _hessian(5, 4) = _tmp193 * _tmp203 + _tmp194 * _tmp204;
    _hessian(6, 4) = _tmp193 * _tmp218 + _tmp194 * _tmp219;
    _hessian(7, 4) = _tmp193 * _tmp228 + _tmp194 * _tmp229;
    _hessian(8, 4) = _tmp193 * _tmp234 + _tmp194 * _tmp235;
    _hessian(9, 4) = _tmp193 * _tmp239 + _tmp194 * _tmp240;
    _hessian(10, 4) = _tmp193 * _tmp244 + _tmp194 * _tmp245;
    _hessian(11, 4) = _tmp193 * _tmp249 + _tmp194 * _tmp250;
    _hessian(12, 4) = _tmp193 * _tmp256 + _tmp194 * _tmp257;
    _hessian(0, 5) = 0;
    _hessian(1, 5) = 0;
    _hessian(2, 5) = 0;
    _hessian(3, 5) = 0;
    ...
    _hessian(6, 5) = _tmp203 * _tmp218 + _tmp204 * _tmp219;
    _hessian(7, 5) = _tmp203 * _tmp228 + _tmp204 * _tmp229;
    _hessian(8, 5) = _tmp203 * _tmp234 + _tmp204 * _tmp235;
    _hessian(9, 5) = _tmp203 * _tmp239 + _tmp204 * _tmp240;
  ...
  if (rhs != nullptr) {
    ...
    _rhs(3, 0) = _tmp183 * _tmp96 + _tmp184 * _tmp97;
    _rhs(4, 0) = _tmp193 * _tmp96 + _tmp194 * _tmp97;
