...
void OrthographicReprojectionDelta(const sym::Pose3<Scalar>& source_pose,
  ...
  const Scalar _tmp9 = _source_pose[0] * _tmp5;
  ...
  const Scalar _tmp16 = _tmp12 * (-_tmp11 + _tmp9) + _tmp15 * (_tmp13 + _tmp14) +
                        _tmp8 * (_tmp4 + _tmp6) +
                        source_inverse_range * (_source_pose[6] - _target_pose[6]);
  const Scalar _tmp17 = _target_pose[3] * _tmp0;
  const Scalar _tmp18 = _target_pose[0] * _tmp2;
  const Scalar _tmp19 = _source_pose[0] * _tmp10;
  const Scalar _tmp20 = _source_pose[3] * _tmp5;
  const Scalar _tmp21 = -2 * std::pow(_source_pose[2], Scalar(2));
  const Scalar _tmp22 = _tmp12 * (_tmp19 + _tmp20) + _tmp15 * (-_tmp4 + _tmp6) +
  ...
  const Scalar _tmp25 = _tmp12 * (_tmp14 + _tmp21) + _tmp15 * (_tmp11 + _tmp9) +
                        _tmp8 * (_tmp19 - _tmp20) +
                        source_inverse_range * (_source_pose[4] - _target_pose[4]);
  const Scalar _tmp26 = _target_pose[2] * _tmp2;
  const Scalar _tmp27 = 2 * _target_pose[0] * _target_pose[3];
  ...
  if (reprojection_delta != nullptr) {
    ...
    _reprojection_delta(1, 0) =
        _target_calibration[1] * (_tmp16 * (_tmp26 + _tmp27) + _tmp22 * (_tmp23 + _tmp28 + 1) +
                                  _tmp25 * (-_tmp17 + _tmp18)) +
  ...
  if (is_valid != nullptr) {
    ...
    _is_valid = std::max<Scalar>(0, (((_tmp16 * (_tmp24 + _tmp28) + _tmp22 * (_tmp26 - _tmp27) +
                                       _tmp25 * (_tmp1 + _tmp3)) > 0) -
                                     ((_tmp16 * (_tmp24 + _tmp28) + _tmp22 * (_tmp26 - _tmp27) +
                                       _tmp25 * (_tmp1 + _tmp3)) < 0)));
  }
