...
void OrthographicReprojectionDelta(const sym::Pose3<Scalar>& source_pose,
  ...
  const Scalar _tmp17 = 2 * _target_pose[0] * _target_pose[2];
  ...
  const Scalar _tmp26 = -2 * std::pow(_target_pose[0], Scalar(2));
  const Scalar _tmp27 = _target_pose[2] * _tmp2;
  ...
  if (reprojection_delta != nullptr) {
    ...
    _reprojection_delta(1, 0) =
        _target_calibration[1] * (_tmp16 * (_tmp23 + _tmp26 + 1) + _tmp22 * (_tmp27 + _tmp28) +
                                  _tmp25 * (-_tmp1 + _tmp3)) +
  ...
  if (is_valid != nullptr) {
    ...
    _is_valid = std::max<Scalar>(0, (((_tmp16 * (_tmp27 - _tmp28) + _tmp22 * (_tmp24 + _tmp26) +
                                       _tmp25 * (_tmp17 + _tmp18)) > 0) -
                                     ((_tmp16 * (_tmp27 - _tmp28) + _tmp22 * (_tmp24 + _tmp26) +
                                       _tmp25 * (_tmp17 + _tmp18)) < 0)));
  }
