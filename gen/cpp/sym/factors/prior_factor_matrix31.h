...
void PriorFactorMatrix31(const Eigen::Matrix<Scalar, 3, 1>& value,
  ...
  const Scalar _tmp2 = _tmp0 * sqrt_info(0, 1) + _tmp1 * sqrt_info(0, 2) +
                       sqrt_info(0, 0) * (-prior(0, 0) + value(0, 0));
  ...
  if (hessian != nullptr) {
    ...
    _hessian(0, 0) = std::pow(sqrt_info(0, 0), Scalar(2));
    _hessian(1, 0) = sqrt_info(0, 0) * sqrt_info(0, 1);
    _hessian(2, 0) = sqrt_info(0, 0) * sqrt_info(0, 2);
    _hessian(0, 1) = 0;
  ...
  if (rhs != nullptr) {
    ...
    _rhs(0, 0) = _tmp2 * sqrt_info(0, 0);
    _rhs(1, 0) = _tmp2 * sqrt_info(0, 1) + _tmp3 * sqrt_info(1, 1);
    _rhs(2, 0) = _tmp1 * _tmp4 + _tmp2 * sqrt_info(0, 2) + _tmp3 * sqrt_info(1, 2);
  }
