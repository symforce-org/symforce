 ...
 *     jacobian: (8x8) jacobian of res wrt arg value (8)
 *     hessian: (8x8) Gauss-Newton hessian for arg value (8)
 *     rhs: (8x1) Gauss-Newton rhs for arg value (8)
 */
template <typename Scalar>
void PriorFactorPolynomialCameraCal(const sym::PolynomialCameraCal<Scalar>& value,
                                    const sym::PolynomialCameraCal<Scalar>& prior,
                                    const Eigen::Matrix<Scalar, 8, 8>& sqrt_info,
                                    const Scalar epsilon,
                                    Eigen::Matrix<Scalar, 8, 1>* const res = nullptr,
                                    Eigen::Matrix<Scalar, 8, 8>* const jacobian = nullptr,
  ...
  // Input arrays
  const Eigen::Matrix<Scalar, 8, 1>& _value = value.Data();
  ...
  if (jacobian != nullptr) {
    Eigen::Matrix<Scalar, 8, 8>& _jacobian = (*jacobian);
  ...
  if (hessian != nullptr) {
    ...
    _hessian(0, 0) = std::pow(sqrt_info(0, 0), Scalar(2)) + std::pow(sqrt_info(1, 0), Scalar(2)) +
                     ...
                     std::pow(sqrt_info(4, 0), Scalar(2)) + std::pow(sqrt_info(5, 0), Scalar(2)) +
                     std::pow(sqrt_info(6, 0), Scalar(2)) + std::pow(sqrt_info(7, 0), Scalar(2));
    _hessian(1, 0) = sqrt_info(0, 0) * sqrt_info(0, 1) + sqrt_info(1, 0) * sqrt_info(1, 1) +
                     ...
                     sqrt_info(4, 0) * sqrt_info(4, 1) + sqrt_info(5, 0) * sqrt_info(5, 1) +
                     sqrt_info(6, 0) * sqrt_info(6, 1) + sqrt_info(7, 0) * sqrt_info(7, 1);
    _hessian(2, 0) = sqrt_info(0, 0) * sqrt_info(0, 2) + sqrt_info(1, 0) * sqrt_info(1, 2) +
                     ...
                     sqrt_info(4, 0) * sqrt_info(4, 2) + sqrt_info(5, 0) * sqrt_info(5, 2) +
                     sqrt_info(6, 0) * sqrt_info(6, 2) + sqrt_info(7, 0) * sqrt_info(7, 2);
    _hessian(3, 0) = sqrt_info(0, 0) * sqrt_info(0, 3) + sqrt_info(1, 0) * sqrt_info(1, 3) +
                     ...
                     sqrt_info(4, 0) * sqrt_info(4, 3) + sqrt_info(5, 0) * sqrt_info(5, 3) +
                     sqrt_info(6, 0) * sqrt_info(6, 3) + sqrt_info(7, 0) * sqrt_info(7, 3);
    _hessian(4, 0) = sqrt_info(0, 0) * sqrt_info(0, 4) + sqrt_info(1, 0) * sqrt_info(1, 4) +
                     ...
                     sqrt_info(4, 0) * sqrt_info(4, 4) + sqrt_info(5, 0) * sqrt_info(5, 4) +
                     sqrt_info(6, 0) * sqrt_info(6, 4) + sqrt_info(7, 0) * sqrt_info(7, 4);
    _hessian(5, 0) = sqrt_info(0, 0) * sqrt_info(0, 5) + sqrt_info(1, 0) * sqrt_info(1, 5) +
                     sqrt_info(2, 0) * sqrt_info(2, 5) + sqrt_info(3, 0) * sqrt_info(3, 5) +
                     sqrt_info(4, 0) * sqrt_info(4, 5) + sqrt_info(5, 0) * sqrt_info(5, 5) +
                     sqrt_info(6, 0) * sqrt_info(6, 5) + sqrt_info(7, 0) * sqrt_info(7, 5);
    _hessian(6, 0) = sqrt_info(0, 0) * sqrt_info(0, 6) + sqrt_info(1, 0) * sqrt_info(1, 6) +
                     sqrt_info(2, 0) * sqrt_info(2, 6) + sqrt_info(3, 0) * sqrt_info(3, 6) +
                     sqrt_info(4, 0) * sqrt_info(4, 6) + sqrt_info(5, 0) * sqrt_info(5, 6) +
                     sqrt_info(6, 0) * sqrt_info(6, 6) + sqrt_info(7, 0) * sqrt_info(7, 6);
    _hessian(7, 0) = sqrt_info(0, 0) * sqrt_info(0, 7) + sqrt_info(1, 0) * sqrt_info(1, 7) +
                     sqrt_info(2, 0) * sqrt_info(2, 7) + sqrt_info(3, 0) * sqrt_info(3, 7) +
                     sqrt_info(4, 0) * sqrt_info(4, 7) + sqrt_info(5, 0) * sqrt_info(5, 7) +
                     sqrt_info(6, 0) * sqrt_info(6, 7) + sqrt_info(7, 0) * sqrt_info(7, 7);
    _hessian(0, 1) = 0;
    _hessian(1, 1) = std::pow(sqrt_info(0, 1), Scalar(2)) + std::pow(sqrt_info(1, 1), Scalar(2)) +
                     ...
                     std::pow(sqrt_info(4, 1), Scalar(2)) + std::pow(sqrt_info(5, 1), Scalar(2)) +
                     std::pow(sqrt_info(6, 1), Scalar(2)) + std::pow(sqrt_info(7, 1), Scalar(2));
    _hessian(2, 1) = sqrt_info(0, 1) * sqrt_info(0, 2) + sqrt_info(1, 1) * sqrt_info(1, 2) +
                     ...
                     sqrt_info(4, 1) * sqrt_info(4, 2) + sqrt_info(5, 1) * sqrt_info(5, 2) +
                     sqrt_info(6, 1) * sqrt_info(6, 2) + sqrt_info(7, 1) * sqrt_info(7, 2);
    _hessian(3, 1) = sqrt_info(0, 1) * sqrt_info(0, 3) + sqrt_info(1, 1) * sqrt_info(1, 3) +
                     ...
                     sqrt_info(4, 1) * sqrt_info(4, 3) + sqrt_info(5, 1) * sqrt_info(5, 3) +
                     sqrt_info(6, 1) * sqrt_info(6, 3) + sqrt_info(7, 1) * sqrt_info(7, 3);
    _hessian(4, 1) = sqrt_info(0, 1) * sqrt_info(0, 4) + sqrt_info(1, 1) * sqrt_info(1, 4) +
                     ...
                     sqrt_info(4, 1) * sqrt_info(4, 4) + sqrt_info(5, 1) * sqrt_info(5, 4) +
                     sqrt_info(6, 1) * sqrt_info(6, 4) + sqrt_info(7, 1) * sqrt_info(7, 4);
    _hessian(5, 1) = sqrt_info(0, 1) * sqrt_info(0, 5) + sqrt_info(1, 1) * sqrt_info(1, 5) +
                     sqrt_info(2, 1) * sqrt_info(2, 5) + sqrt_info(3, 1) * sqrt_info(3, 5) +
                     sqrt_info(4, 1) * sqrt_info(4, 5) + sqrt_info(5, 1) * sqrt_info(5, 5) +
                     sqrt_info(6, 1) * sqrt_info(6, 5) + sqrt_info(7, 1) * sqrt_info(7, 5);
    _hessian(6, 1) = sqrt_info(0, 1) * sqrt_info(0, 6) + sqrt_info(1, 1) * sqrt_info(1, 6) +
                     sqrt_info(2, 1) * sqrt_info(2, 6) + sqrt_info(3, 1) * sqrt_info(3, 6) +
                     sqrt_info(4, 1) * sqrt_info(4, 6) + sqrt_info(5, 1) * sqrt_info(5, 6) +
                     sqrt_info(6, 1) * sqrt_info(6, 6) + sqrt_info(7, 1) * sqrt_info(7, 6);
    _hessian(7, 1) = sqrt_info(0, 1) * sqrt_info(0, 7) + sqrt_info(1, 1) * sqrt_info(1, 7) +
                     sqrt_info(2, 1) * sqrt_info(2, 7) + sqrt_info(3, 1) * sqrt_info(3, 7) +
                     sqrt_info(4, 1) * sqrt_info(4, 7) + sqrt_info(5, 1) * sqrt_info(5, 7) +
                     sqrt_info(6, 1) * sqrt_info(6, 7) + sqrt_info(7, 1) * sqrt_info(7, 7);
    _hessian(0, 2) = 0;
    _hessian(1, 2) = 0;
    _hessian(2, 2) = std::pow(sqrt_info(0, 2), Scalar(2)) + std::pow(sqrt_info(1, 2), Scalar(2)) +
                     ...
                     std::pow(sqrt_info(4, 2), Scalar(2)) + std::pow(sqrt_info(5, 2), Scalar(2)) +
                     std::pow(sqrt_info(6, 2), Scalar(2)) + std::pow(sqrt_info(7, 2), Scalar(2));
    _hessian(3, 2) = sqrt_info(0, 2) * sqrt_info(0, 3) + sqrt_info(1, 2) * sqrt_info(1, 3) +
                     ...
                     sqrt_info(4, 2) * sqrt_info(4, 3) + sqrt_info(5, 2) * sqrt_info(5, 3) +
                     sqrt_info(6, 2) * sqrt_info(6, 3) + sqrt_info(7, 2) * sqrt_info(7, 3);
    _hessian(4, 2) = sqrt_info(0, 2) * sqrt_info(0, 4) + sqrt_info(1, 2) * sqrt_info(1, 4) +
                     ...
                     sqrt_info(4, 2) * sqrt_info(4, 4) + sqrt_info(5, 2) * sqrt_info(5, 4) +
                     sqrt_info(6, 2) * sqrt_info(6, 4) + sqrt_info(7, 2) * sqrt_info(7, 4);
    _hessian(5, 2) = sqrt_info(0, 2) * sqrt_info(0, 5) + sqrt_info(1, 2) * sqrt_info(1, 5) +
                     sqrt_info(2, 2) * sqrt_info(2, 5) + sqrt_info(3, 2) * sqrt_info(3, 5) +
                     sqrt_info(4, 2) * sqrt_info(4, 5) + sqrt_info(5, 2) * sqrt_info(5, 5) +
                     sqrt_info(6, 2) * sqrt_info(6, 5) + sqrt_info(7, 2) * sqrt_info(7, 5);
    _hessian(6, 2) = sqrt_info(0, 2) * sqrt_info(0, 6) + sqrt_info(1, 2) * sqrt_info(1, 6) +
                     sqrt_info(2, 2) * sqrt_info(2, 6) + sqrt_info(3, 2) * sqrt_info(3, 6) +
                     sqrt_info(4, 2) * sqrt_info(4, 6) + sqrt_info(5, 2) * sqrt_info(5, 6) +
                     sqrt_info(6, 2) * sqrt_info(6, 6) + sqrt_info(7, 2) * sqrt_info(7, 6);
    _hessian(7, 2) = sqrt_info(0, 2) * sqrt_info(0, 7) + sqrt_info(1, 2) * sqrt_info(1, 7) +
                     sqrt_info(2, 2) * sqrt_info(2, 7) + sqrt_info(3, 2) * sqrt_info(3, 7) +
                     sqrt_info(4, 2) * sqrt_info(4, 7) + sqrt_info(5, 2) * sqrt_info(5, 7) +
                     sqrt_info(6, 2) * sqrt_info(6, 7) + sqrt_info(7, 2) * sqrt_info(7, 7);
    _hessian(0, 3) = 0;
    _hessian(1, 3) = 0;
    _hessian(2, 3) = 0;
    _hessian(3, 3) = std::pow(sqrt_info(0, 3), Scalar(2)) + std::pow(sqrt_info(1, 3), Scalar(2)) +
                     ...
                     std::pow(sqrt_info(6, 3), Scalar(2)) + std::pow(sqrt_info(7, 3), Scalar(2));
    _hessian(4, 3) = sqrt_info(0, 3) * sqrt_info(0, 4) + sqrt_info(1, 3) * sqrt_info(1, 4) +
                     ...
                     sqrt_info(6, 3) * sqrt_info(6, 4) + sqrt_info(7, 3) * sqrt_info(7, 4);
    _hessian(5, 3) = sqrt_info(0, 3) * sqrt_info(0, 5) + sqrt_info(1, 3) * sqrt_info(1, 5) +
                     ...
                     sqrt_info(6, 3) * sqrt_info(6, 5) + sqrt_info(7, 3) * sqrt_info(7, 5);
    _hessian(6, 3) = sqrt_info(0, 3) * sqrt_info(0, 6) + sqrt_info(1, 3) * sqrt_info(1, 6) +
                     sqrt_info(2, 3) * sqrt_info(2, 6) + sqrt_info(3, 3) * sqrt_info(3, 6) +
                     sqrt_info(4, 3) * sqrt_info(4, 6) + sqrt_info(5, 3) * sqrt_info(5, 6) +
                     sqrt_info(6, 3) * sqrt_info(6, 6) + sqrt_info(7, 3) * sqrt_info(7, 6);
    _hessian(7, 3) = sqrt_info(0, 3) * sqrt_info(0, 7) + sqrt_info(1, 3) * sqrt_info(1, 7) +
                     sqrt_info(2, 3) * sqrt_info(2, 7) + sqrt_info(3, 3) * sqrt_info(3, 7) +
                     sqrt_info(4, 3) * sqrt_info(4, 7) + sqrt_info(5, 3) * sqrt_info(5, 7) +
                     sqrt_info(6, 3) * sqrt_info(6, 7) + sqrt_info(7, 3) * sqrt_info(7, 7);
    _hessian(0, 4) = 0;
    _hessian(1, 4) = 0;
    _hessian(2, 4) = 0;
    _hessian(3, 4) = 0;
    _hessian(4, 4) = std::pow(sqrt_info(0, 4), Scalar(2)) + std::pow(sqrt_info(1, 4), Scalar(2)) +
                     ...
                     std::pow(sqrt_info(6, 4), Scalar(2)) + std::pow(sqrt_info(7, 4), Scalar(2));
    _hessian(5, 4) = sqrt_info(0, 4) * sqrt_info(0, 5) + sqrt_info(1, 4) * sqrt_info(1, 5) +
                     ...
                     sqrt_info(6, 4) * sqrt_info(6, 5) + sqrt_info(7, 4) * sqrt_info(7, 5);
    _hessian(6, 4) = sqrt_info(0, 4) * sqrt_info(0, 6) + sqrt_info(1, 4) * sqrt_info(1, 6) +
                     sqrt_info(2, 4) * sqrt_info(2, 6) + sqrt_info(3, 4) * sqrt_info(3, 6) +
                     sqrt_info(4, 4) * sqrt_info(4, 6) + sqrt_info(5, 4) * sqrt_info(5, 6) +
                     sqrt_info(6, 4) * sqrt_info(6, 6) + sqrt_info(7, 4) * sqrt_info(7, 6);
    _hessian(7, 4) = sqrt_info(0, 4) * sqrt_info(0, 7) + sqrt_info(1, 4) * sqrt_info(1, 7) +
                     sqrt_info(2, 4) * sqrt_info(2, 7) + sqrt_info(3, 4) * sqrt_info(3, 7) +
                     sqrt_info(4, 4) * sqrt_info(4, 7) + sqrt_info(5, 4) * sqrt_info(5, 7) +
                     sqrt_info(6, 4) * sqrt_info(6, 7) + sqrt_info(7, 4) * sqrt_info(7, 7);
    _hessian(0, 5) = 0;
    _hessian(1, 5) = 0;
    _hessian(2, 5) = 0;
    _hessian(3, 5) = 0;
    ...
    _hessian(5, 5) = std::pow(sqrt_info(0, 5), Scalar(2)) + std::pow(sqrt_info(1, 5), Scalar(2)) +
                     ...
                     std::pow(sqrt_info(6, 5), Scalar(2)) + std::pow(sqrt_info(7, 5), Scalar(2));
    _hessian(6, 5) = sqrt_info(0, 5) * sqrt_info(0, 6) + sqrt_info(1, 5) * sqrt_info(1, 6) +
                     sqrt_info(2, 5) * sqrt_info(2, 6) + sqrt_info(3, 5) * sqrt_info(3, 6) +
                     sqrt_info(4, 5) * sqrt_info(4, 6) + sqrt_info(5, 5) * sqrt_info(5, 6) +
                     sqrt_info(6, 5) * sqrt_info(6, 6) + sqrt_info(7, 5) * sqrt_info(7, 6);
    _hessian(7, 5) = sqrt_info(0, 5) * sqrt_info(0, 7) + sqrt_info(1, 5) * sqrt_info(1, 7) +
                     sqrt_info(2, 5) * sqrt_info(2, 7) + sqrt_info(3, 5) * sqrt_info(3, 7) +
                     sqrt_info(4, 5) * sqrt_info(4, 7) + sqrt_info(5, 5) * sqrt_info(5, 7) +
                     sqrt_info(6, 5) * sqrt_info(6, 7) + sqrt_info(7, 5) * sqrt_info(7, 7);
    _hessian(0, 6) = 0;
    _hessian(1, 6) = 0;
    _hessian(2, 6) = 0;
    _hessian(3, 6) = 0;
    ...
    _hessian(6, 6) = std::pow(sqrt_info(0, 6), Scalar(2)) + std::pow(sqrt_info(1, 6), Scalar(2)) +
                     std::pow(sqrt_info(2, 6), Scalar(2)) + std::pow(sqrt_info(3, 6), Scalar(2)) +
                     std::pow(sqrt_info(4, 6), Scalar(2)) + std::pow(sqrt_info(5, 6), Scalar(2)) +
                     std::pow(sqrt_info(6, 6), Scalar(2)) + std::pow(sqrt_info(7, 6), Scalar(2));
    _hessian(7, 6) = sqrt_info(0, 6) * sqrt_info(0, 7) + sqrt_info(1, 6) * sqrt_info(1, 7) +
                     sqrt_info(2, 6) * sqrt_info(2, 7) + sqrt_info(3, 6) * sqrt_info(3, 7) +
                     sqrt_info(4, 6) * sqrt_info(4, 7) + sqrt_info(5, 6) * sqrt_info(5, 7) +
                     sqrt_info(6, 6) * sqrt_info(6, 7) + sqrt_info(7, 6) * sqrt_info(7, 7);
    _hessian(0, 7) = 0;
    _hessian(1, 7) = 0;
    _hessian(2, 7) = 0;
    _hessian(3, 7) = 0;
    ...
    _hessian(7, 7) = std::pow(sqrt_info(0, 7), Scalar(2)) + std::pow(sqrt_info(1, 7), Scalar(2)) +
                     std::pow(sqrt_info(2, 7), Scalar(2)) + std::pow(sqrt_info(3, 7), Scalar(2)) +
                     std::pow(sqrt_info(4, 7), Scalar(2)) + std::pow(sqrt_info(5, 7), Scalar(2)) +
                     std::pow(sqrt_info(6, 7), Scalar(2)) + std::pow(sqrt_info(7, 7), Scalar(2));
  }

  if (rhs != nullptr) {
    Eigen::Matrix<Scalar, 8, 1>& _rhs = (*rhs);

    _rhs(0, 0) = _tmp10 * sqrt_info(2, 0) + _tmp11 * sqrt_info(3, 0) + _tmp12 * sqrt_info(4, 0) +
                 _tmp13 * sqrt_info(5, 0) + _tmp14 * sqrt_info(6, 0) + _tmp15 * sqrt_info(7, 0) +
                 _tmp8 * sqrt_info(0, 0) + _tmp9 * sqrt_info(1, 0);
    _rhs(1, 0) = _tmp10 * sqrt_info(2, 1) + _tmp11 * sqrt_info(3, 1) + _tmp12 * sqrt_info(4, 1) +
                 _tmp13 * sqrt_info(5, 1) + _tmp14 * sqrt_info(6, 1) + _tmp15 * sqrt_info(7, 1) +
                 _tmp8 * sqrt_info(0, 1) + _tmp9 * sqrt_info(1, 1);
    _rhs(2, 0) = _tmp10 * sqrt_info(2, 2) + _tmp11 * sqrt_info(3, 2) + _tmp12 * sqrt_info(4, 2) +
                 _tmp13 * sqrt_info(5, 2) + _tmp14 * sqrt_info(6, 2) + _tmp15 * sqrt_info(7, 2) +
                 _tmp8 * sqrt_info(0, 2) + _tmp9 * sqrt_info(1, 2);
    _rhs(3, 0) = _tmp10 * sqrt_info(2, 3) + _tmp11 * sqrt_info(3, 3) + _tmp12 * sqrt_info(4, 3) +
                 _tmp13 * sqrt_info(5, 3) + _tmp14 * sqrt_info(6, 3) + _tmp15 * sqrt_info(7, 3) +
                 _tmp8 * sqrt_info(0, 3) + _tmp9 * sqrt_info(1, 3);
    _rhs(4, 0) = _tmp10 * sqrt_info(2, 4) + _tmp11 * sqrt_info(3, 4) + _tmp12 * sqrt_info(4, 4) +
                 _tmp13 * sqrt_info(5, 4) + _tmp14 * sqrt_info(6, 4) + _tmp15 * sqrt_info(7, 4) +
                 _tmp8 * sqrt_info(0, 4) + _tmp9 * sqrt_info(1, 4);
    _rhs(5, 0) = _tmp10 * sqrt_info(2, 5) + _tmp11 * sqrt_info(3, 5) + _tmp12 * sqrt_info(4, 5) +
                 _tmp13 * sqrt_info(5, 5) + _tmp14 * sqrt_info(6, 5) + _tmp15 * sqrt_info(7, 5) +
                 _tmp8 * sqrt_info(0, 5) + _tmp9 * sqrt_info(1, 5);
    _rhs(6, 0) = _tmp10 * sqrt_info(2, 6) + _tmp11 * sqrt_info(3, 6) + _tmp12 * sqrt_info(4, 6) +
                 _tmp13 * sqrt_info(5, 6) + _tmp14 * sqrt_info(6, 6) + _tmp15 * sqrt_info(7, 6) +
                 _tmp8 * sqrt_info(0, 6) + _tmp9 * sqrt_info(1, 6);
    _rhs(7, 0) = _tmp10 * sqrt_info(2, 7) + _tmp11 * sqrt_info(3, 7) + _tmp12 * sqrt_info(4, 7) +
                 _tmp13 * sqrt_info(5, 7) + _tmp14 * sqrt_info(6, 7) + _tmp15 * sqrt_info(7, 7) +
                 _tmp8 * sqrt_info(0, 7) + _tmp9 * sqrt_info(1, 7);
  }
