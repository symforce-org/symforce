...
void PriorFactorPose2(const sym::Pose2<Scalar>& value, const sym::Pose2<Scalar>& prior,
  ...
  const Scalar _tmp3 = _prior[0] * _value[1];
  const Scalar _tmp4 = -_tmp2 + _tmp3;
  const Scalar _tmp5 = _prior[0] * _value[0] + _prior[1] * _value[1];
  const Scalar _tmp6 = _tmp5 + std::copysign(epsilon, _tmp5);
  const Scalar _tmp7 = std::atan2(_tmp4, _tmp6);
  const Scalar _tmp8 = _tmp0 * sqrt_info(0, 2) + _tmp1 * sqrt_info(0, 1) + _tmp7 * sqrt_info(0, 0);
  const Scalar _tmp9 = _tmp0 * sqrt_info(1, 2) + _tmp1 * sqrt_info(1, 1) + _tmp7 * sqrt_info(1, 0);
  const Scalar _tmp10 = _tmp0 * sqrt_info(2, 2) + _tmp1 * sqrt_info(2, 1) + _tmp7 * sqrt_info(2, 0);
