...
void PriorFactorPose2(const sym::Pose2<Scalar>& value, const sym::Pose2<Scalar>& prior,
  ...
  const Scalar _tmp16 = _tmp14 * sqrt_info(1, 2);
  const Scalar _tmp17 = _tmp14 * sqrt_info(2, 2);
  const Scalar _tmp18 =
  ...
  if (hessian != nullptr) {
    ...
    _hessian(1, 2) = 0;
    _hessian(2, 0) = _tmp15 * sqrt_info(0, 0) + _tmp16 * sqrt_info(1, 0) + _tmp17 * sqrt_info(2, 0);
    _hessian(2, 1) = _tmp15 * sqrt_info(0, 1) + _tmp16 * sqrt_info(1, 1) + _tmp17 * sqrt_info(2, 1);
    _hessian(2, 2) = _tmp18 * std::pow(sqrt_info(0, 2), Scalar(2)) +
                     _tmp18 * std::pow(sqrt_info(1, 2), Scalar(2)) +
                     _tmp18 * std::pow(sqrt_info(2, 2), Scalar(2));
  }
  ...
  if (rhs != nullptr) {
    ...
    _rhs(2, 0) = _tmp10 * _tmp17 + _tmp15 * _tmp8 + _tmp16 * _tmp9;
  }
