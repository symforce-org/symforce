...
void PriorFactorPose2Diagonal(const sym::Pose2<Scalar>& value, const sym::Pose2<Scalar>& prior,
  ...
  const Scalar _tmp14 = std::pow(sqrt_info(2, 0), Scalar(2));
  ...
  if (res != nullptr) {
    ...
    _res(1, 0) = _tmp6 * sqrt_info(1, 0);
    _res(2, 0) = _tmp7 * sqrt_info(2, 0);
  }
  ...
  if (jacobian != nullptr) {
    ...
    _jacobian(0, 0) = _tmp11 * sqrt_info(0, 0);
  ...
  if (rhs != nullptr) {
    ...
    _rhs(1, 0) = _tmp13 * _tmp6;
    _rhs(2, 0) = _tmp14 * _tmp7;
  }
