...
void PriorFactorPose3Position(const sym::Pose3<Scalar>& value,
  ...
  const Scalar _tmp3 = _tmp0 * sqrt_info(0, 0) + _tmp1 * sqrt_info(0, 1) + _tmp2 * sqrt_info(0, 2);
  const Scalar _tmp4 = _tmp0 * sqrt_info(1, 0) + _tmp1 * sqrt_info(1, 1) + _tmp2 * sqrt_info(1, 2);
  const Scalar _tmp5 = _tmp0 * sqrt_info(2, 0) + _tmp1 * sqrt_info(2, 1) + _tmp2 * sqrt_info(2, 2);
