...
void PriorFactorRot2Isotropic(const sym::Rot2<Scalar>& value, const sym::Rot2<Scalar>& prior,
  ...
  const Scalar _tmp10 = std::pow(sqrt_info, Scalar(2));
