...
struct LieGroupOps<DoubleSphereCameraCal<Scalar>>
    : public internal::LieGroupOpsBase<DoubleSphereCameraCal<Scalar>, Scalar> {
...
extern template struct sym::LieGroupOps<sym::DoubleSphereCameraCal<double>>;
extern template struct sym::LieGroupOps<sym::DoubleSphereCameraCal<float>>;
