...
struct LieGroupOps<OrthographicCameraCal<Scalar>>
    : public internal::LieGroupOpsBase<OrthographicCameraCal<Scalar>, Scalar> {
...
extern template struct sym::LieGroupOps<sym::OrthographicCameraCal<double>>;
extern template struct sym::LieGroupOps<sym::OrthographicCameraCal<float>>;
