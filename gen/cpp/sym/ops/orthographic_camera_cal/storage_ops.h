...
struct StorageOps<OrthographicCameraCal<ScalarType>> {
  ...
  static constexpr type_t TypeEnum() {
    return type_t::ORTHOGRAPHIC_CAMERA_CAL;
  }
};
...
extern template struct sym::StorageOps<sym::OrthographicCameraCal<double>>;
extern template struct sym::StorageOps<sym::OrthographicCameraCal<float>>;
