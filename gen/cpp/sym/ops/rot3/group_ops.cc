...
sym::Rot3<Scalar> GroupOps<Scalar>::ComposeWithJacobians(
  ...
  const Scalar _tmp13 = (1.0 / 2.0) * _a[2];
  ...
  const Scalar _tmp60 = (1.0 / 2.0) * _b[3];
  ...
  const Scalar _tmp67 = (1.0 / 2.0) * _b[0];
...
sym::Rot3<Scalar> GroupOps<Scalar>::BetweenWithJacobians(
  ...
  const Scalar _tmp12 = _tmp11 + _tmp5 - _tmp7 + _tmp9;
  const Scalar _tmp13 = (1.0 / 2.0) * _a[3];
  ...
  const Scalar _tmp22 = (1.0 / 2.0) * _a[2];
  ...
  const Scalar _tmp29 = (1.0 / 2.0) * _a[0];
  ...
  const Scalar _tmp36 = (1.0 / 2.0) * _a[1];
  ...
  const Scalar _tmp54 = (1.0 / 2.0) * _b[2];
