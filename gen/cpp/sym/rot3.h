...
class Rot3 {
 public:
   ...
   */
  const static sym::Rot3<Scalar> FromYaw(const Scalar yaw);

  /**
   * Construct from pitch angle in radians
   */
  const static sym::Rot3<Scalar> FromPitch(const Scalar pitch);

  /**
   * Construct from roll angle in radians
   */
  const static sym::Rot3<Scalar> FromRoll(const Scalar roll);
...
static_assert(sizeof(sym::Rot3<double>) == 4 * sizeof(double));
static_assert(alignof(sym::Rot3<double>) == sizeof(double));
static_assert(sizeof(sym::Rot3<float>) == 4 * sizeof(float));
static_assert(alignof(sym::Rot3<float>) == sizeof(float));
