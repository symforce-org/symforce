...
class GroupOps(object):
    ...
    def inverse_with_jacobian(a):
        ...
        _res_D_a[0, 0] = _tmp12
        _res_D_a[0, 1] = -_tmp13
        _res_D_a[0, 2] = _a[0]*(_tmp17*_tmp5 - _tmp19*_tmp4) - _a[1]*(_tmp21*_tmp5 - _tmp22*_tmp4)
        _res_D_a[1, 0] = _tmp13
        _res_D_a[1, 1] = _tmp12
        _res_D_a[1, 2] = _a[0]*(-_tmp17*_tmp4 - _tmp19*_tmp5) - _a[1]*(-_tmp21*_tmp4 - _tmp22*_tmp5)
        _res_D_a[2, 0] = 0
        _res_D_a[2, 1] = 0
        _res_D_a[2, 2] = _a[0]*(-_a[0]*_tmp0*_tmp23 + _tmp4*(_tmp14 - _tmp3)) - _a[1]*(_a[1]*_tmp1*_tmp23 + _tmp5*(-_tmp20 + _tmp3))
    ...
    def compose_with_jacobians(a, b):
        ...
        _res_D_a[2, 0] = 0
        _res_D_a[2, 1] = 0
        _res_D_a[2, 2] = _a[0]*(_b[0]*_tmp0 + _b[1]*_tmp1) - _a[1]*(-_b[0]*_tmp1 + _b[1]*_tmp0)
    ...
    def between_with_jacobians(a, b):
        ...
        _res_D_a[0, 2] = _a[0]*(_tmp26*_tmp7 + _tmp30*_tmp6) - _a[1]*(_tmp32*_tmp7 + _tmp33*_tmp6)
        _res_D_a[1, 0] = _a[0]*_tmp34 + _tmp21
        _res_D_a[1, 1] = -_a[1]*_tmp34 + _tmp20
        _res_D_a[1, 2] = _a[0]*(_tmp26*_tmp6 - _tmp30*_tmp7) - _a[1]*(_tmp32*_tmp6 - _tmp33*_tmp7)
        _res_D_a[2, 0] = 0
        _res_D_a[2, 1] = 0
        _res_D_a[2, 2] = _a[0]*(_tmp6*(_b[0]*_tmp23 + _tmp35 - _tmp5) - _tmp7*(-_b[1]*_tmp23 - _tmp36 + _tmp4)) - _a[1]*(_tmp6*(-_b[1]*_tmp31 + _tmp36 + _tmp4) - _tmp7*(-_b[0]*_tmp31 + _tmp35 + _tmp5))
        _res_D_b = numpy.zeros((3, 3))
