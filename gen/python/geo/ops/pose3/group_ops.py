...
class GroupOps(object):
    ...
    def inverse_with_jacobian(a):
        ...
        _tmp79 = -1./2.*_tmp17*_tmp57 - 1./2.*_tmp23*_tmp59 - 1./2.*_tmp5*_tmp60
        _tmp80 = -_tmp17*_tmp39 - _tmp23*_tmp35 - _tmp43*_tmp5
        _tmp81 = -1./2.*_tmp17*_tmp47 - 1./2.*_tmp23*_tmp50 - 1./2.*_tmp5*_tmp53
    ...
    def compose_with_jacobians(a, b):
        ...
        _tmp112 = (1./2.)*_tmp109*_tmp78 + (1./2.)*_tmp110*_tmp85 + (1./2.)*_tmp111*_tmp88
        ...
        _tmp124 = (1./2.)*_tmp101*_tmp121 + (1./2.)*_tmp118*_tmp96 + (1./2.)*_tmp120*_tmp98
        ...
        _tmp155 = _tmp2*_tmp4
        _tmp156 = _tmp3*_tmp6
        _tmp157 = (1./2.)*_tmp153 - 1./2.*_tmp154 + (1./2.)*_tmp155 - 1./2.*_tmp156
        ...
        _tmp167 = -1./2.*_tmp153 + (1./2.)*_tmp154 - 1./2.*_tmp155 + (1./2.)*_tmp156
    ...
    def between_with_jacobians(a, b):
        ...
        _tmp125 = (1./2.)*_tmp122*_tmp85 + (1./2.)*_tmp123*_tmp92 + (1./2.)*_tmp124*_tmp99
        ...
        _tmp176 = -1./2.*_tmp172 + (1./2.)*_tmp173 + (1./2.)*_tmp174 + (1./2.)*_tmp175
        ...
        _tmp194 = (1./2.)*_tmp172 - 1./2.*_tmp173 - 1./2.*_tmp174 - 1./2.*_tmp175
