...
class LieGroupOps(object):
    ...
    def to_tangent(a, epsilon):
        ...
        _res[1] = 2*_tmp5
        _res[2] = _a[2]*_tmp4
        _res[3] = _a[4]*(_tmp13*(_tmp20 + _tmp21) + 1.0) + _a[5]*(_tmp17 + _tmp19) + _a[6]*(_tmp15 - _tmp16)
        _res[4] = _a[4]*(_tmp17 - _tmp19) + _a[5]*(_tmp13*(_tmp21 + _tmp24) + 1.0) + _a[6]*(_tmp22 + _tmp23)
        _res[5] = _a[4]*(_tmp15 + _tmp16) + _a[5]*(_tmp22 - _tmp23) + _a[6]*(_tmp13*(_tmp20 + _tmp24) + 1.0)
        return _res
    ...
    def local_coordinates(a, b, epsilon):
        ...
        _tmp1 = numpy.amax((epsilon - 1,numpy.amin((-epsilon + 1,_a[0]*_b[0] + _a[1]*_b[1] + _a[2]*_b[2] + _a[3]*_b[3]))))
        _tmp2 = -_tmp1**2 + 1
        ...
        _tmp20 = -_a[4]*_tmp19 - _a[5]*_tmp16 - _a[6]*_tmp11 + _b[4]*_tmp19 + _b[5]*_tmp16 + _b[6]*_tmp11
        ...
        _tmp27 = 0.5*_tmp26
        _tmp28 = (-1./2.*_tmp26*numpy.cos(_tmp27)/numpy.sin(_tmp27) + 1)/_tmp25
        ...
        _tmp41 = -_a[4]*_tmp40 - _a[5]*_tmp37 - _a[6]*_tmp35 + _b[4]*_tmp40 + _b[5]*_tmp37 + _b[6]*_tmp35
        _tmp42 = -_tmp17 + _tmp18
        _tmp43 = _tmp38 + _tmp39
        _tmp44 = _tmp36 + _tmp9 + 1
        _tmp45 = -_a[4]*_tmp44 - _a[5]*_tmp43 - _a[6]*_tmp42 + _b[4]*_tmp44 + _b[5]*_tmp43 + _b[6]*_tmp42
        _tmp46 = -_tmp22
        _tmp47 = -_tmp23
        _tmp48 = _tmp29*_tmp6
        _tmp49 = _tmp0*_tmp31
        ...
        _res[1] = _tmp5*_tmp6
        _res[2] = 2*_tmp8
        _res[3] = _tmp20*(_tmp30 - _tmp32) + _tmp41*(_tmp33 + _tmp34) + _tmp45*(_tmp28*(_tmp46 + _tmp47) + 1.0)
        _res[4] = _tmp20*(_tmp48 + _tmp49) + _tmp41*(_tmp28*(_tmp47 + _tmp50) + 1.0) + _tmp45*(_tmp33 - _tmp34)
        _res[5] = _tmp20*(_tmp28*(_tmp46 + _tmp50) + 1.0) + _tmp41*(_tmp48 - _tmp49) + _tmp45*(_tmp30 + _tmp32)
        return _res
