...
class LieGroupOps(object):
    ...
    def to_tangent(a, epsilon):
        ...
        _tmp14 = _a[1]*_tmp13*_tmp6
        _tmp15 = _a[0]*_tmp14
        _tmp16 = -_tmp8
        _tmp17 = -_tmp9
        _tmp18 = _a[1]*_tmp4
        _tmp19 = _a[0]*_a[2]*_tmp13*_tmp6
        _tmp20 = -_tmp7
        _tmp21 = _a[0]*_tmp4
        _tmp22 = _a[2]*_tmp14
        ...
        _res[1] = _a[1]*_tmp3
        _res[2] = _a[2]*_tmp3
        _res[3] = _a[4]*(_tmp13*(_tmp16 + _tmp17) + 1.0) + _a[5]*(_tmp15 + _tmp5) + _a[6]*(-_tmp18 + _tmp19)
        _res[4] = _a[4]*(_tmp15 - _tmp5) + _a[5]*(_tmp13*(_tmp16 + _tmp20) + 1.0) + _a[6]*(_tmp21 + _tmp22)
        _res[5] = _a[4]*(_tmp18 + _tmp19) + _a[5]*(-_tmp21 + _tmp22) + _a[6]*(_tmp13*(_tmp17 + _tmp20) + 1.0)
        return _res
    ...
    def local_coordinates(a, b, epsilon):
        ...
        _tmp8 = _tmp4*_tmp7
        _tmp9 = 1.0*_tmp8
        _tmp10 = 4*_tmp2**2/_tmp3
        _tmp11 = _tmp0**2*_tmp10
        _tmp12 = _tmp10*_tmp6**2
        _tmp13 = _tmp10*_tmp7**2
        _tmp14 = _tmp11 + _tmp12 + _tmp13 + epsilon
        _tmp15 = numpy.sqrt(_tmp14)
        _tmp16 = 0.5*_tmp15
        _tmp17 = (-1./2.*_tmp15*numpy.cos(_tmp16)/numpy.sin(_tmp16) + 1)/_tmp14
        _tmp18 = _tmp0*_tmp10*_tmp17
        _tmp19 = _tmp18*_tmp6
        _tmp20 = 2*_a[0]
        _tmp21 = _a[1]*_tmp20
        _tmp22 = 2*_a[3]
        ...
        _tmp25 = -2*_a[0]**2
        _tmp26 = -2*_a[2]**2
        _tmp27 = _tmp25 + _tmp26 + 1
        _tmp28 = 2*_a[1]*_a[2]
        _tmp29 = _a[0]*_tmp22
        _tmp30 = _tmp28 + _tmp29
        _tmp31 = -_a[4]*_tmp24 - _a[5]*_tmp27 - _a[6]*_tmp30 + _b[4]*_tmp24 + _b[5]*_tmp27 + _b[6]*_tmp30
        _tmp32 = -_tmp13
        _tmp33 = -_tmp12
        _tmp34 = -2*_a[1]**2 + 1
        _tmp35 = _tmp26 + _tmp34
        _tmp36 = _tmp21 + _tmp23
        _tmp37 = _a[2]*_tmp20
        _tmp38 = _a[1]*_tmp22
        _tmp39 = _tmp37 - _tmp38
        _tmp40 = -_a[4]*_tmp35 - _a[5]*_tmp36 - _a[6]*_tmp39 + _b[4]*_tmp35 + _b[5]*_tmp36 + _b[6]*_tmp39
        _tmp41 = 1.0*_tmp4
        _tmp42 = _tmp41*_tmp6
        _tmp43 = _tmp18*_tmp7
        _tmp44 = _tmp25 + _tmp34
        _tmp45 = _tmp37 + _tmp38
        _tmp46 = _tmp28 - _tmp29
        _tmp47 = -_a[4]*_tmp45 - _a[5]*_tmp46 - _a[6]*_tmp44 + _b[4]*_tmp45 + _b[5]*_tmp46 + _b[6]*_tmp44
        _tmp48 = -_tmp11
        _tmp49 = _tmp0*_tmp41
        _tmp50 = _tmp10*_tmp17*_tmp6*_tmp7
        ...
        _res[1] = _tmp5*_tmp6
        _res[2] = 2*_tmp8
        _res[3] = _tmp31*(_tmp19 + _tmp9) + _tmp40*(_tmp17*(_tmp32 + _tmp33) + 1.0) + _tmp47*(-_tmp42 + _tmp43)
        _res[4] = _tmp31*(_tmp17*(_tmp32 + _tmp48) + 1.0) + _tmp40*(_tmp19 - _tmp9) + _tmp47*(_tmp49 + _tmp50)
        _res[5] = _tmp31*(-_tmp49 + _tmp50) + _tmp40*(_tmp42 + _tmp43) + _tmp47*(_tmp17*(_tmp33 + _tmp48) + 1.0)
        return _res
