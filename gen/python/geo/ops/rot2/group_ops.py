...
class GroupOps(object):
    ...
    def inverse_with_jacobian(a):
        ...
        _res[1] = -_tmp5
        _res_D_a = [0.] * 1
        _res_D_a[0] = _a[0]*(-_a[0]*_tmp0*_tmp7 + _tmp4*(_tmp0*_tmp6 - _tmp3)) - _a[1]*(_a[1]*_tmp1*_tmp7 + _tmp5*(-_tmp1*_tmp6 + _tmp3))
    ...
    def compose_with_jacobians(a, b):
        ...
        _res[1] = _tmp1
        _res_D_a = [0.] * 1
        _res_D_a[0] = _a[0]*(_b[0]*_tmp0 + _b[1]*_tmp1) - _a[1]*(-_b[0]*_tmp1 + _b[1]*_tmp0)
        _res_D_b = [0.] * 1
        _res_D_b[0] = _b[0]*(_a[0]*_tmp0 + _a[1]*_tmp1) - _b[1]*(-_a[0]*_tmp1 + _a[1]*_tmp0)
    ...
    def between_with_jacobians(a, b):
        ...
        _res[1] = _tmp7
        _res_D_a = [0.] * 1
        _res_D_a[0] = _a[0]*(_tmp6*(_b[0]*_tmp9 + _tmp11 - _tmp5) - _tmp7*(-_b[1]*_tmp9 - _tmp12 + _tmp4)) - _a[1]*(_tmp6*(-_b[1]*_tmp13 + _tmp12 + _tmp4) - _tmp7*(-_b[0]*_tmp13 + _tmp11 + _tmp5))
        _res_D_b = [0.] * 1
        _res_D_b[0] = _b[0]*(_a[0]*_tmp14 - _a[1]*_tmp15) - _b[1]*(-_a[0]*_tmp15 - _a[1]*_tmp14)
        return _res,  _res_D_a,  _res_D_b
