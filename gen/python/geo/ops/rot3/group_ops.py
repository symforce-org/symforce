...
class GroupOps(object):
    ...
    @staticmethod
    def compose(a, b):
        # type: (geo.Rot3, geo.Rot3) -> T.List[float]
    ...
    def inverse_with_jacobian(a):
        # type: (geo.Rot3) -> T.Tuple[T.List[float], numpy.ndarray]
    ...
    def compose_with_jacobians(a, b):
        # type: (geo.Rot3, geo.Rot3) -> T.Tuple[T.List[float], numpy.ndarray, numpy.ndarray]
