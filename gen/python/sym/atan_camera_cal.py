...
class ATANCameraCal(object):
    ...
    def focal_length(self):
        # type: (ATANCameraCal) -> T.List[float]
        """
    ...
    def pixel_from_camera_point(self, point, epsilon):
        # type: (ATANCameraCal, T.Sequence[float], float) -> T.Tuple[T.List[float], float]
        """
    ...
    def pixel_from_camera_point_with_jacobians(self, point, epsilon):
        # type: (ATANCameraCal, T.Sequence[float], float) -> T.Tuple[T.List[float], float, numpy.ndarray, numpy.ndarray]
        """
        Project a 3D point in the camera frame into 2D pixel coordinates.
    ...
    def from_tangent(cls, vec, epsilon=1e-8):
        # type: (T.Sequence[float], float) -> ATANCameraCal
    ...
    def local_coordinates(self, b, epsilon=1e-8):
        # type: (ATANCameraCal, float) -> T.List[float]
