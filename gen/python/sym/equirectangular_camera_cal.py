...
class EquirectangularCameraCal(object):
    ...
    def focal_length(self):
        # type: (EquirectangularCameraCal) -> numpy.ndarray
        """
    ...
    def pixel_from_camera_point(self, point, epsilon):
        # type: (EquirectangularCameraCal, T.Union[T.Sequence[float], numpy.ndarray], float) -> T.Tuple[numpy.ndarray, float]
        """
    ...
    def pixel_from_camera_point_with_jacobians(self, point, epsilon):
        # type: (EquirectangularCameraCal, T.Union[T.Sequence[float], numpy.ndarray], float) -> T.Tuple[numpy.ndarray, float, numpy.ndarray, numpy.ndarray]
        """
        Project a 3D point in the camera frame into 2D pixel coordinates.
    ...
    def from_tangent(cls, vec, epsilon=1e-8):
        # type: (T.Union[T.Sequence[float], numpy.ndarray], float) -> EquirectangularCameraCal
