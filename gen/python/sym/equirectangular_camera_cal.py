...
#     python_templates/cam_package/CLASS.py.jinja
...
class EquirectangularCameraCal(object):
    ...
    def __init__(self, focal_length, principal_point):
        # type: (T.Sequence[float], T.Sequence[float]) -> None
        self.data = []
    ...
    def focal_length(self):
        # type: (EquirectangularCameraCal) -> T.List[float]
        """
    ...
    def pixel_from_camera_point(self, point, epsilon):
        # type: (EquirectangularCameraCal, T.Sequence[float], float) -> T.Tuple[T.List[float], float]
        """
    ...
    def pixel_from_camera_point_with_jacobians(self, point, epsilon):
        # type: (EquirectangularCameraCal, T.Sequence[float], float) -> T.Tuple[T.List[float], float, numpy.ndarray, numpy.ndarray]
        """
        Project a 3D point in the camera frame into 2D pixel coordinates.
    ...
    def from_storage(cls, vec):
        # type: (T.Sequence[float]) -> EquirectangularCameraCal
    ...
    def from_tangent(cls, vec, epsilon=1e-8):
        # type: (T.Sequence[float], float) -> EquirectangularCameraCal
    ...
    def local_coordinates(self, b, epsilon=1e-8):
        # type: (EquirectangularCameraCal, float) -> T.List[float]
