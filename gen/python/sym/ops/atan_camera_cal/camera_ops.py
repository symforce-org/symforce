...
class CameraOps(object):
    ...
    def pixel_from_camera_point(self, point, epsilon):
        # type: (sym.ATANCameraCal, sym.util.VectorType, float) -> T.Tuple[numpy.ndarray, float]
        """
    ...
    def pixel_from_camera_point_with_jacobians(self, point, epsilon):
        # type: (sym.ATANCameraCal, sym.util.VectorType, float) -> T.Tuple[numpy.ndarray, float, numpy.ndarray, numpy.ndarray]
        """
        Project a 3D point in the camera frame into 2D pixel coordinates.
