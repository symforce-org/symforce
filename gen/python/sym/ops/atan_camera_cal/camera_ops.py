...
class CameraOps(object):
    ...
    def pixel_from_camera_point_with_jacobians(self, point, epsilon):
        ...
        _tmp15 = _tmp12 * point[1, 0]
        _tmp16 = _self[1] * _tmp15
        _tmp17 = math.tan(_tmp0)
        _tmp18 = math.atan(_tmp17 * _tmp7)
        _tmp19 = _tmp12 * _tmp18
        _tmp20 = _tmp10 * _tmp19
        _tmp21 = _tmp19 * point[1, 0]
        _tmp22 = _tmp10 * _tmp18 / _self[4] ** 2
        _tmp23 = _tmp17**2
        _tmp24 = 1 / (4 * _tmp23 * _tmp5 + 1)
        _tmp25 = _tmp24 * _tmp9
        _tmp26 = _tmp14 * _tmp25
        _tmp27 = 1.0 * _tmp23 + 1.0
        _tmp28 = _tmp16 * _tmp25
        _tmp29 = _tmp2 ** (-3)
        _tmp30 = _tmp5 ** (-3.0 / 2.0)
        _tmp31 = _tmp29 * _tmp30
        _tmp32 = _tmp19 * _tmp31
        _tmp33 = _self[0] * _tmp4
        _tmp34 = _tmp17 / _tmp5
        _tmp35 = 2 * _tmp24 * _tmp29 * _tmp34
        _tmp36 = _tmp12 * _tmp35
        _tmp37 = _tmp21 * _tmp31
        _tmp38 = _self[1] * _tmp1
        _tmp39 = (
            0.0 if -epsilon + point[2, 0] == 0 else math.copysign(1, -epsilon + point[2, 0])
        ) + 1
        _tmp40 = _tmp3 * _tmp39 * _tmp8
        _tmp41 = (1.0 / 2.0) * _tmp13 * _tmp19
        _tmp42 = _tmp29 * _tmp39
        _tmp43 = -_tmp1 * _tmp42 - _tmp4 * _tmp42
        _tmp44 = _tmp34 * _tmp43
        _tmp45 = _tmp30 * _tmp43 * _tmp9
        _tmp46 = (1.0 / 2.0) * _self[1] * _tmp21
    ...
    def camera_ray_from_pixel_with_jacobians(self, pixel, epsilon):
        ...
        _tmp15 = 1 / _self[1]
        _tmp16 = _tmp1 * _tmp15
        _tmp17 = _tmp4**3 / _self[0] ** 4
        _tmp18 = _tmp10**2 + 1
        _tmp19 = math.tan(_tmp0)
        _tmp20 = (1.0 / 2.0) / _tmp19
        _tmp21 = _self[4] / _tmp7
        _tmp22 = _tmp18 * _tmp20 * _tmp21
        _tmp23 = _tmp10 / _tmp7 ** (3.0 / 2.0)
        _tmp24 = _tmp20 * _tmp23
        _tmp25 = _tmp11 * _tmp20
        _tmp26 = _tmp4 * _tmp6
        _tmp27 = _tmp5 / _self[0] ** 3
        _tmp28 = _tmp15 * _tmp20
        _tmp29 = _tmp1 * _tmp28
        _tmp30 = _tmp18 * _tmp29
        _tmp31 = _tmp21 * _tmp30
        _tmp32 = _tmp23 * _tmp29
        _tmp33 = _tmp2 / _self[1] ** 3
        _tmp34 = _tmp13 * _tmp20
        _tmp35 = _tmp34 * _tmp4
        _tmp36 = _tmp18 * _tmp35
        _tmp37 = _tmp21 * _tmp36
        _tmp38 = _tmp23 * _tmp35
        _tmp39 = _tmp1**3 / _self[1] ** 4
        _tmp40 = _tmp1 * _tmp3
        _tmp41 = _tmp11 * _tmp34
        _tmp42 = _tmp22 * _tmp27
        _tmp43 = _tmp24 * _tmp27
        _tmp44 = _tmp26 * _tmp31
        _tmp45 = _tmp26 * _tmp32
        _tmp46 = _tmp37 * _tmp40
        _tmp47 = _tmp38 * _tmp40
        _tmp48 = _tmp11 * _tmp28
        _tmp49 = _tmp22 * _tmp33
        _tmp50 = _tmp24 * _tmp33
        _tmp51 = _tmp19**2
