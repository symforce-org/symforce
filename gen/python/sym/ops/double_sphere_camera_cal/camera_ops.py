...
class CameraOps(object):
    ...
    def pixel_from_camera_point_with_jacobians(self, point, epsilon):
        ...
        _tmp27 = _tmp24 * (-_tmp2 + _tmp3)
        _tmp28 = _self[1] * point[1]
        _tmp29 = _tmp24 * _tmp28
        _tmp30 = _tmp1 ** (-1)
    ...
    def camera_ray_from_pixel_with_jacobians(self, pixel, epsilon):
        ...
        _tmp56 = _tmp3 / _self[1] ** 3
        _tmp57 = 2 * _tmp56
        _tmp58 = _tmp39 * _tmp56 - _tmp44 * _tmp56
        _tmp59 = _tmp46 * (-_tmp57 + _tmp58)
        _tmp60 = -_tmp49 * _tmp56 + _tmp51 * _tmp57 + _tmp53 * (-_tmp24 * _tmp57 + _tmp58)
        _tmp61 = _tmp21 * _tmp60
        _tmp62 = _tmp32 * _tmp49
        _tmp63 = 2 * _tmp32
        _tmp64 = _tmp51 * _tmp63
        _tmp65 = _tmp24 * _tmp63
        _tmp66 = _tmp32 * _tmp39
        _tmp67 = _tmp32 * _tmp44
        _tmp68 = _tmp66 - _tmp67
        _tmp69 = _tmp53 * (-_tmp65 + _tmp68) - _tmp62 + _tmp64
        _tmp70 = _tmp21 * _tmp69
        _tmp71 = _tmp46 * (-_tmp63 + _tmp68)
        _tmp72 = _tmp2 * _tmp4
        _tmp73 = 2 * _tmp72
        _tmp74 = _tmp51 * _tmp73
        _tmp75 = _tmp49 * _tmp72
        _tmp76 = _tmp24 * _tmp73
        _tmp77 = _tmp39 * _tmp72
        _tmp78 = _tmp44 * _tmp72
        _tmp79 = _tmp77 - _tmp78
        _tmp80 = _tmp53 * (-_tmp76 + _tmp79) + _tmp74 - _tmp75
        _tmp81 = _tmp21 * _tmp80
        _tmp82 = _tmp46 * (-_tmp73 + _tmp79)
        _tmp83 = (1.0 / 2.0) * _tmp7
        _tmp84 = -_self[4] * _tmp52 * _tmp83 + _tmp23
        _tmp85 = _tmp21 * _tmp84
        _tmp86 = _tmp14 - _tmp42 * _tmp83 - 1
        _tmp87 = -_self[5] * _tmp38 * _tmp7 - 2 * _tmp40 * _tmp86
        _tmp88 = _tmp46 * _tmp87
        _tmp89 = _tmp37 * _tmp86
        _tmp90 = _tmp11 * _tmp7
        _tmp91 = -_self[4] * _tmp89 - _tmp50 * _tmp90 + _tmp53 * _tmp87
        _tmp92 = _tmp21 * _tmp91
        _tmp93 = _tmp2 * _tmp30
        _tmp94 = _tmp28 * _tmp72
        _tmp95 = _tmp22 * _tmp28
        _tmp96 = _tmp8 * _tmp95
        _tmp97 = _tmp28 * _tmp48
        _tmp98 = _tmp21 * _tmp23
        _tmp99 = _tmp63 * _tmp96
        _tmp100 = _tmp33 * _tmp48
        _tmp101 = _tmp48 * _tmp94
        _tmp102 = _tmp73 * _tmp96
        _tmp103 = -_tmp66 + _tmp67
        _tmp104 = _tmp53 * (_tmp103 + _tmp65) + _tmp62 - _tmp64
        _tmp105 = _tmp104 * _tmp21
        _tmp106 = _tmp46 * (_tmp103 + _tmp63)
        _tmp107 = -_tmp77 + _tmp78
        _tmp108 = _tmp53 * (_tmp107 + _tmp76) - _tmp74 + _tmp75
        _tmp109 = _tmp108 * _tmp21
        _tmp110 = _tmp46 * (_tmp107 + _tmp73)
