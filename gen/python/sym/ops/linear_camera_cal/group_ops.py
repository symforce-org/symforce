...
class GroupOps(object):
    ...
    @staticmethod
    def identity() -> sym.LinearCameraCal:
        # Total ops: 0
        ...
        # Output terms
        _res = sym.LinearCameraCal.from_storage([0, 0, 0, 0])
        return _res

    @staticmethod
    def inverse(a: sym.LinearCameraCal) -> sym.LinearCameraCal:
        # Total ops: 4
        ...
        # Output terms
        _res = sym.LinearCameraCal.from_storage([-_a[0], -_a[1], -_a[2], -_a[3]])
        return _res

    @staticmethod
    def compose(a: sym.LinearCameraCal, b: sym.LinearCameraCal) -> sym.LinearCameraCal:
        # Total ops: 4
    ...
    @staticmethod
    def between(a: sym.LinearCameraCal, b: sym.LinearCameraCal) -> sym.LinearCameraCal:
        # Total ops: 4
