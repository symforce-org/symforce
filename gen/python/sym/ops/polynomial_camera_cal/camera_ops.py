...
class CameraOps(object):
    ...
    def pixel_from_camera_point_with_jacobians(self, point, epsilon):
        ...
        _tmp16 = _self[0] * point[0]
        _tmp17 = _tmp12 * (1.0 * _tmp3 + 1.0 * _tmp5 + 1.0 * epsilon)
        _tmp18 = _self[1] * point[1]
        _tmp19 = _tmp12 * _tmp9
        _tmp20 = _tmp12 * _tmp7
        _tmp21 = _tmp2 * point[0]
        _tmp22 = 2.0 * _self[5]
        ...
        _tmp28 = _tmp2 * point[1]
        _tmp29 = _tmp12 * (_tmp22 * _tmp28 + _tmp24 * _tmp28 + _tmp26 * _tmp28)
        _tmp30 = (0.0 if -epsilon + point[2] == 0 else math.copysign(1, -epsilon + point[2])) + 1
        ...
        # Output terms
        _pixel = [0.0] * 2
        _pixel[0] = _self[2] + _tmp14 * point[0]
        _pixel[1] = _self[3] + _tmp15 * point[1]
        _is_valid = max(
            0,
            min(
                (0.0 if point[2] == 0 else math.copysign(1, point[2])),
        ...
        _pixel_D_cal[0, 0] = _tmp13 * point[0]
        _pixel_D_cal[1, 0] = 0
        _pixel_D_cal[0, 1] = 0
        _pixel_D_cal[1, 1] = _tmp13 * point[1]
        _pixel_D_cal[0, 2] = 1
        _pixel_D_cal[1, 2] = 0
        _pixel_D_cal[0, 3] = 0
        _pixel_D_cal[1, 3] = 1
