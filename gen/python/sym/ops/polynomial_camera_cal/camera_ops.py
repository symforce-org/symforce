...
class CameraOps(object):
    ...
    @staticmethod
    def focal_length(self: sym.PolynomialCameraCal) -> numpy.ndarray:
        """
    ...
    @staticmethod
    def principal_point(self: sym.PolynomialCameraCal) -> numpy.ndarray:
        """
    ...
    def pixel_from_camera_point(
        self: sym.PolynomialCameraCal, point: numpy.ndarray, epsilon: float
