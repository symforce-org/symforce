...
class LieGroupOps(object):
    ...
    @staticmethod
    def from_tangent(vec: numpy.ndarray, epsilon: float) -> sym.Rot2:
        # Total ops: 2
    ...
    @staticmethod
    def retract(a: sym.Rot2, vec: numpy.ndarray, epsilon: float) -> sym.Rot2:
        # Total ops: 8
    ...
    @staticmethod
    def interpolate(a: sym.Rot2, b: sym.Rot2, alpha: float, epsilon: float) -> sym.Rot2:
        # Total ops: 18
