...
class Pose3(object):
    ...
    def compose_with_point(self, right):
        # type: (Pose3, sym.util.VectorType) -> numpy.ndarray
        """
        ...
        # Input arrays
        _self = self.data
        right = sym.util.check_size_and_reshape(right, "right", (3, 1))
    ...
    def from_tangent(cls, vec, epsilon=1e-8):
        # type: (T.Union[T.Sequence[float], numpy.ndarray], float) -> Pose3
    ...
    def __mul__(self, other):
        # type: (T.Union[Pose3, T.Sequence[float], numpy.ndarray]) -> T.Union[Pose3, numpy.ndarray]
        if isinstance(other, Pose3):
