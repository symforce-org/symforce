...
__attribute__((noinline)) sym::Pose3<Scalar> PoseInverseWithJacobian(
  ...
  const Scalar _tmp5 = _pose[6] * _tmp4;
  const Scalar _tmp6 = _pose[3] * _tmp2;
  const Scalar _tmp7 = _pose[0] * _tmp0;
  const Scalar _tmp8 = _tmp6 + _tmp7;
  const Scalar _tmp9 = _pose[5] * _tmp8;
  const Scalar _tmp10 = std::pow(_pose[1], Scalar(2));
  const Scalar _tmp11 = 2 * _tmp10;
  const Scalar _tmp12 = std::pow(_pose[2], Scalar(2));
  const Scalar _tmp13 = 2 * _tmp12 - 1;
  const Scalar _tmp14 = _tmp11 + _tmp13;
  const Scalar _tmp15 = _tmp6 - _tmp7;
  ...
  const Scalar _tmp24 = _pose[5] * _tmp23;
  const Scalar _tmp25 = _tmp1 + _tmp3;
  const Scalar _tmp26 = _pose[4] * _tmp25;
  const Scalar _tmp27 = _tmp11 + _tmp21 - 1;
  const Scalar _tmp28 = -_tmp10;
  const Scalar _tmp29 = std::pow(_pose[3], Scalar(2));
  const Scalar _tmp30 = -_tmp12 + _tmp29;
  const Scalar _tmp31 = _tmp20 + _tmp28 + _tmp30;
  const Scalar _tmp32 = -_tmp25;
  const Scalar _tmp33 = -_tmp8;
  const Scalar _tmp34 = -_tmp20;
  const Scalar _tmp35 = _tmp10 + _tmp30 + _tmp34;
  const Scalar _tmp36 = -_tmp18;
  const Scalar _tmp37 = _tmp12 + _tmp28 + _tmp29 + _tmp34;
  const Scalar _tmp38 = _pose[6] * _tmp37 - _tmp24 + _tmp26;
  const Scalar _tmp39 = -_pose[4] * _tmp15 + _pose[5] * _tmp35 + _tmp19;
  const Scalar _tmp40 = _pose[4] * _tmp31 - _tmp5 + _tmp9;
  ...
  _res[2] = -_pose[2];
  _res[3] = _pose[3];
  _res[4] = _pose[4] * _tmp14 + _tmp5 - _tmp9;
  _res[5] = _pose[4] * _tmp15 + _pose[5] * _tmp22 - _tmp19;
  _res[6] = _pose[6] * _tmp27 + _tmp24 - _tmp26;

  if (res_D_pose != nullptr) {
    Eigen::Matrix<Scalar, 6, 6>& _res_D_pose = (*res_D_pose);

    _res_D_pose(0, 0) = -_tmp31;
    _res_D_pose(0, 1) = _tmp15;
    _res_D_pose(0, 2) = _tmp32;
    _res_D_pose(0, 3) = 0;
    _res_D_pose(0, 4) = 0;
    _res_D_pose(0, 5) = 0;
    ...
    _res_D_pose(2, 1) = _tmp36;
    _res_D_pose(2, 2) = -_tmp37;
    _res_D_pose(2, 3) = 0;
    _res_D_pose(2, 4) = 0;
    _res_D_pose(2, 5) = 0;
    _res_D_pose(3, 0) = 0;
    _res_D_pose(3, 1) = _tmp38;
    _res_D_pose(3, 2) = -_tmp39;
    _res_D_pose(3, 3) = _tmp14;
    _res_D_pose(3, 4) = _tmp33;
    _res_D_pose(3, 5) = _tmp4;
    _res_D_pose(4, 0) = -_tmp38;
    _res_D_pose(4, 1) = 0;
    _res_D_pose(4, 2) = _tmp40;
    _res_D_pose(4, 3) = _tmp15;
    _res_D_pose(4, 4) = _tmp22;
    _res_D_pose(4, 5) = _tmp36;
    _res_D_pose(5, 0) = _tmp39;
    _res_D_pose(5, 1) = -_tmp40;
    _res_D_pose(5, 2) = 0;
    _res_D_pose(5, 3) = _tmp32;
    _res_D_pose(5, 4) = _tmp23;
    _res_D_pose(5, 5) = _tmp27;
  }
