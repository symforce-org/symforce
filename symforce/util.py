...
def symbolic_eval(func: T.Callable[..., _T]) -> _T:
    ...
    See also: symforce.type_helpers.symbolic_inputs
    """
...
def lambdify(f: T.Callable, use_numba: bool = False) -> T.Callable:
    """
    Convert a symbolic function to a numerical one.  This is a thin wrapper around Codegen.function,
    provided for convenience.

    Args:
        f: A callable with symbolic inputs and outputs - see Codegen.function for details
        use_numba: If True, use Numba to compile the generated function.  This can be much faster,
                   but has some limitations - see codegen.PythonConfig for details

    Returns:
        A numerical function equivalent to `f`

    See also: symforce.codegen.Codegen.function, symforce.codegen.PythonConfig
    """
