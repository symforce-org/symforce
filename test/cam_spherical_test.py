...
class CamSphericalTest(StorageOpsTestMixin, TestCase):
    """
    ...
    def test_max_critical_theta(self) -> None:
        ...
        self.assertNear(cal.critical_theta, 1.8257419)
        ...
        self.assertNear(cal.critical_theta, 1.8565507)
        ...
        self.assertNear(cal.critical_theta, 1.2742925)
