...
#include "./symforce_function_codegen_test_data/codegen_test_cpp_ns/constants_t.h"
#include "./symforce_function_codegen_test_data/codegen_test_cpp_ns/states_t.h"
...
int main(int argc, char** argv) {
    ...
    double y = -5.0;
    geo::Rot3<double> rot;
    codegen_test_cpp_ns::states_t states;
    states.p = {1.0, 2.0};
    codegen_test_cpp_ns::constants_t constants;
    constants.epsilon = 1e-8;

    double foo;
    double bar;
    codegen_test_cpp_ns::CodegenTestCpp<double>(x, y, rot, constants, states, &foo, &bar);
