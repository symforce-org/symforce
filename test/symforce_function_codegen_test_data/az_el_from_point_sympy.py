def az_el_from_point(nav_T_cam, nav_t_point, epsilon):
    ...
    _tmp10 = _tmp8 + _tmp9
    _tmp11 = -_nav_T_cam[4]*_tmp4 - _nav_T_cam[5]*_tmp10 - _nav_T_cam[6]*_tmp7 + _tmp10*nav_t_point[1] + _tmp4*nav_t_point[0] + _tmp7*nav_t_point[2]
    _tmp12 = _tmp1 + _tmp3
    ...
    _tmp17 = _tmp16 + _tmp9
    _tmp18 = -_nav_T_cam[4]*_tmp17 - _nav_T_cam[5]*_tmp12 - _nav_T_cam[6]*_tmp15 + _tmp12*nav_t_point[1] + _tmp15*nav_t_point[2] + _tmp17*nav_t_point[0]
