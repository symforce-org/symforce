...
#ifndef __codegen_multi_function_inputs_constants_t_hpp__
#define __codegen_multi_function_inputs_constants_t_hpp__
...
int64_t inputs_constants_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* inputs_constants_t::getTypeName()
{
...
uint64_t inputs_constants_t::_computeHash(const __lcm_hash_ptr *)
{
