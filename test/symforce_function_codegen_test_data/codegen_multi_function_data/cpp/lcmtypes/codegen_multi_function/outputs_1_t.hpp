...
#ifndef __codegen_multi_function_outputs_1_t_hpp__
#define __codegen_multi_function_outputs_1_t_hpp__
...
class outputs_1_t
{
    public:
        ...
        codegen_multi_function::values_vec_t values_vec_out[3];

        codegen_multi_function::values_vec_t values_vec_2D_out[2][1];
