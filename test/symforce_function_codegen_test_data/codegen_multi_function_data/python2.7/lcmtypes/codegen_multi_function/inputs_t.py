...
class inputs_t(object):
    ...
    __typenames__ = [
        ...
        "codegen_multi_function.values_vec_t",
        "codegen_multi_function.inputs_constants_t",
        "codegen_multi_function.inputs_states_t",
    ]
    ...
    def _encode_one(self, buf):
        ...
        assert (
            ...
            == codegen_multi_function.inputs_constants_t._get_packed_fingerprint()
        )
        self.constants._encode_one(buf)
        assert (
            self.states._get_packed_fingerprint()
            == codegen_multi_function.inputs_states_t._get_packed_fingerprint()
        )
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (
            ...
            + codegen_multi_function.values_vec_t._get_hash_recursive(newparents)
            + codegen_multi_function.inputs_constants_t._get_hash_recursive(newparents)
            + codegen_multi_function.inputs_states_t._get_hash_recursive(newparents)
        ) & 0xFFFFFFFFFFFFFFFF
