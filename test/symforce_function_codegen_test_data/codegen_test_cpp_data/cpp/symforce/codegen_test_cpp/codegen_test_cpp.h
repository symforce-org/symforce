...
void CodegenTestCpp(
    ...
    const std::array<codegen_test_cpp::values_vec_t, 3>& values_vec,
    const std::array<std::array<codegen_test_cpp::values_vec_t, 1>, 2>& values_vec_2D,
    const codegen_test_cpp::constants_t& constants, const codegen_test_cpp::states_t& states,
    Scalar* const foo = nullptr, Scalar* const bar = nullptr,
    std::array<Scalar, 3>* const scalar_vec_out = nullptr,
    std::array<codegen_test_cpp::values_vec_t, 3>* const values_vec_out = nullptr,
    std::array<std::array<codegen_test_cpp::values_vec_t, 1>, 2>* const values_vec_2D_out =
        nullptr) {
  // Input arrays
  ...
  if (values_vec_2D_out != nullptr) {
    std::array<std::array<codegen_test_cpp::values_vec_t, 1>, 2>& _values_vec_2D_out =
        (*values_vec_2D_out);
