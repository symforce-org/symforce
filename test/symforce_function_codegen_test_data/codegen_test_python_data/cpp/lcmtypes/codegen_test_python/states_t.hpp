...
#ifndef __codegen_test_python_states_t_hpp__
#define __codegen_test_python_states_t_hpp__
...
const char* states_t::getTypeName()
{
    return "states_t";
}
...
uint64_t states_t::_computeHash(const __lcm_hash_ptr *)
{
