...
import codegen_test_python

def python_function(x, y, rot, rot_vec, scalar_vec, list_of_lists, values_vec, values_vec_2D, constants, states):
    """
    ...
    _values_vec_out[5] = -values_vec[0].rot[0]**2 - values_vec[0].rot[1]**2 - values_vec[0].rot[2]**2 + values_vec[0].rot[3]**2
    ...
    _values_vec_out[9] = -values_vec[0].rot_vec[0][0]**2 - values_vec[0].rot_vec[0][1]**2 - values_vec[0].rot_vec[0][2]**2 + values_vec[0].rot_vec[0][3]**2
    ...
    _values_vec_out[13] = -values_vec[0].rot_vec[1][0]**2 - values_vec[0].rot_vec[1][1]**2 - values_vec[0].rot_vec[1][2]**2 + values_vec[0].rot_vec[1][3]**2
    ...
    _values_vec_out[17] = -values_vec[0].rot_vec[2][0]**2 - values_vec[0].rot_vec[2][1]**2 - values_vec[0].rot_vec[2][2]**2 + values_vec[0].rot_vec[2][3]**2
    ...
    _values_vec_out[24] = -values_vec[0].list_of_lists[0][0][0]**2 - values_vec[0].list_of_lists[0][0][1]**2 - values_vec[0].list_of_lists[0][0][2]**2 + values_vec[0].list_of_lists[0][0][3]**2
    ...
    _values_vec_out[28] = -values_vec[0].list_of_lists[0][1][0]**2 - values_vec[0].list_of_lists[0][1][1]**2 - values_vec[0].list_of_lists[0][1][2]**2 + values_vec[0].list_of_lists[0][1][3]**2
    ...
    _values_vec_out[32] = -values_vec[0].list_of_lists[0][2][0]**2 - values_vec[0].list_of_lists[0][2][1]**2 - values_vec[0].list_of_lists[0][2][2]**2 + values_vec[0].list_of_lists[0][2][3]**2
    ...
    _values_vec_out[36] = -values_vec[0].list_of_lists[1][0][0]**2 - values_vec[0].list_of_lists[1][0][1]**2 - values_vec[0].list_of_lists[1][0][2]**2 + values_vec[0].list_of_lists[1][0][3]**2
    ...
    _values_vec_out[40] = -values_vec[0].list_of_lists[1][1][0]**2 - values_vec[0].list_of_lists[1][1][1]**2 - values_vec[0].list_of_lists[1][1][2]**2 + values_vec[0].list_of_lists[1][1][3]**2
    ...
    _values_vec_out[44] = -values_vec[0].list_of_lists[1][2][0]**2 - values_vec[0].list_of_lists[1][2][1]**2 - values_vec[0].list_of_lists[1][2][2]**2 + values_vec[0].list_of_lists[1][2][3]**2
    ...
    _values_vec_out[48] = -values_vec[0].list_of_lists[2][0][0]**2 - values_vec[0].list_of_lists[2][0][1]**2 - values_vec[0].list_of_lists[2][0][2]**2 + values_vec[0].list_of_lists[2][0][3]**2
    ...
    _values_vec_out[52] = -values_vec[0].list_of_lists[2][1][0]**2 - values_vec[0].list_of_lists[2][1][1]**2 - values_vec[0].list_of_lists[2][1][2]**2 + values_vec[0].list_of_lists[2][1][3]**2
    ...
    _values_vec_out[56] = -values_vec[0].list_of_lists[2][2][0]**2 - values_vec[0].list_of_lists[2][2][1]**2 - values_vec[0].list_of_lists[2][2][2]**2 + values_vec[0].list_of_lists[2][2][3]**2
    ...
    _values_vec_out[62] = -values_vec[1].rot[0]**2 - values_vec[1].rot[1]**2 - values_vec[1].rot[2]**2 + values_vec[1].rot[3]**2
    ...
    _values_vec_out[66] = -values_vec[1].rot_vec[0][0]**2 - values_vec[1].rot_vec[0][1]**2 - values_vec[1].rot_vec[0][2]**2 + values_vec[1].rot_vec[0][3]**2
    ...
    _values_vec_out[70] = -values_vec[1].rot_vec[1][0]**2 - values_vec[1].rot_vec[1][1]**2 - values_vec[1].rot_vec[1][2]**2 + values_vec[1].rot_vec[1][3]**2
    ...
    _values_vec_out[74] = -values_vec[1].rot_vec[2][0]**2 - values_vec[1].rot_vec[2][1]**2 - values_vec[1].rot_vec[2][2]**2 + values_vec[1].rot_vec[2][3]**2
    ...
    _values_vec_out[81] = -values_vec[1].list_of_lists[0][0][0]**2 - values_vec[1].list_of_lists[0][0][1]**2 - values_vec[1].list_of_lists[0][0][2]**2 + values_vec[1].list_of_lists[0][0][3]**2
    ...
    _values_vec_out[85] = -values_vec[1].list_of_lists[0][1][0]**2 - values_vec[1].list_of_lists[0][1][1]**2 - values_vec[1].list_of_lists[0][1][2]**2 + values_vec[1].list_of_lists[0][1][3]**2
    ...
    _values_vec_out[89] = -values_vec[1].list_of_lists[0][2][0]**2 - values_vec[1].list_of_lists[0][2][1]**2 - values_vec[1].list_of_lists[0][2][2]**2 + values_vec[1].list_of_lists[0][2][3]**2
    ...
    _values_vec_out[93] = -values_vec[1].list_of_lists[1][0][0]**2 - values_vec[1].list_of_lists[1][0][1]**2 - values_vec[1].list_of_lists[1][0][2]**2 + values_vec[1].list_of_lists[1][0][3]**2
    ...
    _values_vec_out[97] = -values_vec[1].list_of_lists[1][1][0]**2 - values_vec[1].list_of_lists[1][1][1]**2 - values_vec[1].list_of_lists[1][1][2]**2 + values_vec[1].list_of_lists[1][1][3]**2
    ...
    _values_vec_out[101] = -values_vec[1].list_of_lists[1][2][0]**2 - values_vec[1].list_of_lists[1][2][1]**2 - values_vec[1].list_of_lists[1][2][2]**2 + values_vec[1].list_of_lists[1][2][3]**2
    ...
    _values_vec_out[105] = -values_vec[1].list_of_lists[2][0][0]**2 - values_vec[1].list_of_lists[2][0][1]**2 - values_vec[1].list_of_lists[2][0][2]**2 + values_vec[1].list_of_lists[2][0][3]**2
    ...
    _values_vec_out[109] = -values_vec[1].list_of_lists[2][1][0]**2 - values_vec[1].list_of_lists[2][1][1]**2 - values_vec[1].list_of_lists[2][1][2]**2 + values_vec[1].list_of_lists[2][1][3]**2
    ...
    _values_vec_out[113] = -values_vec[1].list_of_lists[2][2][0]**2 - values_vec[1].list_of_lists[2][2][1]**2 - values_vec[1].list_of_lists[2][2][2]**2 + values_vec[1].list_of_lists[2][2][3]**2
    ...
    _values_vec_out[119] = -values_vec[2].rot[0]**2 - values_vec[2].rot[1]**2 - values_vec[2].rot[2]**2 + values_vec[2].rot[3]**2
    ...
    _values_vec_out[123] = -values_vec[2].rot_vec[0][0]**2 - values_vec[2].rot_vec[0][1]**2 - values_vec[2].rot_vec[0][2]**2 + values_vec[2].rot_vec[0][3]**2
    ...
    _values_vec_out[127] = -values_vec[2].rot_vec[1][0]**2 - values_vec[2].rot_vec[1][1]**2 - values_vec[2].rot_vec[1][2]**2 + values_vec[2].rot_vec[1][3]**2
    ...
    _values_vec_out[131] = -values_vec[2].rot_vec[2][0]**2 - values_vec[2].rot_vec[2][1]**2 - values_vec[2].rot_vec[2][2]**2 + values_vec[2].rot_vec[2][3]**2
    ...
    _values_vec_out[138] = -values_vec[2].list_of_lists[0][0][0]**2 - values_vec[2].list_of_lists[0][0][1]**2 - values_vec[2].list_of_lists[0][0][2]**2 + values_vec[2].list_of_lists[0][0][3]**2
    ...
    _values_vec_out[142] = -values_vec[2].list_of_lists[0][1][0]**2 - values_vec[2].list_of_lists[0][1][1]**2 - values_vec[2].list_of_lists[0][1][2]**2 + values_vec[2].list_of_lists[0][1][3]**2
    ...
    _values_vec_out[146] = -values_vec[2].list_of_lists[0][2][0]**2 - values_vec[2].list_of_lists[0][2][1]**2 - values_vec[2].list_of_lists[0][2][2]**2 + values_vec[2].list_of_lists[0][2][3]**2
    ...
    _values_vec_out[150] = -values_vec[2].list_of_lists[1][0][0]**2 - values_vec[2].list_of_lists[1][0][1]**2 - values_vec[2].list_of_lists[1][0][2]**2 + values_vec[2].list_of_lists[1][0][3]**2
    ...
    _values_vec_out[154] = -values_vec[2].list_of_lists[1][1][0]**2 - values_vec[2].list_of_lists[1][1][1]**2 - values_vec[2].list_of_lists[1][1][2]**2 + values_vec[2].list_of_lists[1][1][3]**2
    ...
    _values_vec_out[158] = -values_vec[2].list_of_lists[1][2][0]**2 - values_vec[2].list_of_lists[1][2][1]**2 - values_vec[2].list_of_lists[1][2][2]**2 + values_vec[2].list_of_lists[1][2][3]**2
    ...
    _values_vec_out[162] = -values_vec[2].list_of_lists[2][0][0]**2 - values_vec[2].list_of_lists[2][0][1]**2 - values_vec[2].list_of_lists[2][0][2]**2 + values_vec[2].list_of_lists[2][0][3]**2
    ...
    _values_vec_out[166] = -values_vec[2].list_of_lists[2][1][0]**2 - values_vec[2].list_of_lists[2][1][1]**2 - values_vec[2].list_of_lists[2][1][2]**2 + values_vec[2].list_of_lists[2][1][3]**2
    ...
    _values_vec_out[170] = -values_vec[2].list_of_lists[2][2][0]**2 - values_vec[2].list_of_lists[2][2][1]**2 - values_vec[2].list_of_lists[2][2][2]**2 + values_vec[2].list_of_lists[2][2][3]**2
    _values_vec_2D_out = [0.] * 114
    ...
    _values_vec_2D_out[5] = -values_vec_2D[0][0].rot[0]**2 - values_vec_2D[0][0].rot[1]**2 - values_vec_2D[0][0].rot[2]**2 + values_vec_2D[0][0].rot[3]**2
    ...
    _values_vec_2D_out[9] = -values_vec_2D[0][0].rot_vec[0][0]**2 - values_vec_2D[0][0].rot_vec[0][1]**2 - values_vec_2D[0][0].rot_vec[0][2]**2 + values_vec_2D[0][0].rot_vec[0][3]**2
    ...
    _values_vec_2D_out[13] = -values_vec_2D[0][0].rot_vec[1][0]**2 - values_vec_2D[0][0].rot_vec[1][1]**2 - values_vec_2D[0][0].rot_vec[1][2]**2 + values_vec_2D[0][0].rot_vec[1][3]**2
    ...
    _values_vec_2D_out[17] = -values_vec_2D[0][0].rot_vec[2][0]**2 - values_vec_2D[0][0].rot_vec[2][1]**2 - values_vec_2D[0][0].rot_vec[2][2]**2 + values_vec_2D[0][0].rot_vec[2][3]**2
    ...
    _values_vec_2D_out[24] = -values_vec_2D[0][0].list_of_lists[0][0][0]**2 - values_vec_2D[0][0].list_of_lists[0][0][1]**2 - values_vec_2D[0][0].list_of_lists[0][0][2]**2 + values_vec_2D[0][0].list_of_lists[0][0][3]**2
    ...
    _values_vec_2D_out[28] = -values_vec_2D[0][0].list_of_lists[0][1][0]**2 - values_vec_2D[0][0].list_of_lists[0][1][1]**2 - values_vec_2D[0][0].list_of_lists[0][1][2]**2 + values_vec_2D[0][0].list_of_lists[0][1][3]**2
    ...
    _values_vec_2D_out[32] = -values_vec_2D[0][0].list_of_lists[0][2][0]**2 - values_vec_2D[0][0].list_of_lists[0][2][1]**2 - values_vec_2D[0][0].list_of_lists[0][2][2]**2 + values_vec_2D[0][0].list_of_lists[0][2][3]**2
    ...
    _values_vec_2D_out[36] = -values_vec_2D[0][0].list_of_lists[1][0][0]**2 - values_vec_2D[0][0].list_of_lists[1][0][1]**2 - values_vec_2D[0][0].list_of_lists[1][0][2]**2 + values_vec_2D[0][0].list_of_lists[1][0][3]**2
    ...
    _values_vec_2D_out[40] = -values_vec_2D[0][0].list_of_lists[1][1][0]**2 - values_vec_2D[0][0].list_of_lists[1][1][1]**2 - values_vec_2D[0][0].list_of_lists[1][1][2]**2 + values_vec_2D[0][0].list_of_lists[1][1][3]**2
    ...
    _values_vec_2D_out[44] = -values_vec_2D[0][0].list_of_lists[1][2][0]**2 - values_vec_2D[0][0].list_of_lists[1][2][1]**2 - values_vec_2D[0][0].list_of_lists[1][2][2]**2 + values_vec_2D[0][0].list_of_lists[1][2][3]**2
    ...
    _values_vec_2D_out[48] = -values_vec_2D[0][0].list_of_lists[2][0][0]**2 - values_vec_2D[0][0].list_of_lists[2][0][1]**2 - values_vec_2D[0][0].list_of_lists[2][0][2]**2 + values_vec_2D[0][0].list_of_lists[2][0][3]**2
    ...
    _values_vec_2D_out[52] = -values_vec_2D[0][0].list_of_lists[2][1][0]**2 - values_vec_2D[0][0].list_of_lists[2][1][1]**2 - values_vec_2D[0][0].list_of_lists[2][1][2]**2 + values_vec_2D[0][0].list_of_lists[2][1][3]**2
    ...
    _values_vec_2D_out[56] = -values_vec_2D[0][0].list_of_lists[2][2][0]**2 - values_vec_2D[0][0].list_of_lists[2][2][1]**2 - values_vec_2D[0][0].list_of_lists[2][2][2]**2 + values_vec_2D[0][0].list_of_lists[2][2][3]**2
    ...
    _values_vec_2D_out[62] = -values_vec_2D[1][0].rot[0]**2 - values_vec_2D[1][0].rot[1]**2 - values_vec_2D[1][0].rot[2]**2 + values_vec_2D[1][0].rot[3]**2
    ...
    _values_vec_2D_out[66] = -values_vec_2D[1][0].rot_vec[0][0]**2 - values_vec_2D[1][0].rot_vec[0][1]**2 - values_vec_2D[1][0].rot_vec[0][2]**2 + values_vec_2D[1][0].rot_vec[0][3]**2
    ...
    _values_vec_2D_out[70] = -values_vec_2D[1][0].rot_vec[1][0]**2 - values_vec_2D[1][0].rot_vec[1][1]**2 - values_vec_2D[1][0].rot_vec[1][2]**2 + values_vec_2D[1][0].rot_vec[1][3]**2
    ...
    _values_vec_2D_out[74] = -values_vec_2D[1][0].rot_vec[2][0]**2 - values_vec_2D[1][0].rot_vec[2][1]**2 - values_vec_2D[1][0].rot_vec[2][2]**2 + values_vec_2D[1][0].rot_vec[2][3]**2
    ...
    _values_vec_2D_out[81] = -values_vec_2D[1][0].list_of_lists[0][0][0]**2 - values_vec_2D[1][0].list_of_lists[0][0][1]**2 - values_vec_2D[1][0].list_of_lists[0][0][2]**2 + values_vec_2D[1][0].list_of_lists[0][0][3]**2
    ...
    _values_vec_2D_out[85] = -values_vec_2D[1][0].list_of_lists[0][1][0]**2 - values_vec_2D[1][0].list_of_lists[0][1][1]**2 - values_vec_2D[1][0].list_of_lists[0][1][2]**2 + values_vec_2D[1][0].list_of_lists[0][1][3]**2
    ...
    _values_vec_2D_out[89] = -values_vec_2D[1][0].list_of_lists[0][2][0]**2 - values_vec_2D[1][0].list_of_lists[0][2][1]**2 - values_vec_2D[1][0].list_of_lists[0][2][2]**2 + values_vec_2D[1][0].list_of_lists[0][2][3]**2
    ...
    _values_vec_2D_out[93] = -values_vec_2D[1][0].list_of_lists[1][0][0]**2 - values_vec_2D[1][0].list_of_lists[1][0][1]**2 - values_vec_2D[1][0].list_of_lists[1][0][2]**2 + values_vec_2D[1][0].list_of_lists[1][0][3]**2
    ...
    _values_vec_2D_out[97] = -values_vec_2D[1][0].list_of_lists[1][1][0]**2 - values_vec_2D[1][0].list_of_lists[1][1][1]**2 - values_vec_2D[1][0].list_of_lists[1][1][2]**2 + values_vec_2D[1][0].list_of_lists[1][1][3]**2
    ...
    _values_vec_2D_out[101] = -values_vec_2D[1][0].list_of_lists[1][2][0]**2 - values_vec_2D[1][0].list_of_lists[1][2][1]**2 - values_vec_2D[1][0].list_of_lists[1][2][2]**2 + values_vec_2D[1][0].list_of_lists[1][2][3]**2
    ...
    _values_vec_2D_out[105] = -values_vec_2D[1][0].list_of_lists[2][0][0]**2 - values_vec_2D[1][0].list_of_lists[2][0][1]**2 - values_vec_2D[1][0].list_of_lists[2][0][2]**2 + values_vec_2D[1][0].list_of_lists[2][0][3]**2
    ...
    _values_vec_2D_out[109] = -values_vec_2D[1][0].list_of_lists[2][1][0]**2 - values_vec_2D[1][0].list_of_lists[2][1][1]**2 - values_vec_2D[1][0].list_of_lists[2][1][2]**2 + values_vec_2D[1][0].list_of_lists[2][1][3]**2
    ...
    _values_vec_2D_out[113] = -values_vec_2D[1][0].list_of_lists[2][2][0]**2 - values_vec_2D[1][0].list_of_lists[2][2][1]**2 - values_vec_2D[1][0].list_of_lists[2][2][2]**2 + values_vec_2D[1][0].list_of_lists[2][2][3]**2
