...
Eigen::Matrix<Scalar, 6, 6> ComposePose3_Jacobian0(const geo::Pose3<Scalar>& a, const geo::Pose3<Scalar>& b) {
    ...
    const Scalar _tmp65 = -2*(_tmp6 * _tmp6) + 1;
    ...
    const Scalar _tmp92 = (1.0/2.0)*_tmp54*_tmp89 + (1.0/2.0)*_tmp63*_tmp90 + (1.0/2.0)*_tmp66*_tmp91;
    ...
    const Scalar _tmp100 = -2*(_a[2] * _a[2]) + 1;
    ...
    const Scalar _tmp119 = (1.0/2.0)*_tmp113*_tmp73 + (1.0/2.0)*_tmp115*_tmp76 + (1.0/2.0)*_tmp116*_tmp79;
