...
geo::Pose3<Scalar> ComposePose3_ValueAndJacobian0(const geo::Pose3<Scalar>& a, const geo::Pose3<Scalar>& b, Eigen::Matrix<Scalar, 6, 6>* const res_D_a = nullptr) {
    // Input arrays
    ...
    const Scalar _tmp112 = (1.0/2.0)*_tmp109*_tmp75 + (1.0/2.0)*_tmp110*_tmp84 + (1.0/2.0)*_tmp111*_tmp87;
    ...
    const Scalar _tmp121 = (1.0/2.0)*_tmp115*_tmp94 + (1.0/2.0)*_tmp117*_tmp96 + (1.0/2.0)*_tmp118*_tmp99;
