...
int my_dataclass_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int my_dataclass_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int my_dataclass_t::getEncodedSize() const
{
...
int my_dataclass_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int my_dataclass_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int my_dataclass_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
