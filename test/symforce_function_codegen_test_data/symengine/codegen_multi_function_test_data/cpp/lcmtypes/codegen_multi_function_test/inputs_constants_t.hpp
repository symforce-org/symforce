...
class inputs_constants_t
{
    ...
    public:
        ...
        static lcm::StructType schema()
        {
            ...
            fields.push_back(lcm::get_schema<decltype(inputs_constants_t::epsilon)>());
        ...
        uint32_t show_field(std::ostream& _stream, const uint32_t _field_indices[], uint32_t _num_fields, const lcm::FormatSettings &_settings) const
        {
            ...
            switch (_field_indices[0]) {
                case 0:
                ret = lcm::show_field(_stream, _field_indices + 1, _num_fields - 1, epsilon, _settings);
                return ret == 0 ? ret : ret + 1;
                default:
                return 1;
            }
...
constexpr uint64_t inputs_constants_t::getHash()
{
...
constexpr inputs_constants_t::package_name_array_t* inputs_constants_t::getPackageNameArrayPtr() {
    return &"codegen_multi_function_test";
}

constexpr const char * inputs_constants_t::getPackageName()
{
    return *inputs_constants_t::getPackageNameArrayPtr();
}
