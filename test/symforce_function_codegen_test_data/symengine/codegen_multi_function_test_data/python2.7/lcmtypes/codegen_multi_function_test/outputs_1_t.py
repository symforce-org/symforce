...
class outputs_1_t(object):
    ...
    def __init__(self):
        ...
        self.values_vec_out = [codegen_multi_function_test.values_vec_t() for dim0 in range(3)]
    ...
    def _decode_one(buf):
        ...
        self.values_vec_out = []
        for i0 in range(3):
            self.values_vec_out.append(codegen_multi_function_test.values_vec_t._decode_one(buf))
        self.values_vec_2D_out = []
        for i0 in range(2):
