...
def python_function(
    ...
    y: float,
    rot: sym.Rot3,
    rot_vec: T.Sequence[sym.Rot3],
    scalar_vec: T.Sequence[float],
    list_of_lists: T.Sequence[T.Sequence[sym.Rot3]],
    values_vec: T.Sequence[T.Any],
    values_vec_2D: T.Sequence[T.Sequence[T.Any]],
    constants: T.Any,
    big_matrix: numpy.ndarray,
    small_matrix: numpy.ndarray,
    states: T.Any,
) -> T.Tuple[
    float, float, T.List[float], T.List[float], T.List[float], numpy.ndarray, numpy.ndarray
]:
    """
