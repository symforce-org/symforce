...
Eigen::Matrix<Scalar, 6, 6> ComposePose3Jacobian0(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp10 = (Scalar(1) / Scalar(2)) * _a[1];
  ...
  const Scalar _tmp17 = (Scalar(1) / Scalar(2)) * _a[0];
  ...
  const Scalar _tmp25 = (Scalar(1) / Scalar(2)) * _a[3];
  ...
  const Scalar _tmp32 = (Scalar(1) / Scalar(2)) * _a[2];
