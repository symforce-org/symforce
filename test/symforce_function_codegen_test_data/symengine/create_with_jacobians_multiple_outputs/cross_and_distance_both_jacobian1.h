...
void CrossAndDistanceBothJacobian1(const Eigen::Matrix<Scalar, 3, 1>& a,
  ...
  if (distance_D_b != nullptr) {
    ...
    _distance_D_b(0, 0) = -_tmp0 * _tmp3;
    _distance_D_b(0, 1) = -_tmp1 * _tmp3;
    _distance_D_b(0, 2) = -_tmp2 * _tmp3;
  }
