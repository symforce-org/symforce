...
Eigen::Matrix<Scalar, 3, 1> CrossAndDistanceSecondWithJacobians(
  ...
  if (distance_D_a != nullptr) {
    ...
    _distance_D_a(0, 0) = _tmp5;
    _distance_D_a(0, 1) = _tmp6;
    _distance_D_a(0, 2) = _tmp7;
  }

  if (distance_D_b != nullptr) {
    Eigen::Matrix<Scalar, 1, 3>& _distance_D_b = (*distance_D_b);

    _distance_D_b(0, 0) = -_tmp5;
    _distance_D_b(0, 1) = -_tmp6;
    _distance_D_b(0, 2) = -_tmp7;
  }

  if (distance_D_epsilon != nullptr) {
    Eigen::Matrix<Scalar, 1, 1>& _distance_D_epsilon = (*distance_D_epsilon);

    _distance_D_epsilon(0, 0) = (Scalar(1) / Scalar(2)) * _tmp4;
  }
