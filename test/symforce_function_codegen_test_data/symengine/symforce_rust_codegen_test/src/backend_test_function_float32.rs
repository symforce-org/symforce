...
pub mod sym {
    ...
    pub fn backend_test_function_float32(
        ...
        let _tmp0: f32 = core::f32::consts::PI.recip();
        let _tmp1: f32 = 1.4142135623731_f32;
        let _tmp2: f32 = x.sqrt();
        let _tmp3: f32 = x + y;
        ...
        if let Some(res1) = res1 {
            *res1 = 1.00000000000000_f32;
        }

        if let Some(res2) = res2 {
            *res2 = 0.500000000000000_f32;
        }
        ...
        if let Some(res6) = res6 {
            *res6 = 1.44269504088896_f32;
        }

        if let Some(res7) = res7 {
            *res7 = 0.693147180559945_f32;
        }

        if let Some(res8) = res8 {
            *res8 = 2.30258509299405_f32;
        }
        ...
        if let Some(res10) = res10 {
            *res10 = 0.5_f32 * core::f32::consts::PI;
        }

        if let Some(res11) = res11 {
            *res11 = 0.25_f32 * core::f32::consts::PI;
        }
        ...
        if let Some(res43) = res43 {
            *res43 = x.powf(3_f32 / 2.0);
        }

        if let Some(res44) = res44 {
            *res44 = (1_f32 / 2.0) * x.signum() + 1_f32 / 2.0;
        }
