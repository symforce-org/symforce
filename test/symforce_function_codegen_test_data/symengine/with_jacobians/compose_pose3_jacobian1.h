...
Eigen::Matrix<Scalar, 6, 6> ComposePose3Jacobian1(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp23 = _a[1] * _b[3];
  const Scalar _tmp24 = (Scalar(1) / Scalar(2)) * _tmp23;
  const Scalar _tmp25 = _a[0] * _b[2];
  ...
  const Scalar _tmp35 = _a[0] * _b[0];
  const Scalar _tmp36 = _a[3] * _b[3];
  const Scalar _tmp37 = _a[2] * _b[2];
  ...
  const Scalar _tmp42 = _tmp10 * _tmp31;
  const Scalar _tmp43 = _tmp1 + _tmp3 + _tmp5 - _tmp7;
  const Scalar _tmp44 = 2 * _tmp38;
  const Scalar _tmp45 = _tmp21 * _tmp44;
  const Scalar _tmp46 = _tmp13 - _tmp15 - _tmp17 - _tmp19;
  const Scalar _tmp47 = _tmp32 * _tmp44;
  const Scalar _tmp48 = _tmp22 * _tmp8;
  const Scalar _tmp49 = _tmp24 - _tmp26 + _tmp28 + _tmp30;
  const Scalar _tmp50 = -_tmp22 * _tmp46;
  const Scalar _tmp51 = _tmp44 * _tmp9;
  const Scalar _tmp52 = _tmp33 * _tmp46;
  const Scalar _tmp53 = -2 * std::pow(_a[2], Scalar(2));
  const Scalar _tmp54 = 1 - 2 * std::pow(_a[1], Scalar(2));
  const Scalar _tmp55 = 2 * _a[0];
  const Scalar _tmp56 = _a[1] * _tmp55;
  const Scalar _tmp57 = 2 * _a[2];
  const Scalar _tmp58 = _a[3] * _tmp57;
  const Scalar _tmp59 = 2 * _a[1] * _a[3];
  const Scalar _tmp60 = _a[2] * _tmp55;
  const Scalar _tmp61 = -2 * std::pow(_a[0], Scalar(2));
  const Scalar _tmp62 = _a[3] * _tmp55;
  const Scalar _tmp63 = _a[1] * _tmp57;

  // Output terms (1)
  Eigen::Matrix<Scalar, 6, 6> _res_D_b;

  _res_D_b(0, 0) = _tmp11 + _tmp20 * _tmp22 + _tmp41;
  _res_D_b(0, 1) = -_tmp33 * _tmp43 + _tmp39 * _tmp46 - _tmp42 + _tmp45;
  _res_D_b(0, 2) = -_tmp10 * _tmp46 + _tmp39 * _tmp49 - _tmp47 + _tmp48;
  _res_D_b(0, 3) = 0;
  _res_D_b(0, 4) = 0;
  _res_D_b(0, 5) = 0;
  _res_D_b(1, 0) = _tmp20 * _tmp39 - _tmp33 * _tmp8 + _tmp42 - _tmp45;
  _res_D_b(1, 1) = _tmp10 * _tmp43 + _tmp41 + _tmp50;
  _res_D_b(1, 2) = -_tmp22 * _tmp49 + _tmp39 * _tmp8 + _tmp51 - _tmp52;
  _res_D_b(1, 3) = 0;
  _res_D_b(1, 4) = 0;
  _res_D_b(1, 5) = 0;
  _res_D_b(2, 0) = -_tmp10 * _tmp20 + _tmp31 * _tmp39 + _tmp47 - _tmp48;
  _res_D_b(2, 1) = -_tmp22 * _tmp31 + _tmp39 * _tmp43 - _tmp51 + _tmp52;
  _res_D_b(2, 2) = _tmp11 + _tmp33 * _tmp49 + _tmp40 + _tmp50;
  _res_D_b(2, 3) = 0;
  _res_D_b(2, 4) = 0;
  _res_D_b(2, 5) = 0;
  _res_D_b(3, 0) = 0;
