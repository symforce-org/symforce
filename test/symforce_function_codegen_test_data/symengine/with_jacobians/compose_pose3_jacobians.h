...
void ComposePose3Jacobians(const sym::Pose3<Scalar>& a, const sym::Pose3<Scalar>& b,
  ...
  const Scalar _tmp55 = _tmp49 - _tmp51;
  const Scalar _tmp56 = _tmp44 + _tmp46 + _tmp55;
  const Scalar _tmp57 = -_tmp39;
  const Scalar _tmp58 = _tmp37 + _tmp57;
  const Scalar _tmp59 = _tmp29 + _tmp33 + _tmp58;
  ...
  const Scalar _tmp66 = _tmp10 + _tmp6;
  const Scalar _tmp67 = _tmp65 + _tmp66;
  const Scalar _tmp68 = _tmp30 + _tmp32 + _tmp58;
  const Scalar _tmp69 = -_tmp44;
  const Scalar _tmp70 = _tmp46 + _tmp52 + _tmp69;
  const Scalar _tmp71 = _tmp1 + _tmp11 + _tmp64;
  const Scalar _tmp72 = _tmp15 + _tmp25 + _tmp60;
  const Scalar _tmp73 = 2 * _a[0];
  const Scalar _tmp74 = _a[2] * _tmp73;
  const Scalar _tmp75 = 2 * _a[3];
  const Scalar _tmp76 = _a[1] * _tmp75;
  const Scalar _tmp77 = _tmp74 + _tmp76;
  const Scalar _tmp78 = _a[1] * _tmp73;
  const Scalar _tmp79 = -_tmp78;
  const Scalar _tmp80 = _a[2] * _tmp75;
  const Scalar _tmp81 = std::pow(_a[0], Scalar(2));
  const Scalar _tmp82 = std::pow(_a[1], Scalar(2));
  const Scalar _tmp83 = -_tmp82;
  const Scalar _tmp84 = _tmp81 + _tmp83;
  const Scalar _tmp85 = std::pow(_a[2], Scalar(2));
  const Scalar _tmp86 = -_tmp85;
  const Scalar _tmp87 = std::pow(_a[3], Scalar(2));
  const Scalar _tmp88 = _tmp86 + _tmp87;
  const Scalar _tmp89 = -_tmp74;
  const Scalar _tmp90 = -_tmp76;
  const Scalar _tmp91 = -_tmp87;
  const Scalar _tmp92 = _tmp85 + _tmp91;
  const Scalar _tmp93 = -_tmp81;
  const Scalar _tmp94 = _tmp82 + _tmp93;
  const Scalar _tmp95 = -_tmp80;
  const Scalar _tmp96 = _tmp78 + _tmp95;
  const Scalar _tmp97 = 2 * _a[1] * _a[2];
  const Scalar _tmp98 = _a[0] * _tmp75;
  const Scalar _tmp99 = -_tmp98;
  const Scalar _tmp100 = _tmp97 + _tmp99;
  const Scalar _tmp101 = -_tmp97;
  const Scalar _tmp102 = _tmp78 + _tmp80;
  const Scalar _tmp103 = _tmp74 + _tmp90;
  const Scalar _tmp104 = _tmp97 + _tmp98;
  const Scalar _tmp105 = _tmp1 + _tmp4 + _tmp66;
  const Scalar _tmp106 = _tmp34 + _tmp36 + _tmp57;
  const Scalar _tmp107 = -_tmp106 * _tmp42;
  const Scalar _tmp108 = _tmp20 + _tmp24 + _tmp61;
  const Scalar _tmp109 = _tmp47 + _tmp55 + _tmp69;
  const Scalar _tmp110 = _tmp109 * _tmp54;
  const Scalar _tmp111 = -_tmp108 * _tmp27 + _tmp110;
  const Scalar _tmp112 = _tmp109 * _tmp13;
  const Scalar _tmp113 = _tmp29 + _tmp32 + _tmp40;
  const Scalar _tmp114 = _tmp108 * _tmp42;
  const Scalar _tmp115 = _tmp65 + _tmp7 + _tmp9;
  const Scalar _tmp116 = _tmp106 * _tmp13;
  const Scalar _tmp117 = _tmp109 * _tmp27;
  const Scalar _tmp118 = _tmp15 + _tmp18 + _tmp62;
  const Scalar _tmp119 = -_tmp115 * _tmp13;
  const Scalar _tmp120 = _tmp115 * _tmp27;
  const Scalar _tmp121 = _tmp109 * _tmp42;
  const Scalar _tmp122 = -2 * _tmp85;
  const Scalar _tmp123 = -2 * _tmp82;
  const Scalar _tmp124 = 1 - 2 * _tmp81;
  ...
  if (res_D_a != nullptr) {
    ...
    _res_D_a(0, 1) = _tmp13 * _tmp56 - _tmp27 * _tmp59 - _tmp42 * _tmp63 + _tmp54 * _tmp67;
    _res_D_a(0, 2) = _tmp13 * _tmp68 - _tmp27 * _tmp70 - _tmp42 * _tmp71 + _tmp54 * _tmp72;
    _res_D_a(0, 3) = 0;
    _res_D_a(0, 4) = 0;
    _res_D_a(0, 5) = 0;
    _res_D_a(1, 0) = _tmp12 * _tmp54 - _tmp13 * _tmp53 + _tmp26 * _tmp42 - _tmp27 * _tmp41;
    _res_D_a(1, 1) = -_tmp13 * _tmp67 - _tmp27 * _tmp63 + _tmp42 * _tmp59 + _tmp54 * _tmp56;
    _res_D_a(1, 2) = -_tmp13 * _tmp72 - _tmp27 * _tmp71 + _tmp42 * _tmp70 + _tmp54 * _tmp68;
    _res_D_a(1, 3) = 0;
    _res_D_a(1, 4) = 0;
    _res_D_a(1, 5) = 0;
    _res_D_a(2, 0) = -_tmp12 * _tmp42 - _tmp13 * _tmp41 + _tmp26 * _tmp54 + _tmp27 * _tmp53;
    _res_D_a(2, 1) = -_tmp13 * _tmp63 + _tmp27 * _tmp67 - _tmp42 * _tmp56 + _tmp54 * _tmp59;
    _res_D_a(2, 2) = -_tmp13 * _tmp71 + _tmp27 * _tmp72 - _tmp42 * _tmp68 + _tmp54 * _tmp70;
    _res_D_a(2, 3) = 0;
    _res_D_a(2, 4) = 0;
    _res_D_a(2, 5) = 0;
    _res_D_a(3, 0) = _b[5] * _tmp77 + _b[6] * (_tmp79 + _tmp80);
    _res_D_a(3, 1) = _b[4] * (_tmp89 + _tmp90) + _b[6] * (_tmp84 + _tmp88);
    _res_D_a(3, 2) = _b[4] * _tmp96 + _b[5] * (_tmp92 + _tmp94);
    _res_D_a(3, 3) = 1;
    _res_D_a(3, 4) = 0;
    _res_D_a(3, 5) = 0;
    _res_D_a(4, 0) = _b[5] * _tmp100 + _b[6] * (_tmp84 + _tmp92);
    _res_D_a(4, 1) = _b[4] * (_tmp101 + _tmp98) + _b[6] * _tmp102;
    _res_D_a(4, 2) = _b[4] * (_tmp88 + _tmp94) + _b[5] * (_tmp79 + _tmp95);
    _res_D_a(4, 3) = 0;
    _res_D_a(4, 4) = 1;
    _res_D_a(4, 5) = 0;
    _res_D_a(5, 0) = _b[5] * (_tmp83 + _tmp85 + _tmp87 + _tmp93) + _b[6] * (_tmp101 + _tmp99);
    _res_D_a(5, 1) = _b[4] * (_tmp81 + _tmp82 + _tmp86 + _tmp91) + _b[6] * _tmp103;
    _res_D_a(5, 2) = _b[4] * _tmp104 + _b[5] * (_tmp76 + _tmp89);
    _res_D_a(5, 3) = 0;
    _res_D_a(5, 4) = 0;
    _res_D_a(5, 5) = 1;
  }
  ...
  if (res_D_b != nullptr) {
    ...
    _res_D_b(0, 1) = _tmp112 - _tmp113 * _tmp27 - _tmp114 + _tmp115 * _tmp54;
    _res_D_b(0, 2) = -_tmp115 * _tmp42 + _tmp116 - _tmp117 + _tmp118 * _tmp54;
    _res_D_b(0, 3) = 0;
    _res_D_b(0, 4) = 0;
    _res_D_b(0, 5) = 0;
    _res_D_b(1, 0) = _tmp105 * _tmp54 - _tmp106 * _tmp27 - _tmp112 + _tmp114;
    _res_D_b(1, 1) = _tmp111 + _tmp113 * _tmp42 + _tmp119;
    _res_D_b(1, 2) = _tmp106 * _tmp54 - _tmp118 * _tmp13 - _tmp120 + _tmp121;
    _res_D_b(1, 3) = 0;
    _res_D_b(1, 4) = 0;
    _res_D_b(1, 5) = 0;
    _res_D_b(2, 0) = -_tmp105 * _tmp42 + _tmp108 * _tmp54 - _tmp116 + _tmp117;
    _res_D_b(2, 1) = -_tmp108 * _tmp13 + _tmp113 * _tmp54 + _tmp120 - _tmp121;
    _res_D_b(2, 2) = _tmp107 + _tmp110 + _tmp118 * _tmp27 + _tmp119;
    _res_D_b(2, 3) = 0;
    _res_D_b(2, 4) = 0;
    _res_D_b(2, 5) = 0;
    _res_D_b(3, 0) = 0;
    ...
    _res_D_b(4, 5) = _tmp100;
    _res_D_b(5, 0) = 0;
    _res_D_b(5, 1) = 0;
    _res_D_b(5, 2) = 0;
    _res_D_b(5, 3) = _tmp103;
