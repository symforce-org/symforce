...
sym::Pose3<Scalar> ComposePose3WithJacobian0(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp24 = 2 * _a[0] * _a[1];
  ...
  const Scalar _tmp36 = _a[0] * _tmp25;
  const Scalar _tmp37 = -_tmp36;
  const Scalar _tmp38 = _a[1] * _tmp30;
  const Scalar _tmp39 = _tmp37 + _tmp38;
  const Scalar _tmp40 = _tmp36 + _tmp38;
  ...
  const Scalar _tmp63 = (Scalar(1) / Scalar(2)) * _tmp11;
  ...
  const Scalar _tmp69 = (Scalar(1) / Scalar(2)) * _tmp16;
  const Scalar _tmp70 = (Scalar(1) / Scalar(2)) * _tmp15;
  const Scalar _tmp71 = _tmp69 + _tmp70;
  const Scalar _tmp72 = -_tmp67 + _tmp68 + _tmp71;
  const Scalar _tmp73 = 2 * _tmp19;
  const Scalar _tmp74 = -_tmp51;
  const Scalar _tmp75 = _tmp52 + _tmp56 + _tmp74;
  const Scalar _tmp76 = -_tmp43;
  const Scalar _tmp77 = _tmp45 + _tmp46 + _tmp47 + _tmp76;
  const Scalar _tmp78 = _tmp67 + _tmp68 - _tmp69 + _tmp70;
  const Scalar _tmp79 = -_tmp61;
  const Scalar _tmp80 = _tmp59 + _tmp64 + _tmp79;
  const Scalar _tmp81 = _tmp60 + _tmp62 + _tmp63 + _tmp79;
  const Scalar _tmp82 = _tmp67 - _tmp68 + _tmp71;
  const Scalar _tmp83 = _tmp44 + _tmp48 + _tmp76;
  const Scalar _tmp84 = 2 * _tmp53 + 2 * _tmp54 + 2 * _tmp55 + 2 * _tmp74;
  const Scalar _tmp85 = -_tmp24;
  const Scalar _tmp86 = -_tmp20;
  const Scalar _tmp87 = _tmp33 + _tmp86;
  const Scalar _tmp88 = std::pow(_a[3], Scalar(2));
  const Scalar _tmp89 = -_tmp22;
  const Scalar _tmp90 = _tmp88 + _tmp89;
  const Scalar _tmp91 = -_tmp31;
  const Scalar _tmp92 = -_tmp88;
  const Scalar _tmp93 = _tmp22 + _tmp92;
  const Scalar _tmp94 = -_tmp33;
  const Scalar _tmp95 = _tmp20 + _tmp94;
  const Scalar _tmp96 = -_tmp38;
  ...
  _res[2] = _tmp14;
  _res[3] = _tmp19;
  _res[4] = _a[4] + _b[4] * (_tmp21 + _tmp23) + _b[5] * _tmp28 + _b[6] * _tmp32;
  _res[5] = _a[5] + _b[4] * _tmp35 + _b[5] * (_tmp21 + _tmp34 + 1) + _b[6] * _tmp39;
  ...
  if (res_D_a != nullptr) {
    ...
    _res_D_a(0, 1) = -_tmp50 * _tmp75 - _tmp58 * _tmp77 + _tmp66 * _tmp78 + _tmp73 * _tmp80;
    _res_D_a(0, 2) = _tmp19 * _tmp84 - _tmp50 * _tmp81 - _tmp58 * _tmp82 + _tmp66 * _tmp83;
    _res_D_a(0, 3) = 0;
    _res_D_a(0, 4) = 0;
    _res_D_a(0, 5) = 0;
    _res_D_a(1, 0) = -_tmp49 * _tmp58 + _tmp50 * _tmp57 + _tmp65 * _tmp73 - _tmp66 * _tmp72;
    _res_D_a(1, 1) = _tmp50 * _tmp77 - _tmp58 * _tmp75 - _tmp66 * _tmp80 + _tmp73 * _tmp78;
    _res_D_a(1, 2) = -_tmp14 * _tmp84 + _tmp50 * _tmp82 - _tmp58 * _tmp81 + _tmp73 * _tmp83;
    _res_D_a(1, 3) = 0;
    _res_D_a(1, 4) = 0;
    _res_D_a(1, 5) = 0;
    _res_D_a(2, 0) = -_tmp49 * _tmp66 - _tmp50 * _tmp65 + _tmp57 * _tmp73 + _tmp58 * _tmp72;
    _res_D_a(2, 1) = -_tmp50 * _tmp78 + _tmp58 * _tmp80 - _tmp66 * _tmp75 + _tmp73 * _tmp77;
    _res_D_a(2, 2) = -_tmp50 * _tmp83 - _tmp66 * _tmp81 + _tmp73 * _tmp82 + _tmp84 * _tmp9;
    _res_D_a(2, 3) = 0;
    _res_D_a(2, 4) = 0;
    _res_D_a(2, 5) = 0;
    _res_D_a(3, 0) = _b[5] * _tmp32 + _b[6] * (_tmp26 + _tmp85);
    _res_D_a(3, 1) = _b[4] * (_tmp41 + _tmp91) + _b[6] * (_tmp87 + _tmp90);
    _res_D_a(3, 2) = _b[4] * _tmp28 + _b[5] * (_tmp93 + _tmp95);
    _res_D_a(3, 3) = 1;
    _res_D_a(3, 4) = 0;
    _res_D_a(3, 5) = 0;
    _res_D_a(4, 0) = _b[5] * _tmp39 + _b[6] * (_tmp20 + _tmp33 + _tmp89 + _tmp92);
    _res_D_a(4, 1) = _b[4] * (_tmp36 + _tmp96) + _b[6] * _tmp35;
    _res_D_a(4, 2) = _b[4] * (_tmp22 + _tmp86 + _tmp88 + _tmp94) + _b[5] * (_tmp27 + _tmp85);
    _res_D_a(4, 3) = 0;
    _res_D_a(4, 4) = 1;
    _res_D_a(4, 5) = 0;
    _res_D_a(5, 0) = _b[5] * (_tmp90 + _tmp95) + _b[6] * (_tmp37 + _tmp96);
    _res_D_a(5, 1) = _b[4] * (_tmp87 + _tmp93) + _b[6] * _tmp42;
    _res_D_a(5, 2) = _b[4] * _tmp40 + _b[5] * (_tmp29 + _tmp91);
    _res_D_a(5, 3) = 0;
    _res_D_a(5, 4) = 0;
    _res_D_a(5, 5) = 1;
  }
