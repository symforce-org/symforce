...
sym::Pose3<Scalar> ComposePose3WithJacobian0(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp20 = 2 * _a[2];
  const Scalar _tmp21 = _a[0] * _tmp20;
  const Scalar _tmp22 = 2 * _a[1];
  ...
  const Scalar _tmp34 = _a[2] * _tmp22;
  const Scalar _tmp35 = 2 * _a[0] * _a[3];
  const Scalar _tmp36 = -_tmp35;
  const Scalar _tmp37 = _tmp34 + _tmp36;
  const Scalar _tmp38 = std::pow(_a[0], Scalar(2));
  ...
  const Scalar _tmp89 = -_tmp21;
  const Scalar _tmp90 = -_tmp29;
  ...
  const Scalar _tmp96 = _tmp31 + _tmp81;
  ...
  _res[2] = _tmp14;
  _res[3] = _tmp19;
  _res[4] = _a[4] + _b[4] * (_tmp30 + _tmp32 + 1) + _b[5] * _tmp28 + _b[6] * _tmp24;
  _res[5] = _a[5] + _b[4] * _tmp33 + _b[5] * (_tmp30 + _tmp39) + _b[6] * _tmp37;
  _res[6] = _a[6] + _b[4] * _tmp41 + _b[5] * _tmp42 + _b[6] * (_tmp32 + _tmp39);
  ...
  if (res_D_a != nullptr) {
    ...
    _res_D_a(3, 0) = _b[5] * _tmp24 + _b[6] * (_tmp26 + _tmp74);
    _res_D_a(4, 0) = _b[5] * _tmp37 + _b[6] * (_tmp77 + _tmp79);
    _res_D_a(5, 0) = _b[5] * (_tmp29 + _tmp75 + _tmp78 + _tmp81) + _b[6] * (_tmp36 + _tmp80);
    ...
    _res_D_a(3, 1) = _b[4] * (_tmp40 + _tmp89) + _b[6] * (_tmp79 + _tmp91);
    _res_D_a(4, 1) = _b[4] * (_tmp35 + _tmp80) + _b[6] * _tmp33;
    _res_D_a(5, 1) = _b[4] * (_tmp31 + _tmp38 + _tmp76 + _tmp90) + _b[6] * _tmp41;
    ...
    _res_D_a(3, 2) = _b[4] * _tmp28 + _b[5] * (_tmp77 + _tmp96);
    _res_D_a(4, 2) = _b[4] * (_tmp91 + _tmp96) + _b[5] * (_tmp27 + _tmp74);
    _res_D_a(5, 2) = _b[4] * _tmp42 + _b[5] * (_tmp23 + _tmp89);
    _res_D_a(0, 3) = 0;
    _res_D_a(1, 3) = 0;
    _res_D_a(2, 3) = 0;
    _res_D_a(3, 3) = 1;
