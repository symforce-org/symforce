...
sym::Pose3<Scalar> ComposePose3WithJacobian0(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp74 = _tmp67 + _tmp68 - _tmp69 + _tmp70;
  const Scalar _tmp75 = -_tmp61;
  const Scalar _tmp76 = _tmp59 + _tmp64 + _tmp75;
  const Scalar _tmp77 = -_tmp51;
  const Scalar _tmp78 = 2 * _tmp52 + 2 * _tmp56 + 2 * _tmp77;
  const Scalar _tmp79 = -_tmp45;
  const Scalar _tmp80 = _tmp44 + _tmp46 + _tmp47 + _tmp79;
  const Scalar _tmp81 = _tmp60 + _tmp62 + _tmp63 + _tmp75;
  const Scalar _tmp82 = -_tmp67 + _tmp68 + _tmp71;
  const Scalar _tmp83 = _tmp43 + _tmp48 + _tmp79;
  const Scalar _tmp84 = _tmp53 + _tmp54 + _tmp55 + _tmp77;
  const Scalar _tmp85 = -_tmp29;
  ...
  if (res_D_a != nullptr) {
    ...
    _res_D_a(0, 1) = -_tmp4 * _tmp78 + _tmp50 * _tmp74 - _tmp58 * _tmp76 + _tmp73 * _tmp80;
    _res_D_a(0, 2) = _tmp50 * _tmp81 - _tmp58 * _tmp82 - _tmp66 * _tmp83 + _tmp73 * _tmp84;
    _res_D_a(0, 3) = 0;
    _res_D_a(0, 4) = 0;
    _res_D_a(0, 5) = 0;
    _res_D_a(1, 0) = _tmp49 * _tmp73 - _tmp50 * _tmp72 + _tmp57 * _tmp66 - _tmp58 * _tmp65;
    _res_D_a(1, 1) = -_tmp50 * _tmp80 + _tmp66 * _tmp76 + _tmp73 * _tmp74 - _tmp78 * _tmp9;
    _res_D_a(1, 2) = -_tmp50 * _tmp84 - _tmp58 * _tmp83 + _tmp66 * _tmp82 + _tmp73 * _tmp81;
    _res_D_a(1, 3) = 0;
    _res_D_a(1, 4) = 0;
    _res_D_a(1, 5) = 0;
    _res_D_a(2, 0) = -_tmp49 * _tmp66 - _tmp50 * _tmp65 + _tmp57 * _tmp73 + _tmp58 * _tmp72;
    _res_D_a(2, 1) = -_tmp14 * _tmp78 + _tmp58 * _tmp80 - _tmp66 * _tmp74 + _tmp73 * _tmp76;
    _res_D_a(2, 2) = -_tmp50 * _tmp83 + _tmp58 * _tmp84 - _tmp66 * _tmp81 + _tmp73 * _tmp82;
    _res_D_a(2, 3) = 0;
    _res_D_a(2, 4) = 0;
    _res_D_a(2, 5) = 0;
    _res_D_a(3, 0) = _b[5] * _tmp28 + _b[6] * (_tmp30 + _tmp85);
    _res_D_a(3, 1) = _b[4] * (_tmp41 + _tmp91) + _b[6] * (_tmp87 + _tmp90);
    _res_D_a(3, 2) = _b[4] * _tmp32 + _b[5] * (_tmp93 + _tmp95);
    _res_D_a(3, 3) = 1;
    _res_D_a(3, 4) = 0;
    _res_D_a(3, 5) = 0;
    _res_D_a(4, 0) = _b[5] * _tmp38 + _b[6] * (_tmp87 + _tmp93);
    _res_D_a(4, 1) = _b[4] * (_tmp36 + _tmp96) + _b[6] * _tmp39;
    _res_D_a(4, 2) = _b[4] * (_tmp90 + _tmp95) + _b[5] * (_tmp31 + _tmp85);
    _res_D_a(4, 3) = 0;
    _res_D_a(4, 4) = 1;
    _res_D_a(4, 5) = 0;
    _res_D_a(5, 0) = _b[5] * (_tmp20 + _tmp86 + _tmp88 + _tmp94) + _b[6] * (_tmp37 + _tmp96);
    _res_D_a(5, 1) = _b[4] * (_tmp22 + _tmp33 + _tmp89 + _tmp92) + _b[6] * _tmp42;
