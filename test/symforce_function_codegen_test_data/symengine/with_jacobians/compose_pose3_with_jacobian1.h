...
sym::Pose3<Scalar> ComposePose3WithJacobian1(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp65 = _tmp50 * _tmp58;
  const Scalar _tmp66 = -_tmp40 - _tmp41 - _tmp42 + _tmp43;
  const Scalar _tmp67 = _tmp45 * _tmp57;
  const Scalar _tmp68 = _tmp51 * _tmp59;
  const Scalar _tmp69 = 2 * _tmp66;
  const Scalar _tmp70 = _tmp46 + _tmp47 - _tmp48 + _tmp49;
  const Scalar _tmp71 = -_tmp14 * _tmp69;
  const Scalar _tmp72 = _tmp69 * _tmp9;
  ...
  if (res_D_b != nullptr) {
    ...
    _res_D_b(0, 1) = -_tmp51 * _tmp64 + _tmp60 * _tmp66 + _tmp63 - _tmp65;
    _res_D_b(0, 2) = -_tmp4 * _tmp69 + _tmp60 * _tmp70 + _tmp67 - _tmp68;
    _res_D_b(0, 3) = 0;
    _res_D_b(0, 4) = 0;
    _res_D_b(0, 5) = 0;
    _res_D_b(1, 0) = _tmp44 * _tmp60 - _tmp51 * _tmp57 - _tmp63 + _tmp65;
    _res_D_b(1, 1) = _tmp52 + _tmp58 * _tmp64 + _tmp61 + _tmp71;
    _res_D_b(1, 2) = -_tmp45 * _tmp70 + _tmp57 * _tmp60 - _tmp72 + _tmp73;
    _res_D_b(1, 3) = 0;
    _res_D_b(1, 4) = 0;
    _res_D_b(1, 5) = 0;
    _res_D_b(2, 0) = -_tmp44 * _tmp58 + _tmp50 * _tmp60 - _tmp67 + _tmp68;
    _res_D_b(2, 1) = -_tmp45 * _tmp50 + _tmp60 * _tmp64 + _tmp72 - _tmp73;
    _res_D_b(2, 2) = _tmp51 * _tmp70 + _tmp62 + _tmp71;
    _res_D_b(2, 3) = 0;
    _res_D_b(2, 4) = 0;
    _res_D_b(2, 5) = 0;
    _res_D_b(3, 0) = 0;
