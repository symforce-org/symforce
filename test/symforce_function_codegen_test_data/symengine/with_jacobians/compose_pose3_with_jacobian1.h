...
sym::Pose3<Scalar> ComposePose3WithJacobian1(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp20 = -2 * std::pow(_a[1], Scalar(2));
  const Scalar _tmp21 = 1 - 2 * std::pow(_a[2], Scalar(2));
  const Scalar _tmp22 = _tmp20 + _tmp21;
  const Scalar _tmp23 = 2 * _a[0];
  const Scalar _tmp24 = _a[1] * _tmp23;
  const Scalar _tmp25 = 2 * _a[2];
  const Scalar _tmp26 = _a[3] * _tmp25;
  const Scalar _tmp27 = _tmp24 - _tmp26;
  const Scalar _tmp28 = 2 * _a[1] * _a[3];
  const Scalar _tmp29 = _a[2] * _tmp23;
  const Scalar _tmp30 = _tmp28 + _tmp29;
  const Scalar _tmp31 = -2 * std::pow(_a[0], Scalar(2));
  const Scalar _tmp32 = _tmp21 + _tmp31;
  const Scalar _tmp33 = _tmp24 + _tmp26;
  const Scalar _tmp34 = _a[3] * _tmp23;
  const Scalar _tmp35 = _a[1] * _tmp25;
  const Scalar _tmp36 = -_tmp34 + _tmp35;
  const Scalar _tmp37 = _tmp20 + _tmp31 + 1;
  ...
  const Scalar _tmp64 = _tmp53 + _tmp54 + _tmp55 - _tmp56;
  const Scalar _tmp65 = 2 * _tmp59;
  const Scalar _tmp66 = _tmp14 * _tmp65;
  const Scalar _tmp67 = _tmp47 - _tmp48 - _tmp49 - _tmp50;
  const Scalar _tmp68 = _tmp65 * _tmp9;
  const Scalar _tmp69 = _tmp52 * _tmp57;
  const Scalar _tmp70 = _tmp40 - _tmp41 + _tmp42 + _tmp43;
  const Scalar _tmp71 = -_tmp52 * _tmp67;
  const Scalar _tmp72 = _tmp4 * _tmp65;
  const Scalar _tmp73 = _tmp45 * _tmp67;
  ...
  _res[2] = _tmp14;
  _res[3] = _tmp19;
  _res[4] = _a[4] + _b[4] * _tmp22 + _b[5] * _tmp27 + _b[6] * _tmp30;
  _res[5] = _a[5] + _b[4] * _tmp33 + _b[5] * _tmp32 + _b[6] * _tmp36;
  _res[6] = _a[6] + _b[4] * _tmp39 + _b[5] * _tmp38 + _b[6] * _tmp37;

  if (res_D_b != nullptr) {
    Eigen::Matrix<Scalar, 6, 6>& _res_D_b = (*res_D_b);

    _res_D_b(0, 0) = _tmp46 + _tmp51 * _tmp52 + _tmp62;
    _res_D_b(0, 1) = -_tmp45 * _tmp64 + _tmp60 * _tmp67 - _tmp63 + _tmp66;
    _res_D_b(0, 2) = -_tmp58 * _tmp67 + _tmp60 * _tmp70 - _tmp68 + _tmp69;
    _res_D_b(0, 3) = 0;
    _res_D_b(0, 4) = 0;
    _res_D_b(0, 5) = 0;
    _res_D_b(1, 0) = -_tmp45 * _tmp57 + _tmp51 * _tmp60 + _tmp63 - _tmp66;
    _res_D_b(1, 1) = _tmp46 + _tmp58 * _tmp64 + _tmp61 + _tmp71;
    _res_D_b(1, 2) = -_tmp52 * _tmp70 + _tmp57 * _tmp60 + _tmp72 - _tmp73;
    _res_D_b(1, 3) = 0;
    _res_D_b(1, 4) = 0;
    _res_D_b(1, 5) = 0;
    _res_D_b(2, 0) = _tmp44 * _tmp60 - _tmp51 * _tmp58 + _tmp68 - _tmp69;
    _res_D_b(2, 1) = -_tmp44 * _tmp52 + _tmp60 * _tmp64 - _tmp72 + _tmp73;
    _res_D_b(2, 2) = _tmp45 * _tmp70 + _tmp62 + _tmp71;
    _res_D_b(2, 3) = 0;
    _res_D_b(2, 4) = 0;
    _res_D_b(2, 5) = 0;
    _res_D_b(3, 0) = 0;
