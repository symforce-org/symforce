...
void CodegenExplicitTemplateInstantiationTest(
  ...
  if (values_vec_out != nullptr) {
    std::array<codegen_explicit_template_instantiation_test::values_vec_t, 3>& _values_vec_out =
        (*values_vec_out);
    ...
    _values_vec_out[0].rot_vec[0].data[3] = -std::pow(values_vec[0].rot_vec[0].data[0], Scalar(2)) -
    ...
    _values_vec_out[0].rot_vec[1].data[3] = -std::pow(values_vec[0].rot_vec[1].data[0], Scalar(2)) -
    ...
    _values_vec_out[0].rot_vec[2].data[3] = -std::pow(values_vec[0].rot_vec[2].data[0], Scalar(2)) -
    ...
    _values_vec_out[1].rot_vec[0].data[3] = -std::pow(values_vec[1].rot_vec[0].data[0], Scalar(2)) -
    ...
    _values_vec_out[1].rot_vec[1].data[3] = -std::pow(values_vec[1].rot_vec[1].data[0], Scalar(2)) -
    ...
    _values_vec_out[1].rot_vec[2].data[3] = -std::pow(values_vec[1].rot_vec[2].data[0], Scalar(2)) -
    ...
    _values_vec_out[2].rot_vec[0].data[3] = -std::pow(values_vec[2].rot_vec[0].data[0], Scalar(2)) -
    ...
    _values_vec_out[2].rot_vec[1].data[3] = -std::pow(values_vec[2].rot_vec[1].data[0], Scalar(2)) -
    ...
    _values_vec_out[2].rot_vec[2].data[3] = -std::pow(values_vec[2].rot_vec[2].data[0], Scalar(2)) -
  ...
  if (values_vec_2D_out != nullptr) {
    std::array<std::array<codegen_explicit_template_instantiation_test::values_vec_t, 1>, 2>&
        _values_vec_2D_out = (*values_vec_2D_out);
    ...
    _values_vec_2D_out[0][0].rot.data[3] = -std::pow(values_vec_2D[0][0].rot.data[0], Scalar(2)) -
    ...
    _values_vec_2D_out[0][0].rot_vec[0].data[0] = _tmp41 * values_vec_2D[0][0].rot_vec[0].data[0];
    _values_vec_2D_out[0][0].rot_vec[0].data[1] = _tmp41 * values_vec_2D[0][0].rot_vec[0].data[1];
    _values_vec_2D_out[0][0].rot_vec[0].data[2] = _tmp41 * values_vec_2D[0][0].rot_vec[0].data[2];
    ...
    _values_vec_2D_out[0][0].rot_vec[1].data[0] = _tmp42 * values_vec_2D[0][0].rot_vec[1].data[0];
    _values_vec_2D_out[0][0].rot_vec[1].data[1] = _tmp42 * values_vec_2D[0][0].rot_vec[1].data[1];
    _values_vec_2D_out[0][0].rot_vec[1].data[2] = _tmp42 * values_vec_2D[0][0].rot_vec[1].data[2];
    ...
    _values_vec_2D_out[0][0].rot_vec[2].data[0] = _tmp43 * values_vec_2D[0][0].rot_vec[2].data[0];
    _values_vec_2D_out[0][0].rot_vec[2].data[1] = _tmp43 * values_vec_2D[0][0].rot_vec[2].data[1];
    _values_vec_2D_out[0][0].rot_vec[2].data[2] = _tmp43 * values_vec_2D[0][0].rot_vec[2].data[2];
    ...
    _values_vec_2D_out[1][0].rot.data[3] = -std::pow(values_vec_2D[1][0].rot.data[0], Scalar(2)) -
    ...
    _values_vec_2D_out[1][0].rot_vec[0].data[0] = _tmp54 * values_vec_2D[1][0].rot_vec[0].data[0];
    _values_vec_2D_out[1][0].rot_vec[0].data[1] = _tmp54 * values_vec_2D[1][0].rot_vec[0].data[1];
    _values_vec_2D_out[1][0].rot_vec[0].data[2] = _tmp54 * values_vec_2D[1][0].rot_vec[0].data[2];
    ...
    _values_vec_2D_out[1][0].rot_vec[1].data[0] = _tmp55 * values_vec_2D[1][0].rot_vec[1].data[0];
    _values_vec_2D_out[1][0].rot_vec[1].data[1] = _tmp55 * values_vec_2D[1][0].rot_vec[1].data[1];
    _values_vec_2D_out[1][0].rot_vec[1].data[2] = _tmp55 * values_vec_2D[1][0].rot_vec[1].data[2];
    ...
    _values_vec_2D_out[1][0].rot_vec[2].data[0] = _tmp56 * values_vec_2D[1][0].rot_vec[2].data[0];
    _values_vec_2D_out[1][0].rot_vec[2].data[1] = _tmp56 * values_vec_2D[1][0].rot_vec[2].data[1];
    _values_vec_2D_out[1][0].rot_vec[2].data[2] = _tmp56 * values_vec_2D[1][0].rot_vec[2].data[2];
