    ...
    public:
        ...
        uint32_t show_field(std::ostream& _stream, const uint32_t _field_indices[], uint32_t _num_fields, const lcm::FormatSettings &_settings) const
        {
            ...
            switch (_field_indices[0]) {
                ...
                return ret == 0 ? ret : ret + 1;
                case 6:
                ret = lcm::show_field(_stream, _field_indices + 1, _num_fields - 1, values_vec, _settings);
                return ret == 0 ? ret : ret + 1;
                case 7:
                ret = lcm::show_field(_stream, _field_indices + 1, _num_fields - 1, values_vec_2D, _settings);
                return ret == 0 ? ret : ret + 1;
                case 8:
                ret = lcm::show_field(_stream, _field_indices + 1, _num_fields - 1, constants, _settings);
                return ret == 0 ? ret : ret + 1;
                case 9:
                ret = lcm::show_field(_stream, _field_indices + 1, _num_fields - 1, big_matrix, _settings);
                return ret == 0 ? ret : ret + 1;
                case 10:
                ret = lcm::show_field(_stream, _field_indices + 1, _num_fields - 1, small_matrix, _settings);
                return ret == 0 ? ret : ret + 1;
                case 11:
                ret = lcm::show_field(_stream, _field_indices + 1, _num_fields - 1, states, _settings);
                return ret == 0 ? ret : ret + 1;
                default:
                return 1;
            }
