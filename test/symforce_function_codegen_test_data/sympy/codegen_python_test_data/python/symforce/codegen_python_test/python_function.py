...
def python_function(
    ...
    # type: (float, float, sym.Rot3, T.Sequence[sym.Rot3], T.Sequence[float], T.Sequence[T.Sequence[sym.Rot3]], T.Sequence[T.Any], T.Sequence[T.Sequence[T.Any]], T.Any, sym.util.MatrixType, T.Any) -> T.Tuple[float, float, T.List[float], T.List[float], T.List[float]]
    """
    ...
    # Input arrays
    _rot = rot.data
    big_matrix = sym.util.check_matrix_size_and_numpify(big_matrix, "big_matrix", (5, 5))
