...
void BarronResidual(const Eigen::Matrix<Scalar, 5, 1>& x, const Eigen::Matrix<Scalar, 5, 1>& y,
  ...
  const Scalar _tmp4 = _tmp3 * (x(0, 0) - y(0, 0) * x(0, 0) - y(0, 0)) + 1;
  const Scalar _tmp5 = 1.0 / (_tmp1);
  const Scalar _tmp6 = -_tmp5 + 2;
  ...
  const Scalar _tmp16 = _tmp3 * (x(1, 0) - y(1, 0) * x(1, 0) - y(1, 0)) + 1;
  ...
  const Scalar _tmp21 = _tmp3 * (x(2, 0) - y(2, 0) * x(2, 0) - y(2, 0)) + 1;
  ...
  const Scalar _tmp26 = _tmp3 * (x(3, 0) - y(3, 0) * x(3, 0) - y(3, 0)) + 1;
  ...
  const Scalar _tmp31 = _tmp3 * (x(4, 0) - y(4, 0) * x(4, 0) - y(4, 0)) + 1;
  ...
  const Scalar _tmp47 = (_tmp8 * _tmp8) / (_tmp10 * _tmp10);
  ...
  if (hessian != nullptr) {
    ...
    _hessian(0, 0) =
        (_tmp36 * _tmp36) * std::pow(_tmp4, _tmp10) * _tmp47 / (_tmp13 * (_tmp4 * _tmp4));
    _hessian(0, 1) = 0;
    _hessian(0, 2) = 0;
    _hessian(0, 3) = 0;
    _hessian(0, 4) = 0;
    _hessian(1, 0) = 0;
    _hessian(1, 1) =
        std::pow(_tmp16, _tmp10) * (_tmp39 * _tmp39) * _tmp47 / ((_tmp16 * _tmp16) * _tmp18);
    _hessian(1, 2) = 0;
    _hessian(1, 3) = 0;
    _hessian(1, 4) = 0;
    _hessian(2, 0) = 0;
    _hessian(2, 1) = 0;
    _hessian(2, 2) =
        std::pow(_tmp21, _tmp10) * (_tmp41 * _tmp41) * _tmp47 / ((_tmp21 * _tmp21) * _tmp23);
    _hessian(2, 3) = 0;
    _hessian(2, 4) = 0;
    _hessian(3, 0) = 0;
    _hessian(3, 1) = 0;
    _hessian(3, 2) = 0;
    _hessian(3, 3) =
        std::pow(_tmp26, _tmp10) * (_tmp43 * _tmp43) * _tmp47 / ((_tmp26 * _tmp26) * _tmp28);
    _hessian(3, 4) = 0;
    _hessian(4, 0) = 0;
    _hessian(4, 1) = 0;
    _hessian(4, 2) = 0;
    _hessian(4, 3) = 0;
    _hessian(4, 4) =
        std::pow(_tmp31, _tmp10) * (_tmp45 * _tmp45) * _tmp47 / ((_tmp31 * _tmp31) * _tmp33);
  }
