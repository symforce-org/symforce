...
Eigen::Matrix<Scalar, 6, 6> ComposePose3Jacobian0(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp47 = _tmp1 + _tmp3 + _tmp4 - _tmp6;
  const Scalar _tmp48 = -_tmp26 - _tmp27 - _tmp28 + _tmp29;
  const Scalar _tmp49 = -_tmp33 - _tmp35 + _tmp37 - _tmp39;
  const Scalar _tmp50 = -_tmp15 - _tmp16 + _tmp17 - _tmp18;
  const Scalar _tmp51 = -_tmp42;
  const Scalar _tmp52 = 2 * _a[1];
  const Scalar _tmp53 = _a[3] * _tmp52;
  const Scalar _tmp54 = 2 * _a[2];
  const Scalar _tmp55 = _a[0] * _tmp54;
  const Scalar _tmp56 = _tmp53 + _tmp55;
  const Scalar _tmp57 = _a[3] * _tmp54;
  const Scalar _tmp58 = _a[0] * _tmp52;
  const Scalar _tmp59 = _tmp57 - _tmp58;
  const Scalar _tmp60 = std::pow(_a[0], Scalar(2));
  const Scalar _tmp61 = std::pow(_a[1], Scalar(2));
  const Scalar _tmp62 = -_tmp61;
  const Scalar _tmp63 = std::pow(_a[3], Scalar(2));
  const Scalar _tmp64 = std::pow(_a[2], Scalar(2));
  const Scalar _tmp65 = _tmp63 - _tmp64;
  const Scalar _tmp66 = _tmp60 + _tmp62 + _tmp65;
  const Scalar _tmp67 = 2 * _a[0] * _a[3];
  const Scalar _tmp68 = _a[2] * _tmp52;
  const Scalar _tmp69 = _tmp67 - _tmp68;
  const Scalar _tmp70 = -_tmp60;
  const Scalar _tmp71 = _tmp61 + _tmp65 + _tmp70;
  const Scalar _tmp72 = _tmp57 + _tmp58;
  const Scalar _tmp73 = _tmp67 + _tmp68;
  const Scalar _tmp74 = _tmp62 + _tmp63 + _tmp64 + _tmp70;
  const Scalar _tmp75 = _tmp53 - _tmp55;
  ...
  _res_D_a(0, 2) = _tmp14 * _tmp49 + _tmp25 * _tmp47 + _tmp42 * _tmp50 + _tmp48 * _tmp9;
  _res_D_a(0, 3) = 0;
  _res_D_a(0, 4) = 0;
  _res_D_a(0, 5) = 0;
  _res_D_a(1, 0) = _tmp13 * _tmp31 + _tmp20 * _tmp25 + _tmp41 * _tmp9 + _tmp51 * _tmp8;
  _res_D_a(1, 1) = _tmp13 * _tmp46 + _tmp25 * _tmp45 + _tmp43 * _tmp9 + _tmp44 * _tmp51;
  _res_D_a(1, 2) = _tmp13 * _tmp47 + _tmp25 * _tmp49 + _tmp48 * _tmp51 + _tmp50 * _tmp9;
  _res_D_a(1, 3) = 0;
  _res_D_a(1, 4) = 0;
  _res_D_a(1, 5) = 0;
  _res_D_a(2, 0) = _tmp14 * _tmp41 + _tmp20 * _tmp51 + _tmp24 * _tmp8 + _tmp31 * _tmp9;
  _res_D_a(2, 1) = _tmp14 * _tmp43 + _tmp24 * _tmp44 + _tmp45 * _tmp51 + _tmp46 * _tmp9;
  _res_D_a(2, 2) = _tmp14 * _tmp50 + _tmp24 * _tmp48 + _tmp47 * _tmp9 + _tmp49 * _tmp51;
  _res_D_a(2, 3) = 0;
  _res_D_a(2, 4) = 0;
  _res_D_a(2, 5) = 0;
  _res_D_a(3, 0) = _b[5] * _tmp56 + _b[6] * _tmp59;
  _res_D_a(3, 1) = -_b[4] * _tmp56 + _b[6] * _tmp66;
  _res_D_a(3, 2) = -_b[4] * _tmp59 - _b[5] * _tmp66;
  _res_D_a(3, 3) = 1;
  _res_D_a(3, 4) = 0;
  _res_D_a(3, 5) = 0;
  _res_D_a(4, 0) = -_b[5] * _tmp69 - _b[6] * _tmp71;
  _res_D_a(4, 1) = _b[4] * _tmp69 + _b[6] * _tmp72;
  _res_D_a(4, 2) = _b[4] * _tmp71 - _b[5] * _tmp72;
  _res_D_a(4, 3) = 0;
  _res_D_a(4, 4) = 1;
  _res_D_a(4, 5) = 0;
  _res_D_a(5, 0) = _b[5] * _tmp74 - _b[6] * _tmp73;
  _res_D_a(5, 1) = -_b[4] * _tmp74 - _b[6] * _tmp75;
  _res_D_a(5, 2) = _b[4] * _tmp73 + _b[5] * _tmp75;
  _res_D_a(5, 3) = 0;
  _res_D_a(5, 4) = 0;
  _res_D_a(5, 5) = 1;
