...
Eigen::Matrix<Scalar, 6, 6> ComposePose3Jacobian1(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp35 = _a[1] * _tmp33;
  const Scalar _tmp36 = 2 * _a[0];
  ...
  _res_D_b(0, 1) = _tmp10 * _tmp26 + _tmp11 * _tmp24 + _tmp17 * _tmp5 + _tmp18 * _tmp28;
  _res_D_b(0, 2) = _tmp10 * _tmp28 + _tmp12 * _tmp5 + _tmp17 * _tmp24 + _tmp18 * _tmp25;
  _res_D_b(0, 3) = 0;
  _res_D_b(0, 4) = 0;
  _res_D_b(0, 5) = 0;
  _res_D_b(1, 0) = _tmp12 * _tmp24 + _tmp17 * _tmp29 + _tmp18 * _tmp4 + _tmp26 * _tmp9;
  _res_D_b(1, 1) = _tmp11 * _tmp9 + _tmp27 + _tmp30;
  _res_D_b(1, 2) = _tmp12 * _tmp18 + _tmp17 * _tmp9 + _tmp24 * _tmp28 + _tmp25 * _tmp29;
  _res_D_b(1, 3) = 0;
  _res_D_b(1, 4) = 0;
  _res_D_b(1, 5) = 0;
  _res_D_b(2, 0) = _tmp10 * _tmp4 + _tmp12 * _tmp29 + _tmp17 * _tmp23 + _tmp18 * _tmp26;
  _res_D_b(2, 1) = _tmp10 * _tmp17 + _tmp11 * _tmp18 + _tmp23 * _tmp28 + _tmp26 * _tmp29;
  ...
  _res_D_b(3, 5) = _a[2] * _tmp36 + _tmp35;
  _res_D_b(4, 0) = 0;
  _res_D_b(4, 1) = 0;
  _res_D_b(4, 2) = 0;
  _res_D_b(4, 3) = _a[1] * _tmp36 + _tmp34;
  _res_D_b(4, 4) = -_tmp32 - _tmp37;
  _res_D_b(4, 5) = 2 * _a[1] * _a[2] - _tmp38;
  _res_D_b(5, 0) = 0;
  _res_D_b(5, 1) = 0;
  _res_D_b(5, 2) = 0;
  _res_D_b(5, 3) = 2 * _a[0] * _a[2] - _tmp35;
