...
void ComposePose3Jacobians(const sym::Pose3<Scalar>& a, const sym::Pose3<Scalar>& b,
  ...
  const Scalar _tmp57 = std::pow(_a[2], Scalar(2));
  const Scalar _tmp58 = -_tmp57;
  const Scalar _tmp59 = std::pow(_a[3], Scalar(2));
  const Scalar _tmp60 = std::pow(_a[0], Scalar(2));
  const Scalar _tmp61 = _tmp59 - _tmp60;
  const Scalar _tmp62 = _tmp56 + _tmp58 + _tmp61;
  const Scalar _tmp63 = _tmp52 + _tmp53;
  const Scalar _tmp64 = -_tmp56;
  const Scalar _tmp65 = _tmp57 + _tmp61 + _tmp64;
  const Scalar _tmp66 = -_tmp1 + _tmp3 + _tmp7;
  const Scalar _tmp67 = _tmp33 - _tmp35 - _tmp40;
  const Scalar _tmp68 = _tmp26 - _tmp27 - _tmp30;
  const Scalar _tmp69 = _tmp15 - _tmp16 - _tmp19;
  const Scalar _tmp70 = _tmp58 + _tmp59 + _tmp60 + _tmp64;
  const Scalar _tmp71 = _tmp49 + _tmp50;
  const Scalar _tmp72 = _tmp45 - _tmp47;
  const Scalar _tmp73 = -_tmp72;
  const Scalar _tmp74 = _tmp1 + _tmp3;
  const Scalar _tmp75 = _tmp4 - _tmp6 + _tmp74;
  const Scalar _tmp76 = _tmp26 + _tmp27;
  const Scalar _tmp77 = -_tmp28 + _tmp29 - _tmp76;
  const Scalar _tmp78 = _tmp33 + _tmp35;
  const Scalar _tmp79 = _tmp37 - _tmp39 - _tmp78;
  const Scalar _tmp80 = _tmp15 + _tmp16;
  const Scalar _tmp81 = _tmp17 - _tmp18 - _tmp80;
  const Scalar _tmp82 = -_tmp51;
  const Scalar _tmp83 = _tmp37 - _tmp39 + _tmp78;
  const Scalar _tmp84 = _tmp17 - _tmp18 + _tmp80;
  const Scalar _tmp85 = -_tmp84;
  const Scalar _tmp86 = _tmp14 * _tmp85;
  const Scalar _tmp87 = (Scalar(1) / Scalar(2)) * _a[3] * _b[3] - _tmp6 - _tmp74;
  const Scalar _tmp88 = _tmp87 * _tmp9;
  const Scalar _tmp89 = -_tmp28 + _tmp29 + _tmp76;
  ...
  const Scalar _tmp94 = 2 * _tmp56;
  const Scalar _tmp95 = 2 * _tmp57 - 1;
  const Scalar _tmp96 = 2 * _tmp60;
  ...
  if (res_D_a != nullptr) {
    ...
    _res_D_a(4, 0) = _b[5] * _tmp55 - _b[6] * _tmp62;
    _res_D_a(5, 0) = _b[5] * _tmp65 - _b[6] * _tmp63;
    _res_D_a(0, 1) = _tmp14 * _tmp68 + _tmp25 * _tmp69 + _tmp42 * _tmp66 + _tmp67 * _tmp9;
    _res_D_a(1, 1) = _tmp13 * _tmp69 + _tmp25 * _tmp68 + _tmp43 * _tmp67 + _tmp66 * _tmp9;
    _res_D_a(2, 1) = _tmp14 * _tmp66 + _tmp24 * _tmp67 + _tmp43 * _tmp68 + _tmp69 * _tmp9;
    _res_D_a(3, 1) = -_b[4] * _tmp48 + _b[6] * _tmp70;
    _res_D_a(4, 1) = _b[4] * _tmp54 + _b[6] * _tmp71;
    _res_D_a(5, 1) = -_b[4] * _tmp65 + _b[6] * _tmp73;
    _res_D_a(0, 2) = _tmp14 * _tmp79 + _tmp25 * _tmp75 + _tmp42 * _tmp81 + _tmp77 * _tmp9;
    _res_D_a(1, 2) = _tmp13 * _tmp75 + _tmp25 * _tmp79 + _tmp43 * _tmp77 + _tmp81 * _tmp9;
    _res_D_a(2, 2) = _tmp14 * _tmp81 + _tmp24 * _tmp77 + _tmp43 * _tmp79 + _tmp75 * _tmp9;
    _res_D_a(3, 2) = _b[4] * _tmp82 - _b[5] * _tmp70;
    _res_D_a(4, 2) = _b[4] * _tmp62 - _b[5] * _tmp71;
    _res_D_a(5, 2) = _b[4] * _tmp63 + _b[5] * _tmp72;
    _res_D_a(0, 3) = 0;
    _res_D_a(1, 3) = 0;
    _res_D_a(2, 3) = 0;
    _res_D_a(3, 3) = 1;
  ...
  if (res_D_b != nullptr) {
    ...
    _res_D_b(1, 0) = _tmp13 * _tmp90 + _tmp25 * _tmp85 + _tmp43 * _tmp87 + _tmp83 * _tmp9;
    _res_D_b(2, 0) = _tmp14 * _tmp83 + _tmp24 * _tmp87 + _tmp43 * _tmp85 + _tmp9 * _tmp90;
    _res_D_b(3, 0) = 0;
    _res_D_b(4, 0) = 0;
    _res_D_b(5, 0) = 0;
    _res_D_b(0, 1) = _tmp14 * _tmp90 + _tmp25 * _tmp84 + _tmp42 * _tmp87 + _tmp9 * _tmp92;
    _res_D_b(1, 1) = _tmp13 * _tmp84 + _tmp91 + _tmp93;
    _res_D_b(2, 1) = _tmp14 * _tmp87 + _tmp24 * _tmp92 + _tmp43 * _tmp90 + _tmp84 * _tmp9;
    _res_D_b(3, 1) = 0;
    _res_D_b(4, 1) = 0;
    _res_D_b(5, 1) = 0;
    _res_D_b(0, 2) = _tmp14 * _tmp92 + _tmp25 * _tmp87 + _tmp42 * _tmp85 + _tmp89 * _tmp9;
    _res_D_b(1, 2) = _tmp13 * _tmp87 + _tmp25 * _tmp92 + _tmp43 * _tmp89 + _tmp85 * _tmp9;
