...
sym::Pose3<Scalar> ComposePose3WithJacobian0(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp68 = -_tmp38 + _tmp39 + _tmp42;
  const Scalar _tmp69 = _tmp61 - _tmp62 - _tmp65;
  const Scalar _tmp70 = _tmp55 - _tmp56 - _tmp59;
  const Scalar _tmp71 = _tmp47 - _tmp48 - _tmp51;
  const Scalar _tmp72 = _tmp38 + _tmp39 + _tmp40 - _tmp41;
  const Scalar _tmp73 = -_tmp55 - _tmp56 - _tmp57 + _tmp58;
  const Scalar _tmp74 = -_tmp61 - _tmp62 + _tmp63 - _tmp64;
  const Scalar _tmp75 = -_tmp47 - _tmp48 + _tmp49 - _tmp50;
  const Scalar _tmp76 = -_tmp67;
  const Scalar _tmp77 = -_tmp24;
  const Scalar _tmp78 = std::pow(_a[3], Scalar(2));
  const Scalar _tmp79 = -_tmp26 + _tmp78;
  const Scalar _tmp80 = _tmp33 + _tmp77 + _tmp79;
  const Scalar _tmp81 = -_tmp33;
  const Scalar _tmp82 = _tmp24 + _tmp79 + _tmp81;
  const Scalar _tmp83 = _tmp26 + _tmp77 + _tmp78 + _tmp81;
  ...
  if (res_D_a != nullptr) {
    ...
    _res_D_a(0, 1) = _tmp44 * _tmp69 + _tmp46 * _tmp70 + _tmp54 * _tmp71 + _tmp67 * _tmp68;
    _res_D_a(0, 2) = _tmp44 * _tmp73 + _tmp46 * _tmp74 + _tmp54 * _tmp72 + _tmp67 * _tmp75;
    _res_D_a(0, 3) = 0;
    _res_D_a(0, 4) = 0;
    _res_D_a(0, 5) = 0;
    _res_D_a(1, 0) = _tmp43 * _tmp76 + _tmp44 * _tmp66 + _tmp45 * _tmp60 + _tmp52 * _tmp54;
    _res_D_a(1, 1) = _tmp44 * _tmp68 + _tmp45 * _tmp71 + _tmp54 * _tmp70 + _tmp69 * _tmp76;
    _res_D_a(1, 2) = _tmp44 * _tmp75 + _tmp45 * _tmp72 + _tmp54 * _tmp74 + _tmp73 * _tmp76;
    _res_D_a(1, 3) = 0;
    _res_D_a(1, 4) = 0;
    _res_D_a(1, 5) = 0;
    _res_D_a(2, 0) = _tmp43 * _tmp53 + _tmp44 * _tmp60 + _tmp46 * _tmp66 + _tmp52 * _tmp76;
    _res_D_a(2, 1) = _tmp44 * _tmp71 + _tmp46 * _tmp68 + _tmp53 * _tmp69 + _tmp70 * _tmp76;
    _res_D_a(2, 2) = _tmp44 * _tmp72 + _tmp46 * _tmp75 + _tmp53 * _tmp73 + _tmp74 * _tmp76;
    _res_D_a(2, 3) = 0;
    _res_D_a(2, 4) = 0;
    _res_D_a(2, 5) = 0;
    _res_D_a(3, 0) = _b[5] * _tmp23 + _b[6] * _tmp19;
    _res_D_a(3, 1) = -_b[4] * _tmp23 + _b[6] * _tmp80;
    _res_D_a(3, 2) = _b[4] * _tmp20 - _b[5] * _tmp80;
    _res_D_a(3, 3) = 1;
    _res_D_a(3, 4) = 0;
    _res_D_a(3, 5) = 0;
    _res_D_a(4, 0) = _b[5] * _tmp32 - _b[6] * _tmp82;
    _res_D_a(4, 1) = _b[4] * _tmp31 + _b[6] * _tmp28;
    _res_D_a(4, 2) = _b[4] * _tmp82 - _b[5] * _tmp28;
    _res_D_a(4, 3) = 0;
    _res_D_a(4, 4) = 1;
    _res_D_a(4, 5) = 0;
    _res_D_a(5, 0) = _b[5] * _tmp83 - _b[6] * _tmp37;
    _res_D_a(5, 1) = -_b[4] * _tmp83 + _b[6] * _tmp36;
