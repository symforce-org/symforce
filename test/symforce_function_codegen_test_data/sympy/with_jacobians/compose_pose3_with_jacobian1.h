...
sym::Pose3<Scalar> ComposePose3WithJacobian1(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp18 = 2 * _a[0];
  const Scalar _tmp19 = _a[1] * _tmp18;
  const Scalar _tmp20 = -_tmp17 + _tmp19;
  const Scalar _tmp21 = _a[1] * _tmp16;
  const Scalar _tmp22 = _a[2] * _tmp18;
  ...
  const Scalar _tmp28 = _a[0] * _tmp16;
  const Scalar _tmp29 = 2 * _a[1] * _a[2];
  ...
  const Scalar _tmp42 = 2 * _tmp9;
  const Scalar _tmp43 = 2 * _tmp11;
  ...
  const Scalar _tmp57 = (Scalar(1) / Scalar(2)) * _tmp12 - Scalar(1) / Scalar(2) * _tmp13 -
                        Scalar(1) / Scalar(2) * _tmp14 - Scalar(1) / Scalar(2) * _tmp15;
  const Scalar _tmp58 = 2 * _tmp12 - 2 * _tmp13 - 2 * _tmp14 - 2 * _tmp15;
  const Scalar _tmp59 = _tmp57 * _tmp58;
  const Scalar _tmp60 = 2 * _tmp4;
  const Scalar _tmp61 = 2 * _tmp7;
  const Scalar _tmp62 = 2 * _tmp5;
  const Scalar _tmp63 = 2 * _tmp6;
  const Scalar _tmp64 = -_tmp60 + _tmp61 - _tmp62 - _tmp63;
  const Scalar _tmp65 = (Scalar(1) / Scalar(2)) * _tmp4;
  const Scalar _tmp66 = (Scalar(1) / Scalar(2)) * _tmp7;
  const Scalar _tmp67 = (Scalar(1) / Scalar(2)) * _tmp5;
  const Scalar _tmp68 = (Scalar(1) / Scalar(2)) * _tmp6;
  const Scalar _tmp69 = -_tmp65 + _tmp66 - _tmp67 - _tmp68;
  const Scalar _tmp70 = _tmp59 + _tmp64 * _tmp69;
  ...
  const Scalar _tmp77 = _tmp60 - _tmp61 + _tmp62 + _tmp63;
  ...
  if (res_D_b != nullptr) {
    ...
    _res_D_b(0, 1) = _tmp45 * _tmp57 + _tmp50 * _tmp69 + _tmp58 * _tmp71 + _tmp64 * _tmp72;
    _res_D_b(0, 2) = _tmp45 * _tmp55 + _tmp50 * _tmp71 + _tmp57 * _tmp64 + _tmp58 * _tmp73;
    _res_D_b(0, 3) = 0;
    _res_D_b(0, 4) = 0;
    _res_D_b(0, 5) = 0;
    _res_D_b(1, 0) = _tmp40 * _tmp58 + _tmp55 * _tmp64 + _tmp57 * _tmp74 + _tmp69 * _tmp75;
    _res_D_b(1, 1) = _tmp70 + _tmp72 * _tmp75 + _tmp76;
    _res_D_b(1, 2) = _tmp55 * _tmp58 + _tmp57 * _tmp75 + _tmp64 * _tmp71 + _tmp73 * _tmp74;
    _res_D_b(1, 3) = 0;
    _res_D_b(1, 4) = 0;
    _res_D_b(1, 5) = 0;
    _res_D_b(2, 0) = _tmp40 * _tmp50 + _tmp55 * _tmp74 + _tmp57 * _tmp77 + _tmp58 * _tmp69;
    _res_D_b(2, 1) = _tmp50 * _tmp57 + _tmp58 * _tmp72 + _tmp69 * _tmp74 + _tmp71 * _tmp77;
    _res_D_b(2, 2) = _tmp56 + _tmp59 + _tmp73 * _tmp77 + _tmp76;
    _res_D_b(2, 3) = 0;
    _res_D_b(2, 4) = 0;
    _res_D_b(2, 5) = 0;
    _res_D_b(3, 0) = 0;
