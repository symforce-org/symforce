...
sym::Pose3<Scalar> ComposePose3WithJacobians(const sym::Pose3<Scalar>& a,
  ...
  const Scalar _tmp71 = -_tmp41 + _tmp42 + _tmp45;
  const Scalar _tmp72 = _tmp64 - _tmp65 - _tmp68;
  const Scalar _tmp73 = _tmp58 - _tmp59 - _tmp62;
  const Scalar _tmp74 = _tmp50 - _tmp51 - _tmp54;
  const Scalar _tmp75 = _tmp41 + _tmp42;
  const Scalar _tmp76 = _tmp43 - _tmp44 + _tmp75;
  const Scalar _tmp77 = _tmp58 + _tmp59;
  const Scalar _tmp78 = -_tmp60 + _tmp61 - _tmp77;
  const Scalar _tmp79 = _tmp64 + _tmp65;
  const Scalar _tmp80 = _tmp66 - _tmp67 - _tmp79;
  const Scalar _tmp81 = _tmp50 + _tmp51;
  const Scalar _tmp82 = _tmp52 - _tmp53 - _tmp81;
  const Scalar _tmp83 = -_tmp70;
  const Scalar _tmp84 = -_tmp24;
  const Scalar _tmp85 = std::pow(_a[3], Scalar(2));
  const Scalar _tmp86 = -_tmp26 + _tmp85;
  const Scalar _tmp87 = _tmp34 + _tmp84 + _tmp86;
  const Scalar _tmp88 = -_tmp34;
  const Scalar _tmp89 = _tmp24 + _tmp86 + _tmp88;
  const Scalar _tmp90 = _tmp26 + _tmp84 + _tmp85 + _tmp88;
  const Scalar _tmp91 = _tmp66 - _tmp67 + _tmp79;
  const Scalar _tmp92 = _tmp52 - _tmp53 + _tmp81;
  const Scalar _tmp93 = -_tmp92;
  const Scalar _tmp94 = _tmp49 * _tmp93;
  const Scalar _tmp95 = (Scalar(1) / Scalar(2)) * _a[3] * _b[3] - _tmp44 - _tmp75;
  const Scalar _tmp96 = _tmp47 * _tmp95;
  const Scalar _tmp97 = -_tmp60 + _tmp61 + _tmp77;
  ...
  if (res_D_a != nullptr) {
    ...
    _res_D_a(0, 1) = _tmp47 * _tmp72 + _tmp49 * _tmp73 + _tmp57 * _tmp74 + _tmp70 * _tmp71;
    _res_D_a(0, 2) = _tmp47 * _tmp78 + _tmp49 * _tmp80 + _tmp57 * _tmp76 + _tmp70 * _tmp82;
    _res_D_a(0, 3) = 0;
    _res_D_a(0, 4) = 0;
    _res_D_a(0, 5) = 0;
    _res_D_a(1, 0) = _tmp46 * _tmp83 + _tmp47 * _tmp69 + _tmp48 * _tmp63 + _tmp55 * _tmp57;
    _res_D_a(1, 1) = _tmp47 * _tmp71 + _tmp48 * _tmp74 + _tmp57 * _tmp73 + _tmp72 * _tmp83;
    _res_D_a(1, 2) = _tmp47 * _tmp82 + _tmp48 * _tmp76 + _tmp57 * _tmp80 + _tmp78 * _tmp83;
    _res_D_a(1, 3) = 0;
    _res_D_a(1, 4) = 0;
    _res_D_a(1, 5) = 0;
    _res_D_a(2, 0) = _tmp46 * _tmp56 + _tmp47 * _tmp63 + _tmp49 * _tmp69 + _tmp55 * _tmp83;
    _res_D_a(2, 1) = _tmp47 * _tmp74 + _tmp49 * _tmp71 + _tmp56 * _tmp72 + _tmp73 * _tmp83;
    _res_D_a(2, 2) = _tmp47 * _tmp76 + _tmp49 * _tmp82 + _tmp56 * _tmp78 + _tmp80 * _tmp83;
    _res_D_a(2, 3) = 0;
    _res_D_a(2, 4) = 0;
    _res_D_a(2, 5) = 0;
    _res_D_a(3, 0) = _b[5] * _tmp23 + _b[6] * _tmp19;
    _res_D_a(3, 1) = -_b[4] * _tmp23 + _b[6] * _tmp87;
    _res_D_a(3, 2) = _b[4] * _tmp20 - _b[5] * _tmp87;
    _res_D_a(3, 3) = 1;
    _res_D_a(3, 4) = 0;
    _res_D_a(3, 5) = 0;
    _res_D_a(4, 0) = _b[5] * _tmp33 - _b[6] * _tmp89;
    _res_D_a(4, 1) = _b[4] * _tmp32 + _b[6] * _tmp29;
    _res_D_a(4, 2) = _b[4] * _tmp89 - _b[5] * _tmp29;
    _res_D_a(4, 3) = 0;
    _res_D_a(4, 4) = 1;
    _res_D_a(4, 5) = 0;
    _res_D_a(5, 0) = _b[5] * _tmp90 - _b[6] * _tmp39;
    _res_D_a(5, 1) = -_b[4] * _tmp90 + _b[6] * _tmp38;
  ...
  if (res_D_b != nullptr) {
    ...
    _res_D_b(0, 4) = 0;
    _res_D_b(0, 5) = 0;
    _res_D_b(1, 0) = _tmp47 * _tmp91 + _tmp48 * _tmp98 + _tmp57 * _tmp93 + _tmp83 * _tmp95;
    _res_D_b(1, 1) = _tmp101 + _tmp48 * _tmp92 + _tmp99;
    _res_D_b(1, 2) = _tmp100 * _tmp57 + _tmp47 * _tmp93 + _tmp48 * _tmp95 + _tmp83 * _tmp97;
    _res_D_b(1, 3) = 0;
    _res_D_b(1, 4) = 0;
    _res_D_b(1, 5) = 0;
    _res_D_b(2, 0) = _tmp47 * _tmp98 + _tmp49 * _tmp91 + _tmp56 * _tmp95 + _tmp83 * _tmp93;
    _res_D_b(2, 1) = _tmp100 * _tmp56 + _tmp47 * _tmp92 + _tmp49 * _tmp95 + _tmp83 * _tmp98;
