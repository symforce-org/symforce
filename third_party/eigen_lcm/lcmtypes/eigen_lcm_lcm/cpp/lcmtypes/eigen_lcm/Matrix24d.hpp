// This file was hand-written, modified from the Matrix24d type, with the hash
...
class Matrix24d : public Eigen::Matrix<double, 2, 4, Eigen::DontAlign> {
 public:
  ...
  Matrix24d() : Eigen::Matrix<double, 2, 4, Eigen::DontAlign>() {
    *this = Matrix24d::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  Matrix24d(Args&&... args) : Eigen::Matrix<double, 2, 4, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Matrix24d
  template <typename OtherDerived>
  eigen_lcm::Matrix24d& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<double, 2, 4, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Matrix24d& obj) {
    os << "Matrix24d(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<double, 2, 4, Eigen::DontAlign>& operator<<(T other);
...
__lcm_buffer_size Matrix24d::encode(void* buf, __lcm_buffer_size offset,
                                    __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Matrix24d::decode(const void* buf, __lcm_buffer_size offset,
                                    __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Matrix24d::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Matrix24d::getHash() {
  return _computeHash(NULL);
}

constexpr Matrix24d::type_name_array_t* Matrix24d::getTypeNameArrayPtr() {
  return &"Matrix24d";
}

constexpr const char* Matrix24d::getTypeName() {
  return *Matrix24d::getTypeNameArrayPtr();
}

constexpr Matrix24d::package_name_array_t* Matrix24d::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Matrix24d::getPackageName() {
  return *Matrix24d::getPackageNameArrayPtr();
}

__lcm_buffer_size Matrix24d::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                           __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __double_encode_array(buf, offset + pos, maxlen - pos, this->data(), 8);
  if (tlen < 0) {
    return tlen;
  } else {
    pos += tlen;
...
__lcm_buffer_size Matrix24d::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                           __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __double_decode_array(buf, offset + pos, maxlen - pos, this->data(), 8);
  if (tlen < 0) {
    return tlen;
  } else {
    pos += tlen;
...
__lcm_buffer_size Matrix24d::_getEncodedSizeNoHash() const {
