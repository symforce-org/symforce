...
int Matrix2d::encode(void* buf, int offset, int maxlen) const {
  int pos = 0, tlen;
...
int Matrix2d::decode(const void* buf, int offset, int maxlen) {
  int pos = 0, thislen;
...
int Matrix2d::getEncodedSize() const {
...
const char* Matrix2d::getTypeName() {
  return "Matrix2d";
}

const char* Matrix2d::getPackageName() {
  return "eigen_lcm";
}

int Matrix2d::_encodeNoHash(void* buf, int offset, int maxlen) const {
  int pos = 0, tlen;
...
int Matrix2d::_decodeNoHash(const void* buf, int offset, int maxlen) {
  int pos = 0, tlen;
...
int Matrix2d::_getEncodedSizeNoHash() const {
  int enc_size = 0;
  enc_size += __double_encoded_array_size(NULL, 4);
  return enc_size;
}

constexpr uint64_t Matrix2d::_computeHash(const __lcm_hash_ptr*) {
