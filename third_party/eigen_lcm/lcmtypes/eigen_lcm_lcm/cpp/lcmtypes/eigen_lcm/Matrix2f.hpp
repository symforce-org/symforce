...
class Matrix2f : public Eigen::Matrix<float, 2, 2, Eigen::DontAlign> {
 public:
  ...
  Matrix2f() : Eigen::Matrix<float, 2, 2, Eigen::DontAlign>() {
    *this = Matrix2f::Zero();
  }
  ...
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Matrix2f& obj) {
    os << "Matrix2f(";
...
__lcm_buffer_size Matrix2f::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Matrix2f::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Matrix2f::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Matrix2f::getHash() {
  return _computeHash(NULL);
}

constexpr Matrix2f::type_name_array_t* Matrix2f::getTypeNameArrayPtr() {
  return &"Matrix2f";
}

constexpr const char* Matrix2f::getTypeName() {
  return *Matrix2f::getTypeNameArrayPtr();
}

constexpr Matrix2f::package_name_array_t* Matrix2f::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Matrix2f::getPackageName() {
  return *Matrix2f::getPackageNameArrayPtr();
}

__lcm_buffer_size Matrix2f::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Matrix2f::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Matrix2f::_getEncodedSizeNoHash() const {
