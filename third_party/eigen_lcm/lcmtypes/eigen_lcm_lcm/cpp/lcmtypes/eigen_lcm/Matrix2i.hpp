...
class Matrix2i : public Eigen::Matrix<int32_t, 2, 2, Eigen::DontAlign> {
 public:
  ...
  Matrix2i() : Eigen::Matrix<int32_t, 2, 2, Eigen::DontAlign>() {
    *this = Matrix2i::Zero();
  }
  ...
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Matrix2i& obj) {
    os << "Matrix2i(";
...
__lcm_buffer_size Matrix2i::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Matrix2i::getEncodedSize() const {
...
constexpr const char* Matrix2i::getTypeName() {
...
__lcm_buffer_size Matrix2i::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Matrix2i::_getEncodedSizeNoHash() const {
