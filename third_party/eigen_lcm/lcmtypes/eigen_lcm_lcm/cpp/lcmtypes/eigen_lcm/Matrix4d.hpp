...
class Matrix4d : public Eigen::Matrix<double, 4, 4, Eigen::DontAlign> {
 public:
  ...
  Matrix4d() : Eigen::Matrix<double, 4, 4, Eigen::DontAlign>() {
    *this = Matrix4d::Zero();
  }
  ...
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Matrix4d& obj) {
    os << "Matrix4d(";
...
__lcm_buffer_size Matrix4d::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Matrix4d::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Matrix4d::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Matrix4d::getHash() {
  return _computeHash(NULL);
}

constexpr Matrix4d::type_name_array_t* Matrix4d::getTypeNameArrayPtr() {
  return &"Matrix4d";
}

constexpr const char* Matrix4d::getTypeName() {
  return *Matrix4d::getTypeNameArrayPtr();
}

constexpr Matrix4d::package_name_array_t* Matrix4d::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Matrix4d::getPackageName() {
  return *Matrix4d::getPackageNameArrayPtr();
}

__lcm_buffer_size Matrix4d::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Matrix4d::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Matrix4d::_getEncodedSizeNoHash() const {
