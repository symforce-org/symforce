// This file was hand-written, modified from the Matrix54d type, with the hash
...
class Matrix54d : public Eigen::Matrix<double, 5, 4, Eigen::DontAlign> {
 public:
  ...
  Matrix54d() : Eigen::Matrix<double, 5, 4, Eigen::DontAlign>() {
    *this = Matrix54d::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  Matrix54d(Args&&... args) : Eigen::Matrix<double, 5, 4, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Matrix54d
  template <typename OtherDerived>
  eigen_lcm::Matrix54d& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<double, 5, 4, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Matrix54d& obj) {
    os << "Matrix54d(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<double, 5, 4, Eigen::DontAlign>& operator<<(T other);
 ...
 public:
  ...
  constexpr static uint64_t _computeHash(const __lcm_hash_ptr*) {
    uint64_t hash = 0x2b2f4ef42124f12cLL;
    return (hash << 1) + ((hash >> 63) & 1);
  }
};

__lcm_buffer_size Matrix54d::encode(void* buf, __lcm_buffer_size offset,
                                    __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Matrix54d::decode(const void* buf, __lcm_buffer_size offset,
                                    __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Matrix54d::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Matrix54d::getHash() {
  return _computeHash(NULL);
}

constexpr Matrix54d::type_name_array_t* Matrix54d::getTypeNameArrayPtr() {
  return &"Matrix54d";
}

constexpr const char* Matrix54d::getTypeName() {
  return *Matrix54d::getTypeNameArrayPtr();
}

constexpr Matrix54d::package_name_array_t* Matrix54d::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Matrix54d::getPackageName() {
  return *Matrix54d::getPackageNameArrayPtr();
}

__lcm_buffer_size Matrix54d::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                           __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __double_encode_array(buf, offset + pos, maxlen - pos, this->data(), 20);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
__lcm_buffer_size Matrix54d::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                           __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __double_decode_array(buf, offset + pos, maxlen - pos, this->data(), 20);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
__lcm_buffer_size Matrix54d::_getEncodedSizeNoHash() const {
