...
constexpr uint64_t Quaterniond::getHash() {
...
constexpr Quaterniond::package_name_array_t* Quaterniond::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Quaterniond::getPackageName() {
  return *Quaterniond::getPackageNameArrayPtr();
}
