...
class Quaternionf : public Eigen::Quaternion<float, Eigen::DontAlign> {
 public:
  ...
  Quaternionf() : Eigen::Quaternion<float, Eigen::DontAlign>() {
    *this = Quaternionf::Identity();
  }

  // Pass through constructor
  template <typename... Args>
  Quaternionf(Args&&... args) : Eigen::Quaternion<float, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Quaternionf
  template <typename OtherDerived>
  eigen_lcm::Quaternionf& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Quaternion<float, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Quaternionf& obj) {
    os << "Quaternionf(";
 ...
 public:
  ...
  constexpr static uint64_t _computeHash(const __lcm_hash_ptr*) {
    uint64_t hash = 0x5c785266f6c9245aLL;
    return (hash << 1) + ((hash >> 63) & 1);
  }
};

__lcm_buffer_size Quaternionf::encode(void* buf, __lcm_buffer_size offset,
                                      __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Quaternionf::decode(const void* buf, __lcm_buffer_size offset,
                                      __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Quaternionf::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Quaternionf::getHash() {
  return _computeHash(NULL);
}

constexpr Quaternionf::type_name_array_t* Quaternionf::getTypeNameArrayPtr() {
  return &"Quaternionf";
}

constexpr const char* Quaternionf::getTypeName() {
  return *Quaternionf::getTypeNameArrayPtr();
}

constexpr Quaternionf::package_name_array_t* Quaternionf::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Quaternionf::getPackageName() {
  return *Quaternionf::getPackageNameArrayPtr();
}

__lcm_buffer_size Quaternionf::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                             __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __float_encode_array(buf, offset + pos, maxlen - pos, this->coeffs().data(), 4);
  if (tlen < 0) {
    return tlen;
  } else {
    pos += tlen;
...
__lcm_buffer_size Quaternionf::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                             __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __float_decode_array(buf, offset + pos, maxlen - pos, this->coeffs().data(), 4);
  if (tlen < 0) {
    return tlen;
  } else {
    pos += tlen;
...
__lcm_buffer_size Quaternionf::_getEncodedSizeNoHash() const {
