...
class SymmetricMatrix3d : public Eigen::Matrix<double, 3, 3, Eigen::DontAlign> {
 public:
  ...
  SymmetricMatrix3d() : Eigen::Matrix<double, 3, 3, Eigen::DontAlign>() {
    *this = SymmetricMatrix3d::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  SymmetricMatrix3d(Args&&... args) : Eigen::Matrix<double, 3, 3, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::SymmetricMatrix3d
  template <typename OtherDerived>
  eigen_lcm::SymmetricMatrix3d& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<double, 3, 3, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::SymmetricMatrix3d& obj) {
    os << "SymmetricMatrix3d(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<double, 3, 3, Eigen::DontAlign>& operator<<(T other);
...
__lcm_buffer_size SymmetricMatrix3d::encode(void* buf, __lcm_buffer_size offset,
                                            __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size SymmetricMatrix3d::decode(const void* buf, __lcm_buffer_size offset,
                                            __lcm_buffer_size maxlen) {
...
__lcm_buffer_size SymmetricMatrix3d::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t SymmetricMatrix3d::getHash() {
  return _computeHash(NULL);
}

constexpr SymmetricMatrix3d::type_name_array_t* SymmetricMatrix3d::getTypeNameArrayPtr() {
  return &"SymmetricMatrix3d";
}

constexpr const char* SymmetricMatrix3d::getTypeName() {
...
__lcm_buffer_size SymmetricMatrix3d::_encodeNoHash(void* buf, __lcm_buffer_size offset,
  ...
  Eigen::Matrix<double, 6, 1> flattened_lower_triangle;
  ...
  tlen = __double_encode_array(buf, offset + pos, maxlen - pos, flattened_lower_triangle.data(), 6);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
__lcm_buffer_size SymmetricMatrix3d::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                                   __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;

  Eigen::Matrix<double, 6, 1> flattened_lower_triangle;
  tlen = __double_decode_array(buf, offset + pos, maxlen - pos, flattened_lower_triangle.data(), 6);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
__lcm_buffer_size SymmetricMatrix3d::_getEncodedSizeNoHash() const {
