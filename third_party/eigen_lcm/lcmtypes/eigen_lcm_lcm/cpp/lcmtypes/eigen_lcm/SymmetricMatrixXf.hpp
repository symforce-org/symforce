...
class SymmetricMatrixXf
 ...
 public:
  ...
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::SymmetricMatrixXf& obj) {
    os << "SymmetricMatrixXf(";
...
__lcm_buffer_size SymmetricMatrixXf::encode(void* buf, __lcm_buffer_size offset,
                                            __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size SymmetricMatrixXf::decode(const void* buf, __lcm_buffer_size offset,
                                            __lcm_buffer_size maxlen) {
...
__lcm_buffer_size SymmetricMatrixXf::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t SymmetricMatrixXf::getHash() {
  return _computeHash(NULL);
}

constexpr SymmetricMatrixXf::type_name_array_t* SymmetricMatrixXf::getTypeNameArrayPtr() {
  return &"SymmetricMatrixXf";
}

constexpr const char* SymmetricMatrixXf::getTypeName() {
...
__lcm_buffer_size SymmetricMatrixXf::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                                   __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size SymmetricMatrixXf::_getEncodedSizeNoHash() const {
