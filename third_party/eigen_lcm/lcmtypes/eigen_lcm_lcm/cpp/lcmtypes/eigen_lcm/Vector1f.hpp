...
class Vector1f : public Eigen::Matrix<float, 1, 1, Eigen::DontAlign> {
 public:
  ...
  Vector1f() : Eigen::Matrix<float, 1, 1, Eigen::DontAlign>() {
    *this = Vector1f::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  Vector1f(Args&&... args) : Eigen::Matrix<float, 1, 1, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Vector1f
  template <typename OtherDerived>
  eigen_lcm::Vector1f& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<float, 1, 1, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Vector1f& obj) {
    os << "Vector1f(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<float, 1, 1, Eigen::DontAlign>& operator<<(T other);
 ...
 public:
  ...
  constexpr static uint64_t _computeHash(const __lcm_hash_ptr*) {
    uint64_t hash = 0x5c782a36eaf52457LL;
    return (hash << 1) + ((hash >> 63) & 1);
  }
};

__lcm_buffer_size Vector1f::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Vector1f::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Vector1f::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Vector1f::getHash() {
  return _computeHash(NULL);
}

constexpr Vector1f::type_name_array_t* Vector1f::getTypeNameArrayPtr() {
  return &"Vector1f";
}

constexpr const char* Vector1f::getTypeName() {
  return *Vector1f::getTypeNameArrayPtr();
}

constexpr Vector1f::package_name_array_t* Vector1f::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Vector1f::getPackageName() {
  return *Vector1f::getPackageNameArrayPtr();
}

__lcm_buffer_size Vector1f::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Vector1f::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Vector1f::_getEncodedSizeNoHash() const {
