...
int Vector2f::encode(void* buf, int offset, int maxlen) const {
  int pos = 0, tlen;
...
int Vector2f::decode(const void* buf, int offset, int maxlen) {
  int pos = 0, thislen;
...
int Vector2f::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr int64_t Vector2f::getHash() {
  return _computeHash(NULL);
}

const char* Vector2f::getTypeName() {
  return "Vector2f";
}

const char* Vector2f::getPackageName() {
  return "eigen_lcm";
}

int Vector2f::_encodeNoHash(void* buf, int offset, int maxlen) const {
  int pos = 0, tlen;
...
int Vector2f::_decodeNoHash(const void* buf, int offset, int maxlen) {
  int pos = 0, tlen;
...
int Vector2f::_getEncodedSizeNoHash() const {
  int enc_size = 0;
  enc_size += __float_encoded_array_size(NULL, 2);
  return enc_size;
}

constexpr uint64_t Vector2f::_computeHash(const __lcm_hash_ptr*) {
