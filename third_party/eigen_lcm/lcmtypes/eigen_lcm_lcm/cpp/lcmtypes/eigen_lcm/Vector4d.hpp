...
class Vector4d : public Eigen::Matrix<double, 4, 1, Eigen::DontAlign> {
 public:
  ...
  Vector4d() : Eigen::Matrix<double, 4, 1, Eigen::DontAlign>() {
    *this = Vector4d::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  Vector4d(Args&&... args) : Eigen::Matrix<double, 4, 1, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Vector4d
  template <typename OtherDerived>
  eigen_lcm::Vector4d& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<double, 4, 1, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Vector4d& obj) {
    os << "Vector4d(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<double, 4, 1, Eigen::DontAlign>& operator<<(T other);
...
__lcm_buffer_size Vector4d::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Vector4d::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Vector4d::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Vector4d::getHash() {
  return _computeHash(NULL);
}

constexpr Vector4d::type_name_array_t* Vector4d::getTypeNameArrayPtr() {
  return &"Vector4d";
}

constexpr const char* Vector4d::getTypeName() {
  return *Vector4d::getTypeNameArrayPtr();
}

constexpr Vector4d::package_name_array_t* Vector4d::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Vector4d::getPackageName() {
  return *Vector4d::getPackageNameArrayPtr();
}

__lcm_buffer_size Vector4d::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Vector4d::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Vector4d::_getEncodedSizeNoHash() const {
