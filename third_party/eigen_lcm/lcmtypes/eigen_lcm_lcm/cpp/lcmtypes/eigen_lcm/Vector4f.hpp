...
class Vector4f : public Eigen::Matrix<float, 4, 1, Eigen::DontAlign> {
 public:
  ...
  Vector4f() : Eigen::Matrix<float, 4, 1, Eigen::DontAlign>() {
    *this = Vector4f::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  Vector4f(Args&&... args) : Eigen::Matrix<float, 4, 1, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Vector4f
  template <typename OtherDerived>
  eigen_lcm::Vector4f& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<float, 4, 1, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Vector4f& obj) {
    os << "Vector4f(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<float, 4, 1, Eigen::DontAlign>& operator<<(T other);
...
__lcm_buffer_size Vector4f::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Vector4f::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Vector4f::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Vector4f::getHash() {
  return _computeHash(NULL);
}

constexpr Vector4f::type_name_array_t* Vector4f::getTypeNameArrayPtr() {
  return &"Vector4f";
}

constexpr const char* Vector4f::getTypeName() {
  return *Vector4f::getTypeNameArrayPtr();
}

constexpr Vector4f::package_name_array_t* Vector4f::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Vector4f::getPackageName() {
  return *Vector4f::getPackageNameArrayPtr();
}

__lcm_buffer_size Vector4f::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Vector4f::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Vector4f::_getEncodedSizeNoHash() const {
