...
class Vector6f : public Eigen::Matrix<float, 6, 1, Eigen::DontAlign> {
 public:
  ...
  Vector6f() : Eigen::Matrix<float, 6, 1, Eigen::DontAlign>() {
    *this = Vector6f::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  Vector6f(Args&&... args) : Eigen::Matrix<float, 6, 1, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Vector6f
  template <typename OtherDerived>
  eigen_lcm::Vector6f& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<float, 6, 1, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Vector6f& obj) {
    os << "Vector6f(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<float, 6, 1, Eigen::DontAlign>& operator<<(T other);
...
__lcm_buffer_size Vector6f::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Vector6f::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Vector6f::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Vector6f::getHash() {
  return _computeHash(NULL);
}

constexpr Vector6f::type_name_array_t* Vector6f::getTypeNameArrayPtr() {
  return &"Vector6f";
}

constexpr const char* Vector6f::getTypeName() {
  return *Vector6f::getTypeNameArrayPtr();
}

constexpr Vector6f::package_name_array_t* Vector6f::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Vector6f::getPackageName() {
  return *Vector6f::getPackageNameArrayPtr();
}

__lcm_buffer_size Vector6f::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __float_encode_array(buf, offset + pos, maxlen - pos, this->data(), 6);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
__lcm_buffer_size Vector6f::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __float_decode_array(buf, offset + pos, maxlen - pos, this->data(), 6);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
__lcm_buffer_size Vector6f::_getEncodedSizeNoHash() const {
