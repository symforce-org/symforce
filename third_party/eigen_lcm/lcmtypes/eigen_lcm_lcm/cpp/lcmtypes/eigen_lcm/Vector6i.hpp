...
class Vector6i : public Eigen::Matrix<int32_t, 6, 1, Eigen::DontAlign> {
 public:
  ...
  Vector6i() : Eigen::Matrix<int32_t, 6, 1, Eigen::DontAlign>() {
    *this = Vector6i::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  Vector6i(Args&&... args) : Eigen::Matrix<int32_t, 6, 1, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Vector6i
  template <typename OtherDerived>
  eigen_lcm::Vector6i& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<int32_t, 6, 1, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Vector6i& obj) {
    os << "Vector6i(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<int32_t, 6, 1, Eigen::DontAlign>& operator<<(T other);
...
__lcm_buffer_size Vector6i::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Vector6i::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Vector6i::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Vector6i::getHash() {
  return _computeHash(NULL);
}

constexpr Vector6i::type_name_array_t* Vector6i::getTypeNameArrayPtr() {
  return &"Vector6i";
}

constexpr const char* Vector6i::getTypeName() {
  return *Vector6i::getTypeNameArrayPtr();
}

constexpr Vector6i::package_name_array_t* Vector6i::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Vector6i::getPackageName() {
  return *Vector6i::getPackageNameArrayPtr();
}

__lcm_buffer_size Vector6i::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, this->data(), 6);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
__lcm_buffer_size Vector6i::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, this->data(), 6);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
__lcm_buffer_size Vector6i::_getEncodedSizeNoHash() const {
