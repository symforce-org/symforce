...
class Vector7f : public Eigen::Matrix<float, 7, 1, Eigen::DontAlign> {
 public:
  ...
  Vector7f() : Eigen::Matrix<float, 7, 1, Eigen::DontAlign>() {
    *this = Vector7f::Zero();
  }
  ...
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Vector7f& obj) {
    os << "Vector7f(";
...
__lcm_buffer_size Vector7f::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Vector7f::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Vector7f::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Vector7f::getHash() {
  return _computeHash(NULL);
}

constexpr Vector7f::type_name_array_t* Vector7f::getTypeNameArrayPtr() {
  return &"Vector7f";
}

constexpr const char* Vector7f::getTypeName() {
...
__lcm_buffer_size Vector7f::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Vector7f::_getEncodedSizeNoHash() const {
