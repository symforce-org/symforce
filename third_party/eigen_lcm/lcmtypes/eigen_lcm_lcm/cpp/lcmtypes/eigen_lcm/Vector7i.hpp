...
int Vector7i::encode(void* buf, int offset, int maxlen) const {
  int pos = 0, tlen;
...
int Vector7i::decode(const void* buf, int offset, int maxlen) {
  int pos = 0, thislen;
...
int Vector7i::getEncodedSize() const {
...
const char* Vector7i::getTypeName() {
  return "Vector7i";
}

const char* Vector7i::getPackageName() {
  return "eigen_lcm";
}

int Vector7i::_encodeNoHash(void* buf, int offset, int maxlen) const {
  int pos = 0, tlen;
...
int Vector7i::_decodeNoHash(const void* buf, int offset, int maxlen) {
  int pos = 0, tlen;
...
int Vector7i::_getEncodedSizeNoHash() const {
  int enc_size = 0;
  enc_size += __int32_t_encoded_array_size(NULL, 7);
  return enc_size;
}

constexpr uint64_t Vector7i::_computeHash(const __lcm_hash_ptr*) {
