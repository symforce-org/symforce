...
class Vector8d : public Eigen::Matrix<double, 8, 1, Eigen::DontAlign> {
 public:
  ...
  Vector8d() : Eigen::Matrix<double, 8, 1, Eigen::DontAlign>() {
    *this = Vector8d::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  Vector8d(Args&&... args) : Eigen::Matrix<double, 8, 1, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Vector8d
  template <typename OtherDerived>
  eigen_lcm::Vector8d& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<double, 8, 1, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Vector8d& obj) {
    os << "Vector8d(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<double, 8, 1, Eigen::DontAlign>& operator<<(T other);
...
__lcm_buffer_size Vector8d::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Vector8d::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Vector8d::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Vector8d::getHash() {
  return _computeHash(NULL);
}

constexpr Vector8d::type_name_array_t* Vector8d::getTypeNameArrayPtr() {
  return &"Vector8d";
}

constexpr const char* Vector8d::getTypeName() {
  return *Vector8d::getTypeNameArrayPtr();
}

constexpr Vector8d::package_name_array_t* Vector8d::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Vector8d::getPackageName() {
  return *Vector8d::getPackageNameArrayPtr();
}

__lcm_buffer_size Vector8d::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Vector8d::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size Vector8d::_getEncodedSizeNoHash() const {
