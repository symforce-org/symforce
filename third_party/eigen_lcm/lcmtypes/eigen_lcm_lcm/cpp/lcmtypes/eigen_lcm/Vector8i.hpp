...
class Vector8i : public Eigen::Matrix<int32_t, 8, 1, Eigen::DontAlign> {
 public:
  ...
  Vector8i() : Eigen::Matrix<int32_t, 8, 1, Eigen::DontAlign>() {
    *this = Vector8i::Zero();
  }

  // Pass through constructor
  template <typename... Args>
  Vector8i(Args&&... args) : Eigen::Matrix<int32_t, 8, 1, Eigen::DontAlign>(args...) {}

  // This method allows you to assign Eigen expressions to eigen_lcm::Vector8i
  template <typename OtherDerived>
  eigen_lcm::Vector8i& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
    Eigen::Matrix<int32_t, 8, 1, Eigen::DontAlign>::operator=(other);
    return *this;
  }

  // Stream formatting operator
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::Vector8i& obj) {
    os << "Vector8i(";
 ...
 private:
  ...
  template <typename T>
  Eigen::Matrix<int32_t, 8, 1, Eigen::DontAlign>& operator<<(T other);
 ...
 public:
  ...
  constexpr static uint64_t _computeHash(const __lcm_hash_ptr*) {
    uint64_t hash = 0xfbf54881202cbe31LL;
    return (hash << 1) + ((hash >> 63) & 1);
  }
};

__lcm_buffer_size Vector8i::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size Vector8i::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size Vector8i::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t Vector8i::getHash() {
  return _computeHash(NULL);
}

constexpr Vector8i::type_name_array_t* Vector8i::getTypeNameArrayPtr() {
  return &"Vector8i";
}

constexpr const char* Vector8i::getTypeName() {
  return *Vector8i::getTypeNameArrayPtr();
}

constexpr Vector8i::package_name_array_t* Vector8i::getPackageNameArrayPtr() {
  return &"eigen_lcm";
}

constexpr const char* Vector8i::getPackageName() {
  return *Vector8i::getPackageNameArrayPtr();
}

__lcm_buffer_size Vector8i::_encodeNoHash(void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) const {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, this->data(), 8);
  if (tlen < 0) {
    return tlen;
  } else {
    pos += tlen;
...
__lcm_buffer_size Vector8i::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;

  tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, this->data(), 8);
  if (tlen < 0) {
    return tlen;
  } else {
    pos += tlen;
...
__lcm_buffer_size Vector8i::_getEncodedSizeNoHash() const {
  __lcm_buffer_size enc_size = 0;
  enc_size += __int32_t_encoded_array_size(NULL, 8);
  return enc_size;
}
