...
class VectorXd : public Eigen::Matrix<double, Eigen::Dynamic, 1, Eigen::AutoAlign> {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& os, const eigen_lcm::VectorXd& obj) {
    os << "VectorXd(";
...
__lcm_buffer_size VectorXd::encode(void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) const {
...
__lcm_buffer_size VectorXd::decode(const void* buf, __lcm_buffer_size offset,
                                   __lcm_buffer_size maxlen) {
...
__lcm_buffer_size VectorXd::getEncodedSize() const {
  return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t VectorXd::getHash() {
  return _computeHash(NULL);
}

constexpr VectorXd::type_name_array_t* VectorXd::getTypeNameArrayPtr() {
  return &"VectorXd";
}

constexpr const char* VectorXd::getTypeName() {
...
__lcm_buffer_size VectorXd::_decodeNoHash(const void* buf, __lcm_buffer_size offset,
                                          __lcm_buffer_size maxlen) {
  __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size VectorXd::_getEncodedSizeNoHash() const {
