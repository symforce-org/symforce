...
int VectorXf::encode(void* buf, int offset, int maxlen) const {
  int pos = 0, tlen;
...
int VectorXf::decode(const void* buf, int offset, int maxlen) {
  int pos = 0, thislen;
...
int VectorXf::getEncodedSize() const {
...
const char* VectorXf::getTypeName() {
  return "VectorXf";
}

const char* VectorXf::getPackageName() {
  return "eigen_lcm";
}

int VectorXf::_encodeNoHash(void* buf, int offset, int maxlen) const {
  int pos = 0, tlen;
...
int VectorXf::_decodeNoHash(const void* buf, int offset, int maxlen) {
  int pos = 0, tlen;
...
int VectorXf::_getEncodedSizeNoHash() const {
  int enc_size = 0;
...
constexpr uint64_t VectorXf::_computeHash(const __lcm_hash_ptr*) {
